...
```bash
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==25.8.5.1
```

### 安装最新版本

```bash
pip install --upgrade Fr1997v011==25.9.5.1
```
...
```bash
pip install dist/Fr1997v011-25.9.5.1.tar.gz
```
