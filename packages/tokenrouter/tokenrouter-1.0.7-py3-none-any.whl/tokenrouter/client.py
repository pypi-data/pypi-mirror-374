...
class ChatCompletions:
    ...
    def create(
        ...
        **kwargs,
        ...
        extra_headers = self.client._build_secure_headers(key_mode)
        if stream:
            return self.client._stream_request("/v1/chat/completions", payload, extra_headers)
        response = self.client._request("POST", "/v1/chat/completions", json=payload, extra_headers=extra_headers)
...
class LegacyCompletions:
    ...
    def create(
        ...
        **kwargs,
        ...
        extra_headers = self.client._build_secure_headers(key_mode)
        if stream:
            return self.client._stream_request_raw("/v1/completions", payload, extra_headers)
        return self.client._request("POST", "/v1/completions", json=payload, extra_headers=extra_headers)
...
class AsyncChatCompletions:
    ...
    async def create(
        ...
        **kwargs,
        ...
        if stream:
            return self.client._stream_request("/v1/chat/completions", payload, extra_headers)
        response = await self.client._request("POST", "/v1/chat/completions", json=payload, extra_headers=extra_headers)
        return ChatCompletion.from_dict(response)
...
class AsyncLegacyCompletions:
    ...
    async def create(
        ...
        **kwargs,
        ...
        if stream:
            return self.client._stream_request_raw("/v1/completions", payload, extra_headers)
        return await self.client._request("POST", "/v1/completions", json=payload, extra_headers=extra_headers)
