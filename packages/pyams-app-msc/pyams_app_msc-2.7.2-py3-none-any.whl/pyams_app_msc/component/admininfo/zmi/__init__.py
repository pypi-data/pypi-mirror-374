...
from pyams_app_msc.component.admininfo import IAdminInfo
...
@adapter_config(name=get_interface_name(IAdminInfo),
                required=(Interface, IFormLayer, IForm, IObjectWidget),
                provides=IObjectFactory)
def admin_info_factory(*args):  # pylint: disable=unused-argument
    """Administrative information object factory"""
    return get_object_factory(IAdminInfo)
