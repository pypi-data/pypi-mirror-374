...
@adapter_config(name=get_interface_name(IBankingAccount),
                required=(Interface, IFormLayer, IForm, IObjectWidget),
                provides=IObjectFactory)
def banking_account_factory(*args):  # pylint: disable=unused-argument
    """Banking account object factory"""
    return get_object_factory(IBankingAccount)
