...
def deploy(
    ...
    """Deploy a workflow to a workcell."""
...
def start(
    ...
    """Start the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def status(workcell_id: Annotated[UUID, typer.Option(help="ID of the workcell to get the status of.")]):
    """Get the status of the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def get_latest(workcell_id: Annotated[UUID, typer.Option(help="ID of the workcell to get the latest error of.")]):
    """Get the latest error of the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def pause(
    ...
    """Pause the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def resume(
    ...
    """Resume the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def stop(
    ...
    """Stop the currently deployed workflow on the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def reset(
    ...
    """Reset the workflow currently deployed to the given workcell."""
    console = get_custom_console()
    client = CliSafeLinq()
...
def list(
    ...
    table.add_column("Name", min_width=30, max_width=60)
    table.add_column("Hub ID")
