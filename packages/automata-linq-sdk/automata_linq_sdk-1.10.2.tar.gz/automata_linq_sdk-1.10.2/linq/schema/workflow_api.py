...
#   timestamp: 2025-05-27T16:41:58+00:00
...
class AvailableActions(BaseModel):
    ...
    ignore: bool = Field(..., description="Whether the task can be ignored", title="Ignore")
...
class AvailableActionsInput(BaseModel):
    ...
    ignore: bool = Field(default=False, description="Whether the task can be ignored", title="Ignore")
...
class WorkflowDeployInput(BaseModel):
    ...
    model_config = ConfigDict(frozen=True)
    device_id: str = Field(..., description="The ID of device to which workflow will be deployed", title="Device Id")
...
class ActionTaskInput(BaseModel):
    ...
    available_failure_actions: AvailableActionsInput | None = Field(
        default=None,
        description="Available actions for the operator if the task fails. Leave blank for defaults: [complete_manually=True, retry=True, ignore=False]",
    )
