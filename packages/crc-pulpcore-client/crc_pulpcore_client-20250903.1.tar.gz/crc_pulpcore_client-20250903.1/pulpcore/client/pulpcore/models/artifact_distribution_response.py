...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "name", "base_path", "pulp_created", "base_url", "hidden", "pulp_last_updated", "pulp_href", "content_guard", "pulp_labels", "no_content_change_since"]
