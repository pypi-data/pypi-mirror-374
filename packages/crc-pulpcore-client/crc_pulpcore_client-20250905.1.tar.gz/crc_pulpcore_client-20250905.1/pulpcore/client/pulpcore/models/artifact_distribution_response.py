...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "pulp_labels", "name", "pulp_href", "pulp_created", "no_content_change_since", "hidden", "base_url", "prn", "base_path", "content_guard"]
