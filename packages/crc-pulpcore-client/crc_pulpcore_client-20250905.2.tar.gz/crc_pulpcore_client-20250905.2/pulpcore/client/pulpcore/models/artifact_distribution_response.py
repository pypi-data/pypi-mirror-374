...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "pulp_labels", "pulp_href", "base_url", "base_path", "content_guard", "pulp_created", "hidden", "no_content_change_since", "name", "pulp_last_updated"]
