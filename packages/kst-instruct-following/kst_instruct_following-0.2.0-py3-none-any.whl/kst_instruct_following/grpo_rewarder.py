...
import re
import json
from kst_instruct_following.template.reward_template import template_rm, output_format, concat_generate_completions, concat_instructions
from datasets import Dataset
import itertools
from functools import partial
from transformers import AutoTokenizer
from kst_instruct_following.vllm_functions import get_prompt_score

from kst_instruct_following.processor import dialogue_formater
class GRPO_Rewarder():
