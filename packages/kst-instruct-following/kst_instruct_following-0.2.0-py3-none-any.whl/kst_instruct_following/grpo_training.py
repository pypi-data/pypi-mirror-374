...
try:
    from kst_instruct_following.template import reward_template, system_template
    from kst_instruct_following.grpo_rewarder import GRPO_Rewarder, GRPO_Formater
    from kst_instruct_following.processor import grpo_system_prompt_process
except:
