...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "name", "no_content_change_since", "pulp_last_updated", "prn", "repository", "pulp_labels", "base_path", "pulp_href", "content_guard", "hidden", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
