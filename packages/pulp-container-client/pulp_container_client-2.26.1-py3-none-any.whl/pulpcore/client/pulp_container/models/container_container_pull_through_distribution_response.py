...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "name", "no_content_change_since", "pulp_last_updated", "prn", "repository", "pulp_labels", "base_path", "pulp_href", "content_guard", "hidden", "remote", "distributions", "namespace", "private", "description"]
