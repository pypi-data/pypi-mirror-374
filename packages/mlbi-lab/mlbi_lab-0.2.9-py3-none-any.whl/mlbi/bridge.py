...
def evaluate_roc_auc( X, y, vlst, classifier, param_grid, 
    ...
    df_res = pd.DataFrame({'Case': groups, 'AUC': auc_all, 'Sensitivity': sens_all, 'Specificity': spec_all})
...
def plot_pct_box( df_pct, sg_map, ncols, figsize = None, dpi = 100,
                  ...
                  ws_hs = (0.3, 0.3), ylabel = None, xlabel = None, stripplot = True, dot_size = 5, jitter = 2 ):
