...
class Shortcut:
    ...
    def shortcut_album_get(self, device_id: str, album_name: str = "", num: int = 20,
        ...
        return self._api.call(AlbumFileResponse,
                                   self._api._payload.shortcut_album_get, 
                                   device_id, album_name, num, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_album_upload(self, device_id: str, album_name: str, files: List[str], is_zip: bool = False,
        ...
        return self._api.call(AlbumFileResponse,
                                   self._api._payload.shortcut_album_upload,
                                   device_id, album_name, files, is_zip, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_album_down(self, device_id: str, files: List[AlbumFileParams], is_zip: bool = False,
        ...
        return self._api.call(CommonResponse, self._api._payload.shortcut_album_down,
                                   device_id, files, is_zip, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_album_del(self, device_id: str, files: List[AlbumFileParams], outtime: int = 30) -> AlbumFileResponse:
        ...
        return self._api.call(AlbumFileResponse,
                                   self._api._payload.shortcut_album_del,
                                   device_id, files, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_album_clear(self, device_id: str, album_name: str = '', outtime: int = 30) -> AlbumFileResponse:
        ...
        return self._api.call(AlbumFileResponse,
                                   self._api._payload.shortcut_album_clear,
                                   device_id, album_name, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_file_get(self, device_id: str, path: str = "",
        ...
        return self._api.call(PhoneFileResponse,
                                   self._api._payload.shortcut_file_get,
                                   device_id, path, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_file_upload(self, device_id: str, path: str, files: List[str], is_zip: bool = False,
        ...
        return self._api.call(PhoneFileResponse,
                                   self._api._payload.shortcut_file_upload,
                                   device_id, path, is_zip, files, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_file_del(self, device_id: str, path: str, files: List[PhoneFileParams],
        ...
        return self._api.call(PhoneFileResponse,
                                   self._api._payload.shortcut_file_del,
                                   device_id, path, files, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_clipboard_set(self, device_id: str, text: str, sleep: int = 0, outtime: int = 10) -> CommonResponse:
        ...
        return self._api.call(CommonResponse, self._api._payload.shortcut_clipboard_set,
                                   device_id, text, sleep, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_clipboard_get(self, device_id: str, outtime: int = 10) -> ResultTextResponse:
        ...
        return self._api.call(ResultTextResponse,
                                   self._api._payload.shortcut_clipboard_get,
                                   device_id, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_exec_url(self, device_id: str, url: str, outtime: int = 10) -> CommonResponse:
        ...
        return self._api.call(CommonResponse, self._api._payload.shortcut_exec_url,
                                   device_id, url, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_switch_device(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._api.call(CommonResponse, self._api._payload.shortcut_switch_device,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_device_ip(self, device_id: str, outtime: int = 10) -> ResultTextResponse:
        ...
        return self._api.call(ResultTextResponse,
                                   self._api._payload.shortcut_device_ip,
                                   device_id, 1, outtime * 1000, _timeout=outtime + 1)
