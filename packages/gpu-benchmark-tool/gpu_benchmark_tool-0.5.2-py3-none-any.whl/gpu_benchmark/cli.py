...
def cmd_ai_cost_benchmark(args):
    ...
    try:
        ...
        # Summary
        total_cost = sum(metrics.total_cost for metrics in results.values())
        print_info(f"\n💰 Total Cost Across All Models: ${total_cost:.2f}")
        print_info("✅ AI Cost Benchmark completed successfully!")
