...
class ApiGatewayStack(IStack, EnhancedSsmParameterMixin):
    ...
    def _create_rest_api(self, api_id: str, routes: List[Dict[str, Any]]):
        # Temporarily disable auto-deployment to prevent stage conflicts
        original_deploy = self.api_config.deploy
        self.api_config.deploy = False
        ...
        # Restore original deploy setting
        self.api_config.deploy = original_deploy
