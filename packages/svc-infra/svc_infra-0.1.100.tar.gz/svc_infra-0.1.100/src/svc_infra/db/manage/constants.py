...
# Alembic templates loaded from package resources (svc_infra.db.manage.templates.setup)
# Kept as module-level constants for compatibility with setup.py
try:
    import importlib.resources as pkg

    _tmpl_pkg = pkg.files("svc_infra.db.manage.templates.setup")
