...
def test_cpuawkward_UnionArray64_U32_regular_index_1():
    toindex = [123, 123, 123]
    ...
    length = 3
    funcC = getattr(lib, 'awkward_UnionArray64_U32_regular_index')
    ret_pass = funcC(toindex, current, size, fromtags, length)
    pytest_toindex = [0, 1, 2]
    pytest_current = [3, 0, 0]
    assert not ret_pass.str

def test_cpuawkward_UnionArray64_U32_regular_index_2():
    toindex = [123, 123, 123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
    current = [123, 123, 123]
    current = (ctypes.c_uint32*len(current))(*current)
...
def test_cpuawkward_UnionArray64_U32_regular_index_3():
    toindex = [123, 123, 123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
    current = [123, 123, 123]
    current = (ctypes.c_uint32*len(current))(*current)
...
def test_cpuawkward_UnionArray64_U32_regular_index_4():
    toindex = [123, 123, 123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
    current = [123, 123, 123]
    current = (ctypes.c_uint32*len(current))(*current)
...
def test_cpuawkward_UnionArray64_U32_regular_index_5():
    toindex = [123, 123, 123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
    current = [123, 123, 123]
    current = (ctypes.c_uint32*len(current))(*current)
