...
class Ui_shortcutDialog(object):
    ...
    def retranslateUi(self, shortcutDialog):
        ...
        self.text_name.setToolTip(_translate("shortcutDialog", "Name of menu item"))
        self.label_2.setText(_translate("shortcutDialog", "Shortcut"))
        self.shortcut.setToolTip(_translate("shortcutDialog", "Click and then press keys for shortcut"))
        self.validate.setToolTip(_translate("shortcutDialog", "Check if shortcuts conflict and save"))
