...
class Ui_indexDialog(object):
    def setupUi(self, indexDialog):
        ...
        self.addNewIndex.setFocusPolicy(QtCore.Qt.NoFocus)
    ...
    def retranslateUi(self, indexDialog):
        ...
        self.indexChoice.setToolTip(_translate("indexDialog", "Indices are numbered starting at 0"))
        self.addNewIndex.setToolTip(_translate("indexDialog", "Add another index"))
        self.addNewIndex.setText(_translate("indexDialog", "Add New Index"))
        self.label_2.setText(_translate("indexDialog", "Prefix:"))
        self.indexPrefix.setToolTip(_translate("indexDialog", "Prefix for index entry"))
        self.hideDescript.setToolTip(_translate("indexDialog", "Do not show entry description in transcript"))
        ...
        self.entryText.setToolTip(_translate("indexDialog", "Text for the index entry"))
        self.entryAdd.setText(_translate("indexDialog", "Add new entry"))
        self.saveAndInsert.setToolTip(_translate("indexDialog", "Save changes to present index and insert selected entry"))
        self.saveAndInsert.setText(_translate("indexDialog", "Save && Insert"))
        self.saveIndex.setToolTip(_translate("indexDialog", "Save changes to selected index"))
