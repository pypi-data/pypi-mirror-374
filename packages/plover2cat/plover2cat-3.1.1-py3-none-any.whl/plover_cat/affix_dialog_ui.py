...
class Ui_affixDialog(object):
    ...
    def retranslateUi(self, affixDialog):
        ...
        self.styleName.setToolTip(_translate("affixDialog", "Style to set affixes for"))
        self.label_3.setText(_translate("affixDialog", "Prefix string:"))
        self.prefixString.setToolTip(_translate("affixDialog", "String to add at start of paragraph"))
        self.label_2.setText(_translate("affixDialog", "Suffix string:"))
        self.suffixString.setToolTip(_translate("affixDialog", "String to add to end of paragraph"))
        self.insertTab.setToolTip(_translate("affixDialog", "Insert tab character into prefix/suffix string"))
        self.insertTab.setText(_translate("affixDialog", "Insert tab at cursor"))
        self.saveAffixes.setToolTip(_translate("affixDialog", "Save changes for selected style"))
