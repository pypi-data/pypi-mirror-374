...
class Ui_fieldDialog(object):
    ...
    def retranslateUi(self, fieldDialog):
        ...
        self.fieldName.setToolTip(_translate("fieldDialog", "Identifier for field, best be ASCII characters"))
        self.label_2.setText(_translate("fieldDialog", "Field value:"))
        self.fieldValue.setToolTip(_translate("fieldDialog", "Text value for field, appears in transcript. If left blank, field name appears in text."))
        self.addNewField.setText(_translate("fieldDialog", "Add new field"))
        self.userDictTable.setToolTip(_translate("fieldDialog", "Double-click cells to edit field values."))
        self.userDictTable.setSortingEnabled(True)
        self.removeField.setToolTip(_translate("fieldDialog", "Removes selected field from table"))
