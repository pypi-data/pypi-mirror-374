...
class CollectionsApi:
    ...
    def get_entities(
        ...
        Retrieve all extracted entities for a specific file in a collection. This API is only available when the a collection is created with collection_type 'entities'
