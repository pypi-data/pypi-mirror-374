...
class CreateFileSegmentationRequest(BaseModel):
    ...
    """ # noqa: E501
    thumbnails_config: Optional[ThumbnailsConfig] = Field(default=None, description="Configuration for segment thumbnails. Optional.")
    strategy: StrictStr = Field(description="Segmentation strategy - determines which config you must provide")
    uniform_config: Optional[SegmentationUniformConfig] = Field(default=None, description="🎯 **REQUIRED when strategy = 'uniform'** - Configuration for uniform segmentation. Do NOT provide when using shot-detector strategy.")
    shot_detector_config: Optional[SegmentationShotDetectorConfig] = Field(default=None, description="🎯 **REQUIRED when strategy = 'shot-detector'** - Configuration for shot detection segmentation. Do NOT provide when using uniform strategy.")
