...
class Connections:
    ...
    def retrieve_sent_prod_from_query(self, params):
        ...
        response = requests.get(url_complet, verify=self.verify_ssl)
    ...
    def retrieve_bands_for_resolution(self, session, headers, response, resolution, band_list, url_index):
        ...
        response_resolution = session.get(url_resolution, headers=headers, stream=True, verify=self.verify_ssl)
