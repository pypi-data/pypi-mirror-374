...
def proto_files(name: str):
    proto_dir = os.path.join("src", "Infrastructure", "Grpc", "Proto")
    gen_dir = os.path.join("src", "Infrastructure", "Grpc", "Generated")

    proto_path = os.path.join(proto_dir, f"{name}Service.proto")
    common_path = os.path.join(proto_dir, "Common.proto")

    common_py = os.path.join(gen_dir, "Common_pb2.py")
    common_grpc_py = os.path.join(gen_dir, "Common_pb2_grpc.py")
