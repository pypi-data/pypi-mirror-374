...
@click.command(name='proto-files')
@click.argument('name')
def proto_files(name: str):
    base_dir = os.path.dirname(os.path.abspath(__file__))
    proto_dir = os.path.join(base_dir, "src", "Infrastructure", "Grpc", "Proto")
    gen_dir = os.path.join(base_dir, "src", "Infrastructure", "Grpc", "Generated")
