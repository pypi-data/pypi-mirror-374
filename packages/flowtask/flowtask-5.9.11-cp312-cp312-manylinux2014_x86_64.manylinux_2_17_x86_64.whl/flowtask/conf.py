...
WORKDAY_WSDL_PATH = BASE_DIR.joinpath("env", "workday", "staffing_custom_44_2.wsdl")
WORKDAY_WSDL_TIME = BASE_DIR.joinpath("env", "workday", "timetracking_custom_44_2.wsdl")
WORKDAY_WSDL_HUMAN_RESOURCES = BASE_DIR.joinpath("env", "workday", "humanresources_troc_44_2.wsdl")
