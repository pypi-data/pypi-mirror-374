        ...
        try:
            ...
            def on_message(message):
                ...
                if isinstance(message, bytes):
                    payload = message.decode('utf-8') if message else message
            ...
            self.emit(Events.ADD_DATA_CONSUMER, data_consumer)
    ...
    async def send(self, payload, opts=None):
        ...
        try:
            ...
            if not isinstance(payload, (bytes, str)):
                raise TypeError("Invalid payload type current type is: " + type(payload).__name__ + " only string and bytes are allowed")
            ...
            if not self.__send_transport or self.__send_transport.connectionState != "connected":
