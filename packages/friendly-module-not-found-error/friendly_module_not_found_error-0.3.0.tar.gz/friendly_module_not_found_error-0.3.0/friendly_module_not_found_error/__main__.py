...
from friendly_module_not_found_error import _calculate_closed_name
...
class ExceptionTest(unittest.TestCase):
    def test_top_import_exception(self):        
        suggestion = except_suggestion("ant")
        import_error_tuple = (
            ("import ant", ModuleNotFoundError, f"No module named 'ant'. Did you mean: {suggestion!r}?"),
        )
    ...
    def test_custom_module_hook(self):
        suggestion = except_suggestion("module")
        import_error_tuple = (
            ("import module", ModuleNotFoundError, f"No module named 'module'. Did you mean: {suggestion!r}"),
