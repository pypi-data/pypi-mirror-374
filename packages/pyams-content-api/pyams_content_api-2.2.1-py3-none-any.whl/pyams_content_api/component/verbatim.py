...
from pyams_content.component.verbatim import IVerbatimParagraph
...
@adapter_config(required=(IVerbatimParagraph, IRequest),
                provides=IJSONExporter)
class JSONVerbatimParagraphExporter(JSONBaseParagraphExporter):
    """JSON verbatim paragraph exporter"""
    
    def convert_content(self, **params):
        result = super().convert_content(**params)
        lang = params.get('lang')
        self.get_html_attribute(result, 'quote', lang=lang)
