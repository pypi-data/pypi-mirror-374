...
class TestDownloadUrlToFile:
    ...
    async def test_download_url_to_file_basic(self, tmp_path):
        ...
        with patch(
            "good_common.utilities.io.download_url_to_temp_file"
        ) as mock_download:
            # Create a mock context manager
            mock_file = tmp_path / "downloaded.txt"
            mock_file.write_bytes(test_content)
            ...
            result = await download_url_to_file(
