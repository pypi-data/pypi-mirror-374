...
class MaskedVectorizeOp(_ods_ir.OpView):
  ...
  def __init__(self, target, vector_sizes, *, static_vector_sizes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, transformed, target, *, padding_values=None, padding_dimensions=None, pack_paddings=None, hoist_paddings=None, transpose_paddings=None, loc=None, ip=None):
    ...
    if hoist_paddings is not None: attributes["hoist_paddings"] = (hoist_paddings if (
        issubclass(type(hoist_paddings), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64ArrayAttr')) else
          _ods_ir.AttrBuilder.get('I64ArrayAttr')(hoist_paddings, context=_ods_context))
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_375')) else
          _ods_ir.AttrBuilder.get('anonymous_375')(transpose_paddings, context=_ods_context))
    results.append(transformed)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class TileReductionUsingForeachThreadOp(_ods_ir.OpView):
  ...
  def __init__(self, foreach_thread_op, fill_op, split_linalg_op, combining_linalg_op, target, *, num_threads=None, tile_sizes=None, mapping=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TileToForeachThreadOp(_ods_ir.OpView):
  ...
  def __init__(self, foreach_thread_op, tiled_op, target, num_threads, tile_sizes, *, packed_num_threads=None, packed_tile_sizes=None, static_num_threads=None, static_tile_sizes=None, mapping=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
