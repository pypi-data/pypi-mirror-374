...
MarkdownResourceType: TypeAlias = Literal["web", "file", "image"]

TranscribeResourceType: TypeAlias = Literal["youtube"]

InsertStatus: TypeAlias = Literal["PENDING", "COMPLETED", "FAILED"]
