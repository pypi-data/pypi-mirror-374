...
class WetrocloudClient:
    ...
    def _get_resource(self,collection_id: CollectionID, resource: Union[str, bytes, Any],type: ResourceType) -> str:
    ...
    def insert_resource(
        ...
        """
        resource = self._get_resource(collection_id,resource,type)
        payload = {
            "collection_id": collection_id,
            "resource": resource,
            "type": type
    ...
    def check_insert_resource(
            self, 
            collection_id: CollectionID, 
            resource_id: ResourceID
        ) -> CheckInsertResponse:
        """
            Check Status of Inserted resource in a collection.
            
            Args:
                collection_id (str): The ID of the collection.
                resource_id (str): The resource ID to check.
            
            Returns:
                dict: Response including success flag and tokens used.
            
            Endpoint:
                POST /v1/insert/check/ (&#8203;:contentReference[oaicite:7]{index=7})
        """
        payload = {
            "collection_id": collection_id,
        ...
        return self._request("POST", "/v1/resource/insert/check/", data=payload, response_model=CheckInsertResponse)
    ...
    def markdown_converter(
        ...
        """
        Convert structured data from a website or file as Markdown.
        
        Endpoint: POST /v2/markdown-converter/
        Note: This endpoint expects multipart/form-data.
        """
        link = self._get_resource("python_sdk_markdown_collection_id",link,resource_type)
        form_data = {
            "link": link,
            "resource_type": resource_type
        }
        return self._request("POST", "/v2/markdown-converter/", data=form_data, response_model=MarkdownCoverterResponse)
    ...
    def transcript(
        ...
        """
        Extract Trascribe text from Youtube.
        ...
        return self._request("POST", "/v2/transcript/", data=form_data, response_model=TrascribeResponse)
