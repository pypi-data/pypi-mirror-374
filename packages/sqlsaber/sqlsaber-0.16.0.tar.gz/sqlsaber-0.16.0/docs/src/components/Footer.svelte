...
<footer class="border-t border-gray-200 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          ...
          <div class="flex space-x-4">
            ...
            <a
              href="https://twitter.com/sqlsaber"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-gray-600 transition-colors"
            >
          ...
          <ul class="space-y-3 text-gray-600">
            <li>
              <a
                ...
                class="hover:text-gray-900 transition-colors">Documentation</a
              >
            </li>
          </ul>
        </div>
    ...
    <!-- Bottom Bar -->
    <div
      class="border-t border-gray-200 py-8 flex flex-col md:flex-row justify-between items-center"
    >
      <p class="text-gray-500 text-sm">
        © {currentYear} Sarthak Jariwala. All rights reserved.
      </p>
    </div>
  </div>
</footer>
