    ...
    def do_GET(self):
        ...
        try:
            ...
            if 'code' in query_params:
                ...
                self.server.oauth_received = True
...
class OAuthCallbackServer:
    ...
    def start_server(self, timeout: int = 300) -> None:
        ...
        try:
            ...
            self.cert_file, self.key_file = self._create_self_signed_cert()
            ...
            self.server.oauth_received = False
            self.server.timeout = 1  # Short timeout for periodic checks
...
def automated_oauth_flow(auth_manager, open_browser: bool = True, timeout: int = 300) -> Dict[str, Any]:
    """
