...
class SQSListener:
    ...
    def _process_message(self, raw_message: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            context = Context(
                sailor=getattr(self, 'sailor', None),
    ...
    def set_sailor(self, sailor):
        """Set sailor instance (for Record and Context)"""
        self.sailor = sailor
