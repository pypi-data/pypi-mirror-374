...
class DbuiV1QueryExtendRequest(BaseModel):
    ...
    time_range: Optional[DbuiV1QueryExtendRequestTimeRange] = Field(alias="timeRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeRange": DbuiV1QueryExtendRequestTimeRange.from_dict(obj["timeRange"]) if obj.get("timeRange") is not None else None
        })
        return _obj
