...
class DbuiV1TransformRequestAutoloaderInput(BaseModel):
    """
    ...
    row_count: Optional[StrictInt] = Field(default=None, description="An optional number of rows to fetch from the autoloader.", alias="rowCount")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1TransformRequestAutoloaderInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1TransformRequestAutoloaderInput from a dict"""
        if obj is None:
            return None
