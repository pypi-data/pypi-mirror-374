...
class Dimension(_message.Message):
    ...
    def __init__(self, no: _Optional[int] = ..., type: _Optional[_Union[Dimension.Type, str]] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., display_properties_index: _Optional[int] = ..., dimension_line_offset: _Optional[float] = ..., is_custom_vertical_position: bool = ..., custom_vertical_position: _Optional[_Union[Dimension.CustomVerticalPosition, str]] = ..., is_custom_horizontal_position: bool = ..., custom_horizontal_position: _Optional[_Union[Dimension.CustomHorizontalPosition, str]] = ..., symbol: _Optional[str] = ..., comment: _Optional[str] = ..., linear_reference_table: _Optional[_Union[Dimension.LinearReferenceTable, _Mapping]] = ..., angular_reference_table: _Optional[_Union[Dimension.AngularReferenceTable, _Mapping]] = ..., measured_length: _Optional[float] = ..., measured_lengths: _Optional[_Iterable[int]] = ..., measured_angle: _Optional[float] = ..., measured_angles: _Optional[_Iterable[int]] = ..., measured_slope: _Optional[float] = ..., is_global_dimension_line_offset: bool = ..., linear_coordinate_system: _Optional[int] = ..., linear_reference: _Optional[_Union[Dimension.LinearReference, str]] = ..., linear_global_dimension_line_offset_y: _Optional[float] = ..., linear_global_dimension_line_offset_z: _Optional[float] = ..., linear_global_dimension_line_offset: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., arc_length_reference_line: _Optional[int] = ..., arc_length_reference_table: _Optional[_Union[Dimension.ArcLengthReferenceTable, _Mapping]] = ..., arc_length_angle_greater_than_180: bool = ..., angular_quadrant: _Optional[_Union[Dimension.AngularQuadrant, str]] = ..., angular_angle_greater_than_180: bool = ..., radius_diameter_reference_line: _Optional[int] = ..., radius_diameter_is_target_point: bool = ..., radius_diameter_target_point_coordinate_y: _Optional[float] = ..., radius_diameter_target_point_coordinate_z: _Optional[float] = ..., radius_diameter_target_point_coordinates: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., radius_diameter_position_on_line: _Optional[float] = ..., slope_coordinate_system: _Optional[int] = ..., slope_plane: _Optional[_Union[Dimension.SlopePlane, str]] = ..., slope_reference_line: _Optional[int] = ..., slope_direction: _Optional[_Union[Dimension.SlopeDirection, str]] = ..., slope_refer_distance_from_line_end: bool = ..., slope_position_absolute: _Optional[float] = ..., slope_position_relative: _Optional[float] = ..., slope_position_is_relative: bool = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
