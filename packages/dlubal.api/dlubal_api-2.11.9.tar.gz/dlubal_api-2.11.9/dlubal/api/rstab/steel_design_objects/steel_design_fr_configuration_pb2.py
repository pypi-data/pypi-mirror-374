...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STEELDESIGNFRCONFIGURATION']._serialized_start=117
  _globals['_STEELDESIGNFRCONFIGURATION']._serialized_end=635
