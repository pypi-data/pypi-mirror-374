...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STEELDESIGNSEISMICCONFIGURATION']._serialized_start=122
  _globals['_STEELDESIGNSEISMICCONFIGURATION']._serialized_end=645
