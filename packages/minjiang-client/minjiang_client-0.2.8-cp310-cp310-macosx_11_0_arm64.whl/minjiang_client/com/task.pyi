...
def create_task(device_group_name: str, space_name: str, title: str, description: str): ...
def create_sub_process(device_group_name: str, task_id: int, title: str, description: str, resource_id: int, source: str, space_timestamp: int, template_name: str): ...
