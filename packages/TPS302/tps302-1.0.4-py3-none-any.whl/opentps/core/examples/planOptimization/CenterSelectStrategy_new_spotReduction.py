...
best_plan_selected.planDesign.objectives.addFidObjective(roi, FidObjective.Metrics.DMAX, 82.5, 100.0)
best_plan_selected.planDesign.objectives.addFidObjective(roi, FidObjective.Metrics.DMIN, 76.0, 100.0)
best_plan_selected.planDesign.objectives.addFidObjective(ring10, FidObjective.Metrics.DMAX, 84.0, 100.0)
best_plan_selected.planDesign.objectives.addFidObjective(OAR_Rectum, FidObjective.Metrics.DMAX, 77.0, 50.0)
best_plan_selected.planDesign.objectives.addFidObjective(OAR_bladder, FidObjective.Metrics.DMAX, 70.0, 10.0)
...
tps_file = os.path.join(output_path, "Arcplan_CSS_new_90GA_Opti_SpotReduction-2.tps")
