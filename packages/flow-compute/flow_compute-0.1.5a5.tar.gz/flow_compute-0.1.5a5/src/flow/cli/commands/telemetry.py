...
def _merge_telemetry(base: dict[str, Any], enabled: bool | None = None, api_key: str | None = None, url: str | None = None) -> dict[str, Any]:
    cfg = dict(base)
    ...
    def get_command(self) -> click.Command:
        ...
        def status_cmd() -> None:
            try:
                ...
                try:
                    load = getattr(_analytics, "_load_telemetry_settings")
                    settings = load()
                except Exception:
        ...
        @telemetry_group.command("enable", help="Enable telemetry (optionally set Amplitude key and URL)")
