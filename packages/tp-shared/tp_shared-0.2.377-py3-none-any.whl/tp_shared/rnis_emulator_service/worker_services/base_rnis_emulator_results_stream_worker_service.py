...
class BaseRnisEmulatorResultsStreamQueueWorkerService(
    RnisEmulatorResultsStreamQueueRepo, BaseWorkerService
):
    def __init__(
        self,
        redis_client: Redis,
        ...
        RnisEmulatorResultsStreamQueueRepo.__init__(self, redis_client=redis_client)
    ...
    async def add(self, message: RnisEmulatorResultMessage) -> None:
        await RnisEmulatorResultsStreamQueueRepo.add(self, message)
    ...
    async def pop(
        ...
        return await RnisEmulatorResultsStreamQueueRepo.pop(
            self,
    ...
    async def ack(self, message_id: str):
        await RnisEmulatorResultsStreamQueueRepo.ack(self, self.group_name, message_id)
    ...
    async def claim_reassign(
        ...
        return await RnisEmulatorResultsStreamQueueRepo.claim_reassign(
            self,
            group_name=self.group_name,
            consumer_name=self.consumer_name,
            min_idle_time=min_idle_time,
    ...
    async def create_consumer_group(self, create_stream: bool = True):
        await RnisEmulatorResultsStreamQueueRepo.create_consumer_group(
            self,
            group_name=self.group_name,
    ...
    async def trim_by_age(self, retention: timedelta) -> int:
        return await RnisEmulatorResultsStreamQueueRepo.trim_by_age(self, retention)
    ...
    async def delete_all(self) -> None:
        await RnisEmulatorResultsStreamQueueRepo.delete_all(self)
