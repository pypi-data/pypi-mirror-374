...
class ImageManager(BaseSyncManager):
    """Manager for image assets."""

    resource_class = Image
    """The resource model class this manager handles."""

    base_path = "/storefront-assets"
...
class VideoManager(BaseSyncManager):
...
class DocumentManager(BaseSyncManager):
...
# Async managers
class AsyncImageManager(BaseAsyncManager):
...
class AsyncVideoManager(BaseAsyncManager):
...
class AsyncDocumentManager(BaseAsyncManager):
