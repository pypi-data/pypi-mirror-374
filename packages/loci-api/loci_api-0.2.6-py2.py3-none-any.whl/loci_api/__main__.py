...
def parse_args():
    ...
    func_insights_parser.add_argument("--filter", type=str, nargs='*', choices=['new', 'mod', None],
                                      default='mod',
...
def cmd_function_insights(project_name, version_name, version_name_base, perc_resp_limit, perc_thro_limit, perc_bott_limit, pairs, output, filters) -> int:
    ...
    return output_success_result([_to_insight(i, version_id_base is not None) for i in insights['message']], output)
