...
AUTHALIC_RADIUS = 6_371_007.180918475  # m
...
DGGAL_TYPES = {
    "gnosis": {"min_res": 0, "max_res": 28, "default_res": 22, "class_name": "GNOSISGlobalGrid"},
    "isea3h": {"min_res": 0, "max_res": 33, "default_res": 27, "class_name": "ISEA3H"},
    "isea9r": {"min_res": 0, "max_res": 16, "default_res": 13, "class_name": "ISEA9R"},
    "ivea3h": {"min_res": 0, "max_res": 33, "default_res": 27, "class_name": "IVEA3H"},
    "ivea9r": {"min_res": 0, "max_res": 16, "default_res": 13, "class_name": "IVEA9R"},
    "rtea3h": {"min_res": 0, "max_res": 33, "default_res": 27, "class_name": "RTEA3H"},
    "rtea9r": {"min_res": 0, "max_res": 16, "default_res": 13, "class_name": "RTEA9R"},
    "rhealpix": {"min_res": 0, "max_res": 16, "default_res": 14, "class_name": "rHEALPix"}
}

DGGRID_TYPES = {
   "SUPERFUND": {"min_res": 0, "max_res": 9, "default_res": 6}, # error when calling dggrid_instance.grid_stats_table
   "PLANETRISK": {"min_res": 0, "max_res": 22, "default_res": 17},
   "ISEA3H": {"min_res": 0, "max_res": 35, "default_res": 27}, 
   "ISEA4H": {"min_res": 0, "max_res": 30, "default_res": 21}, 
   "ISEA4T": {"min_res": 0, "max_res": 29, "default_res": 20}, 
   "ISEA4D": {"min_res": 0, "max_res": 30, "default_res": 21},      
   "ISEA43H": {"min_res": 0, "max_res": 35, "default_res":27},
   "ISEA7H": {"min_res": 0, "max_res": 21, "default_res": 15},
   "IGEO7": {"min_res": 0, "max_res": 20, "default_res": 15}, # error when calling dggrid_instance.grid_stats_table
   "FULLER3H": {"min_res": 0, "max_res": 35, "default_res":27 },
   "FULLER4H": {"min_res": 0, "max_res": 30, "default_res": 21},
   "FULLER4T": {"min_res": 0, "max_res": 29, "default_res": 20},
   "FULLER4D": {"min_res": 0, "max_res": 30, "default_res": 21},
   "FULLER43H": {"min_res": 0, "max_res": 35, "default_res":27},
   "FULLER7H": {"min_res": 0, "max_res": 21, "default_res": 15}
}

DGGS_TYPES = {
    "h3": {"min_res": 0, "max_res": 15, "default_res": 14},
    "s2": {"min_res": 0, "max_res": 30, "default_res": 22},
    "a5": {"min_res": 0, "max_res": 29, "default_res": 14},         
    "healpix": {"min_res": 0, "max_res": 29, "default_res": 18}, # to be checked
    "rhealpix": {"min_res": 0, "max_res": 15, "default_res": 14},
    "isea4t": {"min_res": 0, "max_res": 39, "default_res": 21},
    "isea3h": {"min_res": 0, "max_res": 40, "default_res": 27},
    "ease": {"min_res": 0, "max_res": 6, "default_res": 5},
    "qtm": {"min_res": 1, "max_res": 24, "default_res": 24},
    "olc": {"min_res": 2, "max_res": 15, "default_res": 11},
    "geohash": {"min_res": 1, "max_res": 12, "default_res": 9},
    "georef": {"min_res": 0, "max_res": 10, "default_res": 4},
    "mgrs": {"min_res": 0, "max_res": 5, "default_res": 4},
    "tilecode": {"min_res": 0, "max_res": 29, "default_res": 23},
    "quadkey": {"min_res": 0, "max_res": 29, "default_res": 23},
    "maidenhead": {"min_res": 1, "max_res": 4, "default_res": 4},
    "gars": {"min_res": 1, "max_res": 4, "default_res": 4}    
}

DGGS_INSPECT = {
    "h3": {"min_res": 2, "max_res": 4,},
    "s2": {"min_res": 2, "max_res": 8,},
    "a5": {"min_res": 2, "max_res": 7,},   
    "isea4t": {"min_res": 2, "max_res": 7},
    "rhealpix": {"min_res": 2, "max_res": 5},
    "dggrid_isea4t": {"min_res": 2, "max_res": 5}, # 6,7 beinng created seperaetaly due to large size
    "dggrid_fuller4t": {"min_res": 2, "max_res": 5}, # 6,7 beinng created seperaetaly due to large size
    "dggrid_isea4d": {"min_res": 2, "max_res": 5}, # 6,7 beinng created seperaetaly due to large size
    "dggrid_fuller4d": {"min_res": 2, "max_res": 5}, # 6,7 beinng created seperaetaly due to large size
    "dggrid_isea7h": {"min_res": 2, "max_res": 4}, # 5 beinng created seperaetaly due to large size
    "dggrid_fuller7h": {"min_res": 2, "max_res": 4}, # 5 beinng created seperaetaly due to large size
    "dggal_isea3h": {"min_res": 2, "max_res": 9}, 
    "dggal_isea9r": {"min_res": 2, "max_res": 5}
    }
