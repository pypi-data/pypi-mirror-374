...
from vgrid.utils.io import process_input_data_bin, convert_to_output_format, validate_h3_resolution
...
def h3_bin(data, resolution, stats="count", category=None, numeric_field=None, lat_col="lat", lon_col="lon", **kwargs):
    """
    ...
    # Build aggregation on joined data
        ...
        if category:
            if stats == "count":
                ...
                if numeric_field is None:
                    raise ValueError(f"numeric_field required for stats='{stats}'")
