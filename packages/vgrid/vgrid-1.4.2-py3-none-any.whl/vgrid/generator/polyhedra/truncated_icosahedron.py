"""
Truncated Icosahedron Grid Generator Module

Generates Truncated Icosahedron DGGS grids with automatic cell generation and validation for truncated icosahedral polyhedron representation using icosahedron geometry.

Key Functions:
- truncated_icosahedron(): Main grid generation function for truncated icosahedral polyhedron
- truncated_icosahedron_cli(): Command-line interface for grid generation
"""
