...
- S2 compact mode to reduce cell count for polygons
...
def point2s2(
    ...
    Returns:
        list: List of dictionaries representing S2 cells containing the point(s)
...
def polyline2hs2(
    ...
    Example:
        ...
        >>> cells = polyline2hs2(line, 10, {"name": "route"})
        >>> len(cells) > 0
        True
    """
    s2_rows = []
...
def polygon2hs2(
    ...
    Example:
        ...
        >>> cells = polygon2hs2(poly, 10, {"name": "area"}, predicate="intersect")
        >>> len(cells) > 0
        True
    """
    s2_rows = []
