...
from vgrid.utils.io import process_input_data_vector, convert_to_output_format, validate_dggal_type, validate_dggal_resolution
...
def vector2dggal(
    ...
    **kwargs,
    ...
    result = geodataframe2dggal(
        dggs_type, gdf_input, resolution, predicate, compact, topology, include_properties
    )
