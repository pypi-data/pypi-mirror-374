"""
ISEA3H Grid Conversion Module

This module provides comprehensive functionality for converting vector geometries to ISEA3H grid cells.
ISEA3H is a hierarchical geospatial indexing system that divides the Earth's surface into cells of
varying resolutions, from 0 (coarsest) to 32 (finest).

Key Features:
- Convert points, lines, and polygons to ISEA3H grid cells
...
- Topology preservation mode to ensure disjoint features have disjoint ISEA3H cells
- ISEA3H compact mode to reduce cell count for polygons
...
The module uses the EAGGR library for ISEA3H hierarchical geospatial indexing and supports
...
def point2isea3h(
    ...
    Returns:
        list: List of dictionaries representing ISEA3H cells containing the point(s)
