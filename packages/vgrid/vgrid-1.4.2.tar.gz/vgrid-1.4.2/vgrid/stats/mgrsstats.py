...
def mgrs_metrics(res, unit: str = "m"):    
    ...
    cls = characteristic_length_scale(avg_cell_area*(10**(-6)), unit=unit) # convert avg_cell_area to m2 before calling characteristic_length_scale
...
def mgrsstats(unit: str = "m"):
    ...
    for res in range(min_res, max_res + 1):
        num_cells, avg_edge_len, avg_cell_area, cls = mgrs_metrics(res, unit=unit)
