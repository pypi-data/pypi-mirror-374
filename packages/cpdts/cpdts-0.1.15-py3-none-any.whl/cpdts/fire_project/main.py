...
def fire_create(project_name):
    ...
    items = {
        ...
        f"src/{project_name}/decorators/singleton.py":{
            "template": "templates/decorators/singleton.py",
        },
        f"src/{project_name}/utils/dialog.py":{
            "template": "templates/utils/dialog.py",
        },
        f"src/{project_name}/scripts/clean.py":{
            "template": "templates/scripts/clean.py",
        },
        "pyproject.toml":{
