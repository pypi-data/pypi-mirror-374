...
from israel_open_banking.core.ssl_adapter import send_get_request, send_post_request


class MizrahiBankService:
    def __init__(self, consent_id: str, access_token: str, psu_id: str) -> None:
        ...
        self.ca_cert = config.MIZRAHI_CA_CERT_PATH
        self.url_builder = BankUrlBuilder(
            api_base_url=config.MIZRAHI_API_URL,
        )
    ...
    def _signed_get(self, endpoint: str, params: Optional[dict] = None):
        ...
        # 3. Sign the request
        headers, _ = build_headers(Aspsp.MIZRAHI,
                                   {},
                                   extra_headers={
                                       "psu_id": self.psu_id,
