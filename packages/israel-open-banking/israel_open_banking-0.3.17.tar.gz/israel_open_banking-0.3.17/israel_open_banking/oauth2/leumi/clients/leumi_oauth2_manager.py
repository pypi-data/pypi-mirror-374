...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.leumi.clients.leumi_oauth2_client import LeumiOAuth2Client


class LeumiOAuth2Manager(OAuth2Manager):
    def __init__(self, client: LeumiOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: LeumiOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Leumi Bank API.
