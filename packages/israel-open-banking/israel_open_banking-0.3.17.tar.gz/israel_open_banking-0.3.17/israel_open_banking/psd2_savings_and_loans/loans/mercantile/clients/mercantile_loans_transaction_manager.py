...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.mercantile.clients.mercantile_loans_ais_client import \
        MercantileAISLoansClient


class MercantileLoansTransactionManager(AISLoansTransactionManager):
    def __init__(self, ais_client: MercantileAISLoansClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: MercantileAISLoansClient = ais_client
