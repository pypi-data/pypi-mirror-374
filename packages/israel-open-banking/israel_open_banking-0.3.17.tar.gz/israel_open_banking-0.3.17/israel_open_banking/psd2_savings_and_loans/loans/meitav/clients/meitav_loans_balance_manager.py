...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.meitav.clients.meitav_loans_ais_client import \
        MeitavAISLoansClient


class MeitavLoansBalanceManager(AISLoansBalanceManager):
    """Handles /accounts/{id}/balances endpoints for Meitav-Bank."""

    def __init__(self, ais_client: MeitavAISLoansClient) -> None:
        super().__init__(ais_client)
        self.ais_client: MeitavAISLoansClient = ais_client
