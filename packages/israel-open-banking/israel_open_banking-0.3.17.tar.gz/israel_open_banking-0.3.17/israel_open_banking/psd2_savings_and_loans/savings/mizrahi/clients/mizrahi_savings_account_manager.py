...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.mizrahi.clients.mizrahi_savings_ais_client import \
        MizrahiAISSavingsClient


class MizrahiSavingsAccountManager(AISSavingsAccountManager):
