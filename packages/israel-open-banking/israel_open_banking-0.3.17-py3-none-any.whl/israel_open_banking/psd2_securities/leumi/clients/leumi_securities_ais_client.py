...
from israel_open_banking.core.ais.securities.models import SecuritiesAccountList, SecuritiesAccountDetails, \
    ...
    SecuritiesOrder
from israel_open_banking.psd2_securities.leumi.clients.leumi_securities_account_manager import \
    LeumiSecuritiesAccountManager
from israel_open_banking.psd2_securities.leumi.clients.leumi_securities_order_manager import \
    LeumiSecuritiesOrderManager
from israel_open_banking.psd2_securities.leumi.clients.leumi_securities_position_manager import \
    LeumiSecuritiesPositionManager
from israel_open_banking.psd2_securities.leumi.clients.leumi_securities_transaction_manager import \
    LeumiSecuritiesTransactionManager
from israel_open_banking.psd2_securities.leumi.services.leumi_securities_bank_service import \
    LeumiBankSecuritiesService
...
class LeumiAISSecuritiesClient(AISSecuritiesBaseClient):
    """PSD2‑compliant AIS adapter for Leumi Bank."""

    def __init__(self, service: LeumiBankSecuritiesService) -> None:
        super().__init__(client=None)  # We do not use a generic OpenBankingClient
        self._svc: LeumiBankSecuritiesService = service

        # plug‑in concrete managers
        self.accounts: LeumiSecuritiesAccountManager = LeumiSecuritiesAccountManager(self)
        self.positions: LeumiSecuritiesPositionManager = LeumiSecuritiesPositionManager(self)
        self.transactions: LeumiSecuritiesTransactionManager = LeumiSecuritiesTransactionManager(self)
        self.orders: LeumiSecuritiesOrderManager = LeumiSecuritiesOrderManager(self)
    ...
    @property
    def svc(self) -> LeumiBankSecuritiesService:
        return self._svc
