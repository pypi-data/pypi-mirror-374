...
class AmericanExpressSingleCardsService:
    def __init__(self, consent_id: str, access_token: str, psu_id: str) -> None:
        ...
        self.ca_cert = config.AMERICAN_EXPRESS_CA_CERT_PATH
        self.url_builder = BankUrlBuilder(
            api_base_url=config.AMERICAN_EXPRESS_API_URL
        )
    ...
    def _signed_get(self, endpoint: str, params: Optional[dict] = None) -> requests.Response:
        ...
        # 3. Sign the request
        headers, _ = build_headers(Aspsp.AMEX,
                                   {},
                                   extra_headers={
                                       "psu_id": self.psu_id,
