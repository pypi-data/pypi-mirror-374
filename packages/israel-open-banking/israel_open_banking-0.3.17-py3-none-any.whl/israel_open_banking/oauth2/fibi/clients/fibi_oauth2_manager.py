...
class FibiOAuth2Manager(OAuth2Manager):
    def __init__(self, client: FibiOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: FibiOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Fibi Bank API.
