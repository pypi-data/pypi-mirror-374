...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.fibi.clients.fibi_savings_ais_client import \
        FibiAISSavingsClient


class FibiSavingsAccountManager(AISSavingsAccountManager):
