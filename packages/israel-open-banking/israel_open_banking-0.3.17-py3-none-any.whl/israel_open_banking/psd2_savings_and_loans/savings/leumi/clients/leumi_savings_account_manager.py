...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.leumi.clients.leumi_savings_ais_client import \
        LeumiAISSavingsClient


class LeumiSavingsAccountManager(AISSavingsAccountManager):
