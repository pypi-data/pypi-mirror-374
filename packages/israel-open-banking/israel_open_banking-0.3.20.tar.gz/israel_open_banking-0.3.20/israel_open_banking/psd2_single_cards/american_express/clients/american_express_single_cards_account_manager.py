...
if TYPE_CHECKING:
    from israel_open_banking.psd2_single_cards.american_express.clients.american_express_single_cards_ais_client import \
        AmericanExpressAISSingleCardsClient


class AmericanExpressSingleCardsManager(AISSingleCardsManager):
