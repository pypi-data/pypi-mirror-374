...
class AISSecuritiesException(Exception):
...
class AISConsentSecuritiesException(AISSecuritiesException):
...
class AISAccountSecuritiesException(AISSecuritiesException):
...
class AISTransactionSecuritiesException(AISSecuritiesException):
...
class AISPositionSecuritiesException(AISSecuritiesException):
...
class AISOrderSecuritiesException(AISSecuritiesException):
