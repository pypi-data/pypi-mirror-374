...
class MercantileSecuritiesPositionManager(AISSecuritiesPositionManager):
    """Handles /securities-accounts/{id}/positions endpoints for Mercantile-Bank."""

    def __init__(self, ais_client: MercantileAISSecuritiesClient) -> None:
