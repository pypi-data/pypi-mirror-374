...
class DiscountSecuritiesPositionManager(AISSecuritiesPositionManager):
    """Handles /securities-accounts/{id}/positions endpoints for Discount-Bank."""

    def __init__(self, ais_client: DiscountAISSecuritiesClient) -> None:
        super().__init__(ais_client)
        self.ais_client: DiscountAISSecuritiesClient = ais_client
