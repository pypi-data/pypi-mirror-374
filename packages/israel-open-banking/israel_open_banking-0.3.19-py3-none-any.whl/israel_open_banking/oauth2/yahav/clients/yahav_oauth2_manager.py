...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.yahav.clients.yahav_oauth2_client import YahavOAuth2Client


class YahavOAuth2Manager(OAuth2Manager):
    def __init__(self, client: YahavOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: YahavOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Yahav Bank API.
