...
from israel_open_banking.core.ais.securities.models import SecuritiesAccountList, SecuritiesAccountDetails, \
    ...
    SecuritiesOrder
from israel_open_banking.psd2_securities.mizrahi.clients.mizrahi_securities_account_manager import \
    MizrahiSecuritiesAccountManager
from israel_open_banking.psd2_securities.mizrahi.clients.mizrahi_securities_order_manager import \
    MizrahiSecuritiesOrderManager
from israel_open_banking.psd2_securities.mizrahi.clients.mizrahi_securities_position_manager import \
    MizrahiSecuritiesPositionManager
from israel_open_banking.psd2_securities.mizrahi.clients.mizrahi_securities_transaction_manager import \
    MizrahiSecuritiesTransactionManager
from israel_open_banking.psd2_securities.mizrahi.services.mizrahi_securities_bank_service import \
    MizrahiBankSecuritiesService
...
class MizrahiAISSecuritiesClient(AISSecuritiesBaseClient):
    """PSD2‑compliant AIS adapter for Mizrahi Bank."""

    def __init__(self, service: MizrahiBankSecuritiesService) -> None:
        super().__init__(client=None)  # We do not use a generic OpenBankingClient
        self._svc: MizrahiBankSecuritiesService = service

        # plug‑in concrete managers
        self.accounts: MizrahiSecuritiesAccountManager = MizrahiSecuritiesAccountManager(self)
        self.positions: MizrahiSecuritiesPositionManager = MizrahiSecuritiesPositionManager(self)
        self.transactions: MizrahiSecuritiesTransactionManager = MizrahiSecuritiesTransactionManager(self)
        self.orders: MizrahiSecuritiesOrderManager = MizrahiSecuritiesOrderManager(self)
    ...
    @property
    def svc(self) -> MizrahiBankSecuritiesService:
        return self._svc
