...
class AISSavingsAndLoansException(Exception):
...
class AISConsentSavingsAndLoansException(AISSavingsAndLoansException):
...
class AISAccountSavingsAndLoansException(AISSavingsAndLoansException):
...
class AISTransactionSavingsAndLoansException(AISSavingsAndLoansException):
...
class AISBalanceSavingsAndLoansException(AISSavingsAndLoansException):
