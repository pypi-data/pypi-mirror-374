...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.one_zero.clients.one_zero_oauth2_client import OneZeroOAuth2Client


class OneZeroOAuth2Manager(OAuth2Manager):
    def __init__(self, client: OneZeroOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: OneZeroOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the OneZero Bank API.
