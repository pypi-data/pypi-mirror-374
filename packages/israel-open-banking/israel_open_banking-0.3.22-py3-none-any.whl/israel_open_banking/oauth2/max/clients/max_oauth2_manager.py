...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.max.clients.max_oauth2_client import MaxOAuth2Client


class MaxOAuth2Manager(OAuth2Manager):
    def __init__(self, client: MaxOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: MaxOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Max Bank API.
