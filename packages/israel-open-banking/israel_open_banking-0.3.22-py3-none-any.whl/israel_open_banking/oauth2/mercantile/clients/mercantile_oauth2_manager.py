...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.mercantile.clients.mercantile_oauth2_client import MercantileOAuth2Client


class MercantileOAuth2Manager(OAuth2Manager):
    def __init__(self, client: MercantileOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: MercantileOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Discount Bank API.
