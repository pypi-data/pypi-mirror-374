...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.mizrahi.clients.mizrahi_loans_ais_client import \
        MizrahiAISLoansClient


class MizrahiLoansTransactionManager(AISLoansTransactionManager):
    def __init__(self, ais_client: MizrahiAISLoansClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: MizrahiAISLoansClient = ais_client
