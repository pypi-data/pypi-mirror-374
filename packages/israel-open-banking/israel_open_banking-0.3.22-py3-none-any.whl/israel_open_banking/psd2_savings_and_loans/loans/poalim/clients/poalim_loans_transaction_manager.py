...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.poalim.clients.poalim_loans_ais_client import \
        PoalimAISLoansClient


class PoalimLoansTransactionManager(AISLoansTransactionManager):
    def __init__(self, ais_client: PoalimAISLoansClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: PoalimAISLoansClient = ais_client
