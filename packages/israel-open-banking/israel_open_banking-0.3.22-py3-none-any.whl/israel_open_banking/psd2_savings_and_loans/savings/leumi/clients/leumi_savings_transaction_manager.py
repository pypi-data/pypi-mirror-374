...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.leumi.clients.leumi_savings_ais_client import LeumiAISSavingsClient


class LeumiSavingsTransactionManager(AISSavingsTransactionManager):
    def __init__(self, ais_client: LeumiAISSavingsClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: LeumiAISSavingsClient = ais_client
