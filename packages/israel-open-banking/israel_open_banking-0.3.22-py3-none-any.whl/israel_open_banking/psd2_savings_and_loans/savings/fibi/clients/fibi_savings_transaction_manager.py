...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.fibi.clients.fibi_savings_ais_client import FibiAISSavingsClient


class FibiSavingsTransactionManager(AISSavingsTransactionManager):
    def __init__(self, ais_client: FibiAISSavingsClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: FibiAISSavingsClient = ais_client
