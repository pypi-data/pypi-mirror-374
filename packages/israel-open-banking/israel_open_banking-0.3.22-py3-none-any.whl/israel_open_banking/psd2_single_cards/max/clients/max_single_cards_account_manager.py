...
if TYPE_CHECKING:
    from israel_open_banking.psd2_single_cards.max.clients.max_single_cards_ais_client import \
        MaxAISSingleCardsClient


class MaxSingleCardsManager(AISSingleCardsManager):
