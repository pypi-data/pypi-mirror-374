...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.discount.clients.discount_loans_ais_client import \
        DiscountAISLoansClient


class DiscountLoansTransactionManager(AISLoansTransactionManager):
    def __init__(self, ais_client: DiscountAISLoansClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: DiscountAISLoansClient = ais_client
