...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.isracard.clients.isracard_oauth2_client import IsracardOAuth2Client


class IsracardOAuth2Manager(OAuth2Manager):
    def __init__(self, client: IsracardOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: IsracardOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Isracard Bank API.
