...
class PoalimOAuth2Manager(OAuth2Manager):
    def __init__(self, client: PoalimOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: PoalimOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Poalim Bank API.
