...
if TYPE_CHECKING:
    from israel_open_banking.psd2_general.one_zero.clients.one_zero_ais_client import OneZeroAISClient


class OneZeroBalanceManager(AISBalanceManager):
    """Handles /accounts/{id}/balances endpoints for OneZero-Bank."""

    def __init__(self, ais_client: OneZeroAISClient) -> None:
        super().__init__(ais_client)
        self.ais_client: OneZeroAISClient = ais_client
