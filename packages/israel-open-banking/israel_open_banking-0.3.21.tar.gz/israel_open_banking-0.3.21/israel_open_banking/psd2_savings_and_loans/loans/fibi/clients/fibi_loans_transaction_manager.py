...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.fibi.clients.fibi_loans_ais_client import \
        FibiAISLoansClient


class FibiLoansTransactionManager(AISLoansTransactionManager):
    def __init__(self, ais_client: FibiAISLoansClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: FibiAISLoansClient = ais_client
