...
class MaxLoansBalanceManager(AISLoansBalanceManager):
    """Handles /accounts/{id}/balances endpoints for Max-Bank."""

    def __init__(self, ais_client: MaxAISLoansClient) -> None:
