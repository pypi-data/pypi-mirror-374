...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.meitav.clients.meitav_oauth2_client import MeitavOAuth2Client


class MeitavOAuth2Manager(OAuth2Manager):
    def __init__(self, client: MeitavOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: MeitavOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Meitav Bank API.
