...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.mercantile.clients.mercantile_savings_ais_client import MercantileAISSavingsClient


class MercantileSavingsTransactionManager(AISSavingsTransactionManager):
    def __init__(self, ais_client: MercantileAISSavingsClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: MercantileAISSavingsClient = ais_client
