...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.poalim.clients.poalim_savings_ais_client import \
        PoalimAISSavingsClient


class PoalimSavingsAccountManager(AISSavingsAccountManager):
