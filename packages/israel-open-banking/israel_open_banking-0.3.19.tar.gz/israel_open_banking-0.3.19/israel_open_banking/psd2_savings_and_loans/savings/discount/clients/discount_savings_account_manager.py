...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.discount.clients.discount_savings_ais_client import \
        DiscountAISSavingsClient


class DiscountSavingsAccountManager(AISSavingsAccountManager):
