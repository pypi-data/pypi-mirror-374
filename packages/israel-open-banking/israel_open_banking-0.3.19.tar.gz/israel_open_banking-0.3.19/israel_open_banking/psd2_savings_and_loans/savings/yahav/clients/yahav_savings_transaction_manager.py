...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.yahav.clients.yahav_savings_ais_client import YahavAISSavingsClient


class YahavSavingsTransactionManager(AISSavingsTransactionManager):
    def __init__(self, ais_client: YahavAISSavingsClient) -> None:  # noqa: D401
