...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.pepper.clients.pepper_savings_ais_client import PepperAISSavingsClient


class PepperSavingsTransactionManager(AISSavingsTransactionManager):
    def __init__(self, ais_client: PepperAISSavingsClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: PepperAISSavingsClient = ais_client
