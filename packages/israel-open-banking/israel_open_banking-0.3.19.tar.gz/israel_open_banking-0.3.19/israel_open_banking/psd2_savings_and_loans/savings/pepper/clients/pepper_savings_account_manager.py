...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.pepper.clients.pepper_savings_ais_client import \
        PepperAISSavingsClient


class PepperSavingsAccountManager(AISSavingsAccountManager):
