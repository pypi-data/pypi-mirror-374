...
class DiscountTransactionManager(AISTransactionManager):
    def __init__(self, ais_client: DiscountAISClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: DiscountAISClient = ais_client
