...
if TYPE_CHECKING:
    from israel_open_banking.psd2_securities.mizrahi.clients.mizrahi_securities_ais_client import \
        MizrahiAISSecuritiesClient


class MizrahiSecuritiesPositionManager(AISSecuritiesPositionManager):
    """Handles /securities-accounts/{id}/positions endpoints for Mizrahi-Bank."""

    def __init__(self, ais_client: MizrahiAISSecuritiesClient) -> None:
        super().__init__(ais_client)
        self.ais_client: MizrahiAISSecuritiesClient = ais_client
