...
from israel_open_banking.core.ais.securities.models import SecuritiesAccountList, SecuritiesAccountDetails, \
    ...
    SecuritiesOrder
from israel_open_banking.psd2_securities.yahav.clients.yahav_securities_account_manager import \
    YahavSecuritiesAccountManager
from israel_open_banking.psd2_securities.yahav.clients.yahav_securities_order_manager import \
    YahavSecuritiesOrderManager
from israel_open_banking.psd2_securities.yahav.clients.yahav_securities_position_manager import \
    YahavSecuritiesPositionManager
from israel_open_banking.psd2_securities.yahav.clients.yahav_securities_transaction_manager import \
    YahavSecuritiesTransactionManager
from israel_open_banking.psd2_securities.yahav.services.yahav_securities_bank_service import \
    YahavBankSecuritiesService
...
class YahavAISSecuritiesClient(AISSecuritiesBaseClient):
    """PSD2‑compliant AIS adapter for Yahav Bank."""

    def __init__(self, service: YahavBankSecuritiesService) -> None:
        super().__init__(client=None)  # We do not use a generic OpenBankingClient
        self._svc: YahavBankSecuritiesService = service

        # plug‑in concrete managers
        self.accounts: YahavSecuritiesAccountManager = YahavSecuritiesAccountManager(self)
        self.positions: YahavSecuritiesPositionManager = YahavSecuritiesPositionManager(self)
        self.transactions: YahavSecuritiesTransactionManager = YahavSecuritiesTransactionManager(self)
        self.orders: YahavSecuritiesOrderManager = YahavSecuritiesOrderManager(self)
    ...
    @property
    def svc(self) -> YahavBankSecuritiesService:
        return self._svc
