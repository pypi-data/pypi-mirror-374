...
if TYPE_CHECKING:
    from israel_open_banking.psd2_securities.fibi.clients.fibi_securities_ais_client import \
        FibiAISSecuritiesClient


class FibiSecuritiesPositionManager(AISSecuritiesPositionManager):
    """Handles /securities-accounts/{id}/positions endpoints for Fibi-Bank."""

    def __init__(self, ais_client: FibiAISSecuritiesClient) -> None:
        super().__init__(ais_client)
        self.ais_client: FibiAISSecuritiesClient = ais_client
