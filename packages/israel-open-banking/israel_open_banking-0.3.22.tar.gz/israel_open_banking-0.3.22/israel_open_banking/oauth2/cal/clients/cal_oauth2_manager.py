...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.cal.clients.cal_oauth2_client import CalOAuth2Client


class CalOAuth2Manager(OAuth2Manager):
    def __init__(self, client: CalOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: CalOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the Cal Bank API.
