...
if TYPE_CHECKING:
    from israel_open_banking.oauth2.american_express.clients.american_express_oauth2_client import AmericanExpressOAuth2Client


class AmericanExpressOAuth2Manager(OAuth2Manager):
    def __init__(self, client: AmericanExpressOAuth2Client) -> None:  # noqa: D401
        super().__init__(client)
        self.client: AmericanExpressOAuth2Client = client

    def get_access_token(self) -> str:
        """
        Retrieves the access token for the AmericanExpress Bank API.
