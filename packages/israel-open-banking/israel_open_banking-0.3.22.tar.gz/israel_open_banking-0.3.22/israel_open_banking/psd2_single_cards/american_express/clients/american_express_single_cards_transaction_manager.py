...
class AmericanExpressSingleCardsTransactionManager(AISSingleCardsTransactionManager):
    def __init__(self, ais_client: AmericanExpressAISSingleCardsClient) -> None:  # noqa: D401
