...
if TYPE_CHECKING:
    from israel_open_banking.psd2_single_cards.max.clients.max_single_cards_ais_client import MaxAISSingleCardsClient


class MaxSingleCardsBalanceManager(AISSingleCardsBalanceManager):
    """Handles /accounts/{id}/balances endpoints for Max."""

    def __init__(self, ais_client: MaxAISSingleCardsClient) -> None:
        super().__init__(ais_client)
        self.ais_client: MaxAISSingleCardsClient = ais_client
