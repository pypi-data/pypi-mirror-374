...
if TYPE_CHECKING:
    from israel_open_banking.psd2_single_cards.cal.clients.cal_single_cards_ais_client import \
        CalAISSingleCardsClient


class CalSingleCardsManager(AISSingleCardsManager):
    def __init__(self, ais_client: "CalAISSingleCardsClient") -> None:
