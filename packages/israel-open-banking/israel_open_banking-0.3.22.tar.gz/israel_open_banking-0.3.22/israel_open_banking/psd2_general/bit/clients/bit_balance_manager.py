...
class BitBalanceManager(AISBalanceManager):
    """Handles /accounts/{id}/balances endpoints for Bit-Bank."""

    def __init__(self, ais_client: BitAISClient) -> None:
        super().__init__(ais_client)
        self.ais_client: BitAISClient = ais_client
