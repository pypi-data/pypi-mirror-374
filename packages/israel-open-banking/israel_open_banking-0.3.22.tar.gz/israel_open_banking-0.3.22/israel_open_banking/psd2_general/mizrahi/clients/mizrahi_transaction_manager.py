...
if TYPE_CHECKING:
    from israel_open_banking.psd2_general.mizrahi.clients.mizrahi_ais_client import MizrahiAISClient


class MizrahiTransactionManager(AISTransactionManager):
    def __init__(self, ais_client: MizrahiAISClient) -> None:  # noqa: D401
        super().__init__(ais_client)
        self.ais_client: MizrahiAISClient = ais_client
