...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.savings.mercantile.clients.mercantile_savings_ais_client import \
        MercantileAISSavingsClient


class MercantileSavingsAccountManager(AISSavingsAccountManager):
