...
if TYPE_CHECKING:
    from israel_open_banking.psd2_savings_and_loans.loans.leumi.clients.leumi_loans_ais_client import \
        LeumiAISLoansClient


class LeumiLoansAccountManager(AISLoansAccountManager):
    def __init__(self, ais_client: "LeumiAISLoansClient") -> None:
        super().__init__(ais_client)
        self.ais_client: "LeumiAISLoansClient" = ais_client
