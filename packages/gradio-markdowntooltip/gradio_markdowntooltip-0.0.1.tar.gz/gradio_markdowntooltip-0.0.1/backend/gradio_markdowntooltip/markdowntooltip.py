...
class MarkdownTooltip(Component):
    """
    Used to render arbitrary MarkdownTooltip output with an optional tooltip. Can also render latex enclosed by dollar signs. As this component does not accept user input,
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            value: Value to show in MarkdownTooltip component. If a function is provided, the function will be called each time the app loads to set the initial value of this component.
            tooltip: Optional tooltip text to show when hovering over the (?) icon. If not provided, no tooltip icon will be displayed.
            ...
            line_breaks: If True, will enable Github-flavored MarkdownTooltip line breaks in chatbot messages. If False (default), single new lines will be ignored.
            ...
            show_copy_button: If True, includes a copy button to copy the text in the MarkdownTooltip component. Default is False.
            container: If True, the MarkdownTooltip component will be displayed in a container. Default is False.
            padding: If True, the MarkdownTooltip component will have a certain padding (set by the `--block-padding` CSS variable) in all directions. Default is False.
        """
    ...
    def preprocess(self, payload: str | None) -> str | None:
        """
        Parameters:
            payload: the `str` of MarkdownTooltip corresponding to the displayed value.
        Returns:
            Passes the `str` of MarkdownTooltip corresponding to the displayed value.
        """
        return payload
    ...
    def postprocess(self, value: str | I18nData | None) -> str | dict | None:
        """
        Parameters:
            value: Expects a valid `str` that can be rendered as MarkdownTooltip.
        Returns:
