...
from ..utils.core import run_command, get_apk_patchx_home, download_file
...
class AndroidSDKService:
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.sdk_root = get_apk_patchx_home() / "tools" / "sdk"
        self.cmdline_tools_dir = get_apk_patchx_home() / "tools" / "cmdline-tools"
    ...
    def ensure_cmdline_tools(self) -> None:
        ...
        zip_path = get_apk_patchx_home() / "tools" / "commandlinetools.zip"
        ...
        with zipfile.ZipFile(zip_path, 'r') as zip_ref:
            zip_ref.extractall(get_apk_patchx_home() / "tools")
