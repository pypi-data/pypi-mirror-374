...
from ..utils.core import run_command, get_apk_patchx_home
...
class SigningService:
    ...
    def keystore_path(self) -> Path:
        ...
        if self._keystore_path is None:
            keystore_path = get_apk_patchx_home() / "debug.keystore"
    ...
    def _generate_debug_keystore(self, keystore_path: Path) -> None:
        ...
        cmd = [
            ...
            "-alias", "apk_patchx_debug",
            "-keyalg", "RSA",
            "-keysize", "2048",
            "-validity", "10000",
            "-storepass", "apk_patchx",
            "-keypass", "apk_patchx",
    ...
    def _apksigner_sign(self, apk_path: Path, output_path: Path) -> Path:
        ...
        cmd = [
            ...
            "--ks-key-alias", "apk_patchx_debug",
            "--ks-pass", "pass:apk_patchx",
            "--key-pass", "pass:apk_patchx",
            "--out", str(output_path),
            str(apk_path)
        ]
