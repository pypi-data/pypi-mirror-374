...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for moon in moons:
            ...
            report_dict = {"Region": str(moon_region.name), "Constalation": str(moon_system.eve_constellation),"System": str(moon_system.name), 
        ...
        fields = ['Region', 'Constalation', 'System', 'Moon','Rarity Class' ,'Total Value', 'Drill value', 'Razor Tax', 'EDGE Tax', 'Material']
