...
class MedicationApi:
    ...
    def get_medications(
        self,
        q: Annotated[Optional[StrictStr], Field(description="Filter medications by query.  Searches the drug description, scd, sbd, strength and drug form and ndcs for the medication.")] = None,
        pricing_program: Optional[StrictStr] = None,
        ...
        deep: Annotated[Optional[StrictBool], Field(description="If true, returns contained objects for the medication.  If false, returns only the minimum fields.  Defaults to false.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param q: Filter medications by query.  Searches the drug description, scd, sbd, strength and drug form and ndcs for the medication.
        :type q: str
        :param pricing_program:
        :type pricing_program: str
        ...
        :param deep: If true, returns contained objects for the medication.  If false, returns only the minimum fields.  Defaults to false.
        :type deep: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
