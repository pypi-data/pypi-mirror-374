...
import sys
from types import SimpleNamespace as Namespace, TracebackType
...
class NullFile(TextIO, IO[str]):
    ...
    def __exit__(self, __t: type[BaseException] | None, __v: BaseException | None, __tra: TracebackType | None) -> None:
        """Nothing to clean up."""
