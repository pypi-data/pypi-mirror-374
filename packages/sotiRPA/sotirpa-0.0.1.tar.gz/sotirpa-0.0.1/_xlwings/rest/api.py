...
# TODO: proper exception handling in _xlwings base package so it can be used here
import logging
import sys
...
from _xlwings.rest.serializers import (
    serialize_app,
    serialize_book,
    serialize_chart,
    serialize_name,
...
try:
    ...
    raise Exception(
        "To use the _xlwings REST API server, you need Flask>=1.0.0 installed."
    )
