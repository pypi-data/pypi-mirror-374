"""
_xlwings - Make Excel fly with Python!
        ...
        if isinstance(name_or_index, numbers.Number):
            ...
            try:
                ...
                engine_to_product_name = {
                    "remote": "_xlwings Server",
                    "calamine": "_xlwings Reader",
                }
                if not _xlwings.__pro__ and name_or_index != "excel":
                    raise LicenseError(
                        f"{engine_to_product_name.get(name_or_index, name_or_index)} "
                        "requires a license key. Install one by running '_xlwings "
...
class App:
    ...
    An app object is a member of the :meth:`apps <_xlwings.main.Apps>` collection:
    ...
    spec : str, default None
        ...
        On Windows, if you want to change the version of Excel that _xlwings talks to, go
        to ``Control Panel > Programs and Features`` and ``Repair`` the Office version
        that you want as default.


    .. note::
        On Mac, while _xlwings allows you to run multiple instances of Excel, it's a
    ...
    def startup_path(self):
        """
        Returns the path to ``XLSTART`` which is where the _xlwings add-in gets
        copied to by doing ``_xlwings addin install``.
    ...
    def render_template(self, template=None, output=None, book_settings=None, **data):
        """
        This function requires _xlwings :bdg-secondary:`PRO`.

        This is a convenience wrapper around :meth:`mysheet.render_template
        <_xlwings.Sheet.render_template>`
        ...
        book_settings: dict, default None
            A dictionary of ``_xlwings.Book`` parameters, for details see:
            :attr:`_xlwings.Book`.
    ...
    def alert(self, prompt, title=None, buttons="ok", mode=None, callback=None):
        ...
        the value of the pressed button. For _xlwings Server, instead of
        ...
        callback : str, default None
            Only used by _xlwings Server: you can provide the name of a
        ...
        button_value: str or None
            Returns ``None`` when used with _xlwings Server, otherwise the value
...
class Book:
    ...
    def json(self):
        ...
        Google Apps Script _xlwings module. Only available with book objects that have
    ...
    def caller(cls):
        ...
        if hasattr(Book, "_mock_caller"):
            ...
            name = wb.lower()
            if sys.platform.startswith("win"):
                app = App(impl=_xlwings._xlwindows.App(xl=int(hwnd)))
        ...
        elif _xlwings._xlwindows.BOOK_CALLER:
            # Called via OPTIMIZED_CONNECTION = True
            return cls(impl=_xlwings._xlwindows.Book(_xlwings._xlwindows.BOOK_CALLER))
        else:
            raise Exception(
    ...
    def set_mock_caller(self):
        ...
        ::
            ...
            def my_macro():
                ...
                sht.range('A1').value = 'Hello _xlwings!'
    ...
    def to_pdf(
        ...
        layout : str or path-like object, default None
            This argument requires _xlwings :bdg-secondary:`PRO`.
        ...
        See also :meth:`_xlwings.Sheet.to_pdf`
...
class Sheet:
    ...
    def to_pdf(self, path=None, layout=None, show=False, quality="standard"):
        ...
        See also :meth:`_xlwings.Book.to_pdf`
    ...
    def charts(self):
        """
        See :meth:`Charts <_xlwings.main.Charts>`
    ...
    def shapes(self):
        """
        See :meth:`Shapes <_xlwings.main.Shapes>`
    ...
    def tables(self):
        """
        See :meth:`Tables <_xlwings.main.Tables>`
    ...
    def pictures(self):
        """
        See :meth:`Pictures <_xlwings.main.Pictures>`
...
class Range:
    ...
    def raw_value(self):
        ...
        _xlwings' data cleaning/converting. This can be helpful if speed is an issue but
    ...
    def value(self):
        """
        Gets and sets the values for the given Range. See :meth:`_xlwings.Range.options`
        ...
        object : returned object depends on the converter being used,
                 see :meth:`_xlwings.Range.options`
        """
    ...
    def copy(self, destination=None):
        ...
        destination : xlwings.Range
            _xlwings Range to which the specified range will be copied. If omitted,
...
class Shape:
    ...
    def text(self, value):
        if _xlwings.__pro__:
            from _xlwings.pro import Markdown
            from _xlwings.pro.reports.markdown import format_text, render_text
...
class Table:
    ...
    def data_body_range(self):
        """Returns an _xlwings range object that represents the range of values,
    ...
    def header_row_range(self):
        """Returns an _xlwings range object that represents the range of the header row"""
    ...
    def insert_row_range(self):
        """Returns an _xlwings range object representing the row where data is going to
    ...
    @property
    def range(self):
        """Returns an _xlwings range object of the table."""
    ...
    def table_style(self):
        ...
        See :meth:`Tables.add <_xlwings.main.Tables.add>` for possible values.
        """
    ...
    def totals_row_range(self):
        """Returns an _xlwings range object representing the Total row"""
    ...
    def resize(self, range):
        """Resize a Table by providing an _xlwings range object
    ...
    def impl(self):
        if engines.active is None:
            if not (
                ...
                raise XlwingsError(
                    "The interactive mode of _xlwings is only supported on Windows and "
                    "macOS. On Linux, you can use _xlwings Server or _xlwings Reader."
                )
            elif sys.platform.startswith("darwin"):
                raise XlwingsError(
                    'Make sure to have "appscript" and "psutil", '
                    "dependencies of _xlwings, installed."
                )
            elif sys.platform.startswith("win"):
                raise XlwingsError(
                    'Make sure to have "pywin32", a dependency of _xlwings, installed.'
                )
