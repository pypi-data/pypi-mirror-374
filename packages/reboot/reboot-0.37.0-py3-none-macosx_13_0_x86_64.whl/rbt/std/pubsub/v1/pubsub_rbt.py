...
class PubSubServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):

    def __init__(
        self,
        *,
        servicer: PubSubBaseServicer,
        ...
        super().__init__(
            ...
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.pubsub.v1.PubSub'),
            service_names = [
                IMPORT_reboot_aio_types.ServiceName("rbt.std.pubsub.v1.PubSubMethods"),
            ],
    ...
    def add_to_server(self, server: IMPORT_grpc.aio.Server) -> None:
        rbt.std.pubsub.v1.pubsub_pb2_grpc.add_PubSubMethodsServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Publish':
            ...
            logger.warning(
                ...
                f"Method '{method}' is invalid for servicer PubSub."
                "\n"
    ...
    async def react_mutate(
        ...
        if method == 'Publish':
            ...
            while True:
                ...
                stub = rbt.std.pubsub.v1.pubsub_pb2_grpc.PubSubMethodsStub(
                ...
                try:
                    ...
                    if status is not None:
                        raise PubSub.PublishAborted.from_status(
                            status
                        ) from None
                    raise PubSub.PublishAborted.from_grpc_aio_rpc_error(
                        error
                     ) from None
            ...
            while True:
                ...
                try:
                    ...
                    status = await IMPORT_rpc_status_async.from_call(call)
                    if status is not None:
                        raise PubSub.SubscribeAborted.from_status(
                            status
                        ) from None
                    raise PubSub.SubscribeAborted.from_grpc_aio_rpc_error(
                        error
                     ) from None
    ...
    async def dispatch(
        ...
        *,
            ...
            async def run_Publish(
                ...
                *,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (PubSubWorkflowStub(
                            context=context,
                        ...
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.pubsub.v1.PubSubMethods.Publish', []):
                ...
                *,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.pubsub.v1.PubSubMethods.Subscribe', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
                ...
                *,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.pubsub.v1.PubSubMethods.Broker', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if len(done) == 0:
                                ...
                                logger.warning(
                                    f'Still waiting for method PubSub.Broker '
        ...
        raise RuntimeError(
            ...
            f"on 'PubSub' which does not exist"
        )

    # PubSub specific methods:
    async def __Publish(
        self,
        context: IMPORT_reboot_aio_contexts.WriterContext,
        state: rbt.std.pubsub.v1.pubsub_pb2.PubSub,
        request: rbt.std.pubsub.v1.pubsub_pb2.PublishRequest,
        *,
        validating_effects: bool,
    ) -> PubSub.PublishEffects:
        try:
            response = (
            ...
            self.maybe_raise_effect_validation_retry(
                ...
                method_name='PubSub.Publish',
                validating_effects=validating_effects,
                context=context,
            )
            return PubSub.PublishEffects(
                state=state,
                response=response,
            ...
            aborted_type = PubSub.PublishAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.pubsub.v1.PubSub.Publish') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Publish') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.pubsub.v1.PubSub.Publish') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.pubsub.v1.PubSub.Publish') "
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Publish') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Publish') {type(exception).__name__}: {exception}"
            )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                authorize=self._maybe_authorize(
                    method_name='rbt.std.pubsub.v1.PubSubMethods.Publish',
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await PubSubServicerTasks(
                    context=context,
                    state_ref=context._state_ref,
                ).Publish(
                    request,
        ...
        *,
        ...
        try:
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='PubSub.Subscribe',
                validating_effects=validating_effects,
                context=context,
            )
            return PubSub.SubscribeEffects(
                state=state,
                response=response,
                tasks=context._tasks,
                _colocated_upserts=context._colocated_upserts,
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = PubSub.SubscribeAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.pubsub.v1.PubSub.Subscribe') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Subscribe') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.pubsub.v1.PubSub.Subscribe') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.pubsub.v1.PubSub.Subscribe') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Subscribe') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Subscribe') {type(exception).__name__}: {exception}"
            )
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                self.tasks_dispatcher,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.pubsub.v1.PubSubMethods.Subscribe',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    async def __Broker(
        ...
        *,
        ...
        try:
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = PubSub.BrokerAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.pubsub.v1.PubSub.Broker') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Broker') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.pubsub.v1.PubSub.Broker') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.pubsub.v1.PubSub.Broker') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Broker') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.pubsub.v1.PubSub.Broker') {type(exception).__name__}: {exception}"
            )
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                transaction=transaction,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.pubsub.v1.PubSubMethods.Broker',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    def _maybe_authorize(
        ...
        *,
        ...
        request: IMPORT_typing.Optional[PubSubRequestTypes] = None,
    ) -> IMPORT_typing.Optional[IMPORT_typing.Callable[[IMPORT_typing.Optional[PubSubStateType]], IMPORT_typing.Awaitable[None]]]:
        ...
        async def authorize(state: IMPORT_typing.Optional[PubSubStateType]) -> None:
            ...
            try:
                ...
                raise TypeError(
                    ...
                    f"`rbt.std.pubsub.v1.PubSub('{headers.state_ref.id}')`"
                ) from e
...
class _PubSubStub(IMPORT_reboot_aio_stubs.Stub):

    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.std.pubsub.v1.PubSub')
    ...
    def __init__(
        ...
        *,
        ...
        self._rbt_std_pubsub_v1_pubsubmethods_stub = rbt.std.pubsub.v1.pubsub_pb2_grpc.PubSubMethodsStub(channel)


class PubSubReaderStub(_PubSubStub):
...
class PubSubWriterStub(_PubSubStub):
    ...
    async def Publish(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            service_name=IMPORT_reboot_aio_types.ServiceName('rbt.std.pubsub.v1.PubSubMethods'),
            method='Publish',
            mutation=True,
            request=request,
            metadata=metadata,
            ...
            async with self._call(
                IMPORT_reboot_aio_types.StateTypeName('rbt.std.pubsub.v1.PubSub'),
                IMPORT_reboot_aio_types.ServiceName('rbt.std.pubsub.v1.PubSubMethods'),
                'Publish',
                self._rbt_std_pubsub_v1_pubsubmethods_stub.Publish,
                request,
                unary=True,
                reader=False,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.std.pubsub.v1.PubSubMethods'),
                'Subscribe',
                self._rbt_std_pubsub_v1_pubsubmethods_stub.Subscribe,
                request,
                unary=True,
                reader=False,
...
class PubSubWorkflowStub(_PubSubStub):
...
class PubSubTasksStub(_PubSubStub):
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[misc, attr-defined]
                    if key == IMPORT_reboot_aio_headers.TASK_ID_UUID:
                        return IMPORT_rbt_v1alpha1.tasks_pb2.TaskId(
                            state_type=IMPORT_reboot_aio_types.StateTypeName('rbt.std.pubsub.v1.PubSub'),
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.std.pubsub.v1.PubSubMethods'),
                'Broker',
                self._rbt_std_pubsub_v1_pubsubmethods_stub.Broker,
                request,
                unary=True,
                reader=False,
...
PubSubStateType: IMPORT_typing.TypeAlias = rbt.std.pubsub.v1.pubsub_pb2.PubSub
PubSubRequestTypes: IMPORT_typing.TypeAlias = \
...
class PubSubAuthorizer(
    IMPORT_rebootdev.aio.auth.authorizers.Authorizer[PubSubStateType, PubSubRequestTypes],
):
    StateType: IMPORT_typing.TypeAlias = PubSubStateType
    RequestTypes: IMPORT_typing.TypeAlias = PubSubRequestTypes
        ...
        *,
        Publish: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.std.pubsub.v1.pubsub_pb2.PubSub,
              rbt.std.pubsub.v1.pubsub_pb2.PublishRequest,
            ]
        ] = None,
    ...
    async def authorize(
        ...
        *,
        ...
        state: IMPORT_typing.Optional[PubSubStateType],
        request: IMPORT_typing.Optional[PubSubRequestTypes],
        **kwargs,
    ) -> IMPORT_rebootdev.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.std.pubsub.v1.PubSubMethods.Publish':
            return await self.Publish(
                context=context,
                state=IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.PubSub, state),
                request=IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.PublishRequest, request),
            )
        elif method_name == 'rbt.std.pubsub.v1.PubSubMethods.Subscribe':
            return await self.Subscribe(
                context=context,
                state=IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.PubSub, state),
                request=IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest, request),
            )
        elif method_name == 'rbt.std.pubsub.v1.PubSubMethods.Broker':
    ...
    # For 'rbt.std.pubsub.v1.PubSubMethods.Publish'.
    async def Publish(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.pubsub.v1.PubSubMethods.Subscribe'.
    async def Subscribe(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.pubsub.v1.PubSubMethods.Broker'.
    async def Broker(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
...
class PubSubBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    Authorizer: IMPORT_typing.TypeAlias = PubSubAuthorizer

    __service_names__ = [
        IMPORT_reboot_aio_types.ServiceName('rbt.std.pubsub.v1.PubSubMethods'),
    ]
    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.std.pubsub.v1.PubSub')
    __state_type__ = rbt.std.pubsub.v1.pubsub_pb2.PubSub
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: IMPORT_typing.Optional[PubSubServicerMiddleware] = None
    ...
    def create_middleware(
        ...
        *,
        ...
        app_internal_api_key_secret: str,
        ready: IMPORT_asyncio.Event,
    ) -> PubSubServicerMiddleware:
        self._middleware = PubSubServicerMiddleware(
            servicer=self,
            application_id=application_id,
            consensus_id=consensus_id,
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> PubSub.WeakReference[PubSub.WeakReference._WriterSchedule]:
        ...
        return PubSub.WeakReference(
            ...
            schedule_type=PubSub.WeakReference._WriterSchedule,
    ...
    class Effects(IMPORT_reboot_aio_state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.pubsub.v1.pubsub_pb2.PubSub])
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.std.pubsub.v1.pubsub_pb2.PubSub
        ) -> PubSubBaseServicer.InlineWriterCallableResult:
            ...
    ...
    class WorkflowState:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: PubSubBaseServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: PubSubBaseServicer.InlineWriterCallable[PubSubBaseServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[PubSubBaseServicer.InlineWriterCallableResult],
        ) -> PubSubBaseServicer.InlineWriterCallableResult:
            ...
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return await IMPORT_reboot_aio_workflows.at_least_once(
                        ...
                        context,
                        read,
                        type=rbt.std.pubsub.v1.pubsub_pb2.PubSub,
                    )
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: PubSubBaseServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"PubSub.{task.method_name} inline writer"
        ...
        def per_workflow(self, alias: IMPORT_typing.Optional[str] = None):
            return PubSubBaseServicer.WorkflowState._Idempotently(
        ...
        class _Always:
            ...
            async def read(
                ...
                return await PubSubBaseServicer.WorkflowState._Idempotently(
                    servicer=self._servicer,
                    alias=None,
        ...
        def always(self):
            return PubSubBaseServicer.WorkflowState._Always(
                servicer=self._servicer,
            )
...
class PubSubSingletonServicer(PubSubBaseServicer):

    @property
    def state(self):
        return PubSubBaseServicer.WorkflowState(
            servicer=self
        )
    ...
    async def _Publish(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.pubsub.v1.PubSub('{context.state_id}')",
...
class PubSubServicer(PubSubBaseServicer):

    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.pubsub.v1.pubsub_pb2.PubSub]
    ...
    _instances: dict[str, PubSubServicer] = {}

    def _instance(self, state_id: str):
        instances = PubSubServicer._instances
    ...
    @property
    def state(self) -> rbt.std.pubsub.v1.pubsub_pb2.PubSub:
        state = PubSubServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = PubSubServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.std.pubsub.v1.pubsub_pb2.PubSub):
        state = PubSubServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Publish(
        ...
        # `_state is None`.
        assert PubSubServicer._state.get() is None
        PubSubServicer._state.set(state)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            ...
            PubSubServicer._state.set(None)
    ...
    async def _Broker(
        ...
        PubSubServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            ...
            PubSubServicer._workflow.set(False)
...
PubSub_ScheduleTypeVar = IMPORT_typing.TypeVar('PubSub_ScheduleTypeVar', 'PubSub.WeakReference._Schedule', 'PubSub.WeakReference._WriterSchedule')
PubSub_IdempotentlyScheduleTypeVar = IMPORT_typing.TypeVar('PubSub_IdempotentlyScheduleTypeVar', 'PubSub.WeakReference._Schedule', 'PubSub.WeakReference._WriterSchedule')

PubSub_UntilCallableType = IMPORT_typing.TypeVar('PubSub_UntilCallableType')

class PubSubSingleton:
    Servicer: IMPORT_typing.TypeAlias = PubSubSingletonServicer


class PubSub:


    Servicer: IMPORT_typing.TypeAlias = PubSubServicer

    singleton: IMPORT_typing.TypeAlias = PubSubSingleton

    Effects: IMPORT_typing.TypeAlias = PubSubBaseServicer.Effects

    Authorizer: IMPORT_typing.TypeAlias = PubSubAuthorizer

    State: IMPORT_typing.TypeAlias = rbt.std.pubsub.v1.pubsub_pb2.PubSub
    ...
    PublishEffects: IMPORT_typing.TypeAlias = PubSubBaseServicer.PublishEffects
    ...
    SubscribeEffects: IMPORT_typing.TypeAlias = PubSubBaseServicer.SubscribeEffects
    ...
    class WeakReference(IMPORT_typing.Generic[PubSub_ScheduleTypeVar]):

        _schedule_type: type[PubSub_ScheduleTypeVar]
        ...
        def __init__(
            ...
            *,
            schedule_type: type[PubSub_ScheduleTypeVar],
            bearer_token: IMPORT_typing.Optional[str] = None,
            servicer: IMPORT_typing.Optional[PubSubBaseServicer] = None,
        ):
            self._application_id = application_id
            self._state_ref = IMPORT_reboot_aio_types.StateRef.from_id(
              PubSub.__state_type_name__,
              state_id,
            )
            self._schedule_type = schedule_type
            self._idempotency_manager: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.IdempotencyManager] = None
            self._reader_stub: IMPORT_typing.Optional[PubSubReaderStub] = None
            self._writer_stub: IMPORT_typing.Optional[PubSubWriterStub] = None
            self._workflow_stub: IMPORT_typing.Optional[PubSubWorkflowStub] = None
            self._tasks_stub: IMPORT_typing.Optional[PubSubTasksStub] = None
        ...
        def _reader(
            ...
            if self._reader_stub is None:
                self._reader_stub = PubSubReaderStub(
                    context=context,
                    state_ref=self._state_ref,
            ...
            if self._idempotency_manager is None:
                ...
                raise IMPORT_reboot_aio_call.MixedContextsError(
                    "This `WeakReference` for `PubSub` with ID "
        ...
        def _writer(
            ...
            if self._writer_stub is None:
                self._writer_stub = PubSubWriterStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        def _workflow(
            ...
            if self._workflow_stub is None:
                self._workflow_stub = PubSubWorkflowStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        def _tasks(
            ...
            if self._tasks_stub is None:
                self._tasks_stub = PubSubTasksStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        def reactively(self):
            return PubSub.WeakReference._Reactively(
                application_id=self._application_id,
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )

        class _Idempotently(IMPORT_typing.Generic[PubSub_IdempotentlyScheduleTypeVar]):

            _weak_reference: PubSub.WeakReference[PubSub_IdempotentlyScheduleTypeVar]

            def __init__(
                self,
                *,
                weak_reference: PubSub.WeakReference[PubSub_IdempotentlyScheduleTypeVar],
                idempotency: IMPORT_reboot_aio_idempotency.Idempotency,
            ):
            ...
            def schedule(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> PubSub_IdempotentlyScheduleTypeVar:
            ...
            def spawn(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> PubSub.WeakReference._Spawn:
                return PubSub.WeakReference._Spawn(
                    self._weak_reference._application_id,
                    self._weak_reference._tasks,
                    when=when,
                    idempotency=self._idempotency,
            ...
            async def Read(
                ...
                return await PubSubBaseServicer.WorkflowState._Idempotently._read(
            ...
            async def Write(
                ...
                *,
                ...
                return await PubSubBaseServicer.WorkflowState._Idempotently._write_validating_effects(
                    self._weak_reference._servicer,
                    self._idempotency,
                    context,
                    writer,
            ...
            async def Publish(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                topic: IMPORT_typing.Optional[str] = None,
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> PubSub.WeakReference._Idempotently[PubSub_ScheduleTypeVar]:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID, generated: bool = False) -> PubSub.WeakReference._Idempotently[PubSub_ScheduleTypeVar]:
            ...
        ...
        ) -> PubSub.WeakReference._Idempotently[PubSub_ScheduleTypeVar]:
            return PubSub.WeakReference._Idempotently(
                weak_reference=self,
        ...
        class _UntilChangesSatisfies(IMPORT_typing.Generic[PubSub_UntilCallableType]):

            _idempotency_alias: str
            _context: IMPORT_reboot_aio_contexts.WorkflowContext
            _callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[PubSub_UntilCallableType]]
            _type: type[PubSub_UntilCallableType]
            ...
            def __init__(
                ...
                *,
                idempotency_alias: str,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[PubSub_UntilCallableType]],
                type: type[PubSub_UntilCallableType],
            ):
            ...
            async def satisfies(
                self,
                condition: IMPORT_typing.Callable[[PubSub_UntilCallableType], bool],
            ):
        ...
        class _Until:
            ...
            _weak_reference: PubSub.WeakReference
            _idempotency_alias: str

            def __init__(
                self,
                *,
                weak_reference: PubSub.WeakReference,
                idempotency_alias: str,
            ):
                self._weak_reference = weak_reference
                self._idempotency_alias = idempotency_alias
            ...
            def Read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> PubSub.WeakReference._UntilChangesSatisfies[rbt.std.pubsub.v1.pubsub_pb2.PubSub]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
                ...
                return PubSub.WeakReference._UntilChangesSatisfies(
        ...
        def until(self, alias: str):
            return PubSub.WeakReference._Until(
                weak_reference=self,
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                application_id: IMPORT_typing.Optional[IMPORT_reboot_aio_types.ApplicationId],
                tasks: IMPORT_typing.Callable[[IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext], PubSubTasksStub],
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
                idempotency: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Publish(
                ...
                *,
                ...
                if topic is not None and not isinstance(
                    topic,
                    str,
                ):
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.pubsub.v1.pubsub_pb2.PublishRequest': field 'topic' is not "
            ...
            async def Subscribe(
                ...
                *,
                ...
                if topic is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest': field 'topic' is not "
                        f"of required type 'str'"
                    )
            ...
            async def Broker(
                ...
                *,
                ...
                if topic is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.pubsub.v1.pubsub_pb2.BrokerRequest': field 'topic' is not "
                        f"of required type 'str'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
            ...
            async def Publish(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return (await PubSubServicerTasks(
                        context=__context__,
    ...
    @classmethod
    def forall(cls, ids: list[str]) -> PubSub._Forall:
        return PubSub._Forall(ids)
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> PubSub.WeakReference[PubSub.WeakReference._Schedule]:
        return PubSub.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
            state_id=state_id,
            schedule_type=PubSub.WeakReference._Schedule,
            bearer_token=bearer_token,
        )
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> PubSub._ConstructIdempotently:
        ...

    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID, generated: bool = False) -> PubSub._ConstructIdempotently:
        ...
    ...
    def idempotently(
        ...
        *,
        ...
        each_iteration: IMPORT_typing.Optional[bool] = None,
        generated: bool = False,
    ) -> PubSub._ConstructIdempotently:
        return PubSub._ConstructIdempotently(
...
class PubSubServicerNodeAdaptor(PubSub.singleton.Servicer):
            ...
            try:
                ...
                if result.HasField('state'):
                    with IMPORT_reboot_aio_tracing.span(
                        ...
                        state.CopyFrom(
                            rbt.std.pubsub.v1.pubsub_pb2.PubSub.FromString(
                                result.state
                            )
                        )
...
class PubSubWeakReferenceNodeAdaptor(PubSub.WeakReference[PubSub.WeakReference._Schedule]):
