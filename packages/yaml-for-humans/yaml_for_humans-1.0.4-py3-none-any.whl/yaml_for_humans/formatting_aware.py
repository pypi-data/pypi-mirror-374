...
class FormattingAwareComposer(Composer):
    ...
    def _check_structural_empty_lines_after(self, key_node, value_node, index, parent_node):
        ...
        if index + 1 < len(parent_node.value):
            ...
            if empty_lines_after > 0:
                ...
                if hasattr(next_key_node, '_formatting_metadata'):
                    ...
                    next_key_node._formatting_metadata.empty_lines_before = empty_lines_after
                else:
                    # Create new metadata
