...
class CWT:
    ...
    @staticmethod
    def PlotCWT(cwtmatr: np.ndarray, freqs: np.ndarray, timestamps: np.ndarray, limit_by_coi: bool=True, wavelet: str = None, y_scale="log", z_scale="linear", cmap="viridis", figsize=(12,6), dpi=400, cwtmatr_absolute: bool = True):
    ...
    @staticmethod
    def PlotMultiCWT(cwtmatr: List[np.ndarray], freqs: List[np.ndarray], timestamps: List[np.ndarray], limit_by_coi: bool=True, wavelet: str = None, y_scale="log", z_scale="linear", cmap="viridis", figsize=(12,6), dpi=200, cwtmatr_absolute: bool = True):
