...
SERVICE_NAMESPACE = os.getenv("NAMESPACE", RESOURCE_ATTRIBUTES.get('service.namespace', 'helpmetest'))
DEPLOYMENT_ENVIRONMENT = os.getenv("ENV", RESOURCE_ATTRIBUTES.get('deployment.environment', 'production'))
...
def init(config: Any = None, app_name: Optional[str] = None, service_namespace: Optional[str] = None, deployment_env: Optional[str] = None, service_version: Optional[str] = None) -> None:
    ...
    # Set namespace - priority: function param > NAMESPACE env var > current value > 'helpmetest'
    if service_namespace:
        SERVICE_NAMESPACE = service_namespace
    elif os.getenv("NAMESPACE"):
        SERVICE_NAMESPACE = os.getenv("NAMESPACE")
    elif not SERVICE_NAMESPACE:
        SERVICE_NAMESPACE = 'helpmetest'
    
    # Set deployment environment - priority: function param > ENV env var > current value > 'production'
    if deployment_env:
