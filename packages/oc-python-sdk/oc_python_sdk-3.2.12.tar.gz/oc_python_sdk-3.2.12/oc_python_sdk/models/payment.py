...
class PaymentDataSplit(BaseModel):
    code: str
    amount: condecimal(ge=Decimal('0'), max_digits=12, decimal_places=2) | None = None
    meta: dict
...
class PaymentData(BaseModel):
    ...
    amount: Optional[condecimal(ge=Decimal('0'), max_digits=12, decimal_places=2)] | None = None
