...
inline constexpr std::int32_t version_minor = 5;
inline constexpr std::int32_t version_patch = 0;

inline constexpr char torch_version[] = "2.8.0";
inline constexpr char torch_variant[] = "CUDA 12.6"
...
inline constexpr std::optional<std::int32_t> cuda_version_minor = 6;
