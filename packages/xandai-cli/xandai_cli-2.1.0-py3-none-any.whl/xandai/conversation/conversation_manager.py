...
class ConversationManager:
    ...
    def add_message(self, role: str, content: str, mode: str = "chat", metadata: Dict[str, Any] = None):
        """
    ...
    def get_recent_history(self, limit: int = 10, mode_filter: Optional[str] = None) -> List[ConversationMessage]:
        """
    ...
    def _save_session(self):
        ...
        with open(filepath, 'w', encoding='utf-8') as f:
            json.dump(self._serialize_session(self.current_session), f, 
