...
typedef enum SANITIZER_CBID_RUNTIME_API_enum {
    ...
    SANITIZER_CBID_RUNTIME_API_cudaSignalExternalSemaphoresAsync                           = 393,
    SANITIZER_CBID_RUNTIME_API_cudaSignalExternalSemaphoresAsync_ptsz                      = 394,
    SANITIZER_CBID_RUNTIME_API_cudaWaitExternalSemaphoresAsync                             = 395,
    SANITIZER_CBID_RUNTIME_API_cudaWaitExternalSemaphoresAsync_ptsz                        = 396,
    ...
    SANITIZER_CBID_RUNTIME_API_cudaGetDeviceProperties                                     = 440,
    ...
    SANITIZER_CBID_RUNTIME_API_cudaMemAdvise                                               = 448,
    SANITIZER_CBID_RUNTIME_API_cudaMemPrefetchAsync                                        = 449,
    SANITIZER_CBID_RUNTIME_API_cudaMemPrefetchAsync_ptsz                                   = 450,
    ...
    SANITIZER_CBID_RUNTIME_API_cudaGraphGetEdges                                           = 455,
    SANITIZER_CBID_RUNTIME_API_cudaGraphNodeGetDependencies                                = 456,
    SANITIZER_CBID_RUNTIME_API_cudaGraphNodeGetDependentNodes                              = 457,
    SANITIZER_CBID_RUNTIME_API_cudaGraphAddDependencies                                    = 458,
    SANITIZER_CBID_RUNTIME_API_cudaGraphRemoveDependencies                                 = 459,
    SANITIZER_CBID_RUNTIME_API_cudaGraphAddNode                                            = 460,
    SANITIZER_CBID_RUNTIME_API_cudaStreamGetCaptureInfo                                    = 461,
    SANITIZER_CBID_RUNTIME_API_cudaStreamGetCaptureInfo_ptsz                               = 462,
    SANITIZER_CBID_RUNTIME_API_cudaStreamUpdateCaptureDependencies                         = 463,
    SANITIZER_CBID_RUNTIME_API_cudaStreamUpdateCaptureDependencies_ptsz                    = 464,
    ...
    SANITIZER_CBID_RUNTIME_API_cudaStreamGetDevice                                         = 480,
    SANITIZER_CBID_RUNTIME_API_cudaStreamGetDevice_ptsz                                    = 481,
    SANITIZER_CBID_RUNTIME_API_cudaEventElapsedTime                                        = 486,
    SANITIZER_CBID_RUNTIME_API_cudaMemPrefetchBatchAsync                                   = 487,
    SANITIZER_CBID_RUNTIME_API_cudaMemPrefetchBatchAsync_ptsz                              = 488,
    SANITIZER_CBID_RUNTIME_API_cudaMemDiscardBatchAsync                                    = 489,
    SANITIZER_CBID_RUNTIME_API_cudaMemDiscardBatchAsync_ptsz                               = 490,
    SANITIZER_CBID_RUNTIME_API_cudaMemDiscardAndPrefetchBatchAsync                         = 491,
    SANITIZER_CBID_RUNTIME_API_cudaMemDiscardAndPrefetchBatchAsync_ptsz                    = 492,
    SANITIZER_CBID_RUNTIME_API_cudaGetExportTable                                          = 493,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterFatBinary                                     = 494,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterFatBinaryEnd                                  = 495,
    SANITIZER_CBID_RUNTIME_API___cudaUnregisterFatBinary                                   = 496,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterVar                                           = 497,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterHostVar                                       = 498,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterFunction                                      = 499,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterManagedVar                                    = 500,
    SANITIZER_CBID_RUNTIME_API___cudaInitModule                                            = 501,
    SANITIZER_CBID_RUNTIME_API___cudaPushCallConfiguration                                 = 502,
    SANITIZER_CBID_RUNTIME_API___cudaPopCallConfiguration                                  = 503,
    SANITIZER_CBID_RUNTIME_API___cudaGetKernel                                             = 504,
    SANITIZER_CBID_RUNTIME_API___cudaLaunchKernel                                          = 505,
    SANITIZER_CBID_RUNTIME_API___cudaLaunchKernel_ptsz                                     = 506,
    SANITIZER_CBID_RUNTIME_API___cudaRegisterUnifiedTable                                  = 507,
    SANITIZER_CBID_RUNTIME_API___cudaGetProcAddress                                        = 508,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpyBatchAsync                                        = 509,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpyBatchAsync_ptsz                                   = 510,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpy3DBatchAsync                                      = 511,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpy3DBatchAsync_ptsz                                 = 512,
    SANITIZER_CBID_RUNTIME_API_cudaLogsRegisterCallback                                    = 513,
    SANITIZER_CBID_RUNTIME_API_cudaLogsUnregisterCallback                                  = 514,
    SANITIZER_CBID_RUNTIME_API_cudaLogsCurrent                                             = 515,
    SANITIZER_CBID_RUNTIME_API_cudaLogsDumpToFile                                          = 516,
    SANITIZER_CBID_RUNTIME_API_cudaLogsDumpToMemory                                        = 517,
    SANITIZER_CBID_RUNTIME_API_cudaMemGetDefaultMemPool                                    = 518,
    SANITIZER_CBID_RUNTIME_API_cudaMemGetMemPool                                           = 519,
    SANITIZER_CBID_RUNTIME_API_cudaMemSetMemPool                                           = 520,
    SANITIZER_CBID_RUNTIME_API_cudaDeviceGetHostAtomicCapabilities                         = 521,
    SANITIZER_CBID_RUNTIME_API_cudaDeviceGetP2PAtomicCapabilities                          = 522,
    SANITIZER_CBID_RUNTIME_API_SIZE                                                        = 523,
