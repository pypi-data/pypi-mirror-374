...
typedef struct cudaGetDeviceProperties_v12000_params_st {
    struct cudaDeviceProp *prop;
    int device;
} cudaGetDeviceProperties_v12000_params;
...
typedef struct cudaDeviceGetHostAtomicCapabilities_v13000_params_st {
    unsigned int *capabilities;
    const enum cudaAtomicOperation *operations;
    unsigned int count;
    int device;
} cudaDeviceGetHostAtomicCapabilities_v13000_params;
...
typedef struct cudaDeviceGetP2PAtomicCapabilities_v13000_params_st {
    unsigned int *capabilities;
    const enum cudaAtomicOperation *operations;
    unsigned int count;
    int srcDevice;
    int dstDevice;
} cudaDeviceGetP2PAtomicCapabilities_v13000_params;
...
typedef struct cudaStreamGetCaptureInfo_ptsz_v12030_params_st {
    cudaStream_t stream;
...
} cudaStreamGetCaptureInfo_ptsz_v12030_params;

typedef struct cudaStreamUpdateCaptureDependencies_ptsz_v12030_params_st {
    cudaStream_t stream;
    cudaGraphNode_t *dependencies;
    const cudaGraphEdgeData *dependencyData;
    size_t numDependencies;
    unsigned int flags;
} cudaStreamUpdateCaptureDependencies_ptsz_v12030_params;
...
typedef struct cudaEventElapsedTime_v12080_params_st {
    float *ms;
    cudaEvent_t start;
    cudaEvent_t end;
} cudaEventElapsedTime_v12080_params;
...
typedef struct cudaSignalExternalSemaphoresAsync_ptsz_v11020_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreSignalParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaSignalExternalSemaphoresAsync_ptsz_v11020_params;

typedef struct cudaWaitExternalSemaphoresAsync_ptsz_v11020_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreWaitParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaWaitExternalSemaphoresAsync_ptsz_v11020_params;
...
typedef struct cudaMemcpyBatchAsync_ptsz_v13000_params_st {
    void *const *dsts;
    ...
    size_t numAttrs;
    cudaStream_t stream;
} cudaMemcpyBatchAsync_ptsz_v13000_params;

typedef struct cudaMemcpy3DBatchAsync_ptsz_v13000_params_st {
    size_t numOps;
    struct cudaMemcpy3DBatchOp *opList;
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemcpy3DBatchAsync_ptsz_v13000_params;
...
typedef struct cudaMemPrefetchAsync_ptsz_v12020_params_st {
    const void *devPtr;
    size_t count;
    struct cudaMemLocation location;
    unsigned int flags;
    cudaStream_t stream;
} cudaMemPrefetchAsync_ptsz_v12020_params;

typedef struct cudaMemPrefetchBatchAsync_ptsz_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    ...
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemPrefetchBatchAsync_ptsz_v13000_params;

typedef struct cudaMemDiscardBatchAsync_ptsz_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemDiscardBatchAsync_ptsz_v13000_params;

typedef struct cudaMemDiscardAndPrefetchBatchAsync_ptsz_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    struct cudaMemLocation *prefetchLocs;
    ...
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemDiscardAndPrefetchBatchAsync_ptsz_v13000_params;

typedef struct cudaMemAdvise_v12020_params_st {
    const void *devPtr;
    size_t count;
    enum cudaMemoryAdvise advice;
    struct cudaMemLocation location;
} cudaMemAdvise_v12020_params;
...
typedef struct cudaMemGetDefaultMemPool_v13000_params_st {
    cudaMemPool_t *memPool;
    struct cudaMemLocation *location;
    enum cudaMemAllocationType type;
} cudaMemGetDefaultMemPool_v13000_params;

typedef struct cudaMemGetMemPool_v13000_params_st {
    cudaMemPool_t *memPool;
    struct cudaMemLocation *location;
    enum cudaMemAllocationType type;
} cudaMemGetMemPool_v13000_params;

typedef struct cudaMemSetMemPool_v13000_params_st {
    struct cudaMemLocation *location;
    enum cudaMemAllocationType type;
    cudaMemPool_t memPool;
} cudaMemSetMemPool_v13000_params;
...
typedef struct cudaLogsRegisterCallback_v13000_params_st {
    cudaLogsCallback_t callbackFunc;
    void *userData;
    cudaLogsCallbackHandle *callback_out;
} cudaLogsRegisterCallback_v13000_params;

typedef struct cudaLogsUnregisterCallback_v13000_params_st {
    cudaLogsCallbackHandle callback;
} cudaLogsUnregisterCallback_v13000_params;

typedef struct cudaLogsCurrent_v13000_params_st {
    cudaLogIterator *iterator_out;
    unsigned int flags;
} cudaLogsCurrent_v13000_params;

typedef struct cudaLogsDumpToFile_v13000_params_st {
    cudaLogIterator *iterator;
    const char *pathToFile;
    unsigned int flags;
} cudaLogsDumpToFile_v13000_params;

typedef struct cudaLogsDumpToMemory_v13000_params_st {
    cudaLogIterator *iterator;
    char *buffer;
    size_t *size;
    unsigned int flags;
} cudaLogsDumpToMemory_v13000_params;
...
typedef struct cudaGraphGetEdges_v12030_params_st {
    cudaGraph_t graph;
    cudaGraphNode_t *from;
    cudaGraphNode_t *to;
    cudaGraphEdgeData *edgeData;
    size_t *numEdges;
} cudaGraphGetEdges_v12030_params;

typedef struct cudaGraphNodeGetDependencies_v12030_params_st {
    cudaGraphNode_t node;
    cudaGraphNode_t *pDependencies;
    cudaGraphEdgeData *edgeData;
    size_t *pNumDependencies;
} cudaGraphNodeGetDependencies_v12030_params;

typedef struct cudaGraphNodeGetDependentNodes_v12030_params_st {
    cudaGraphNode_t node;
    cudaGraphNode_t *pDependentNodes;
    cudaGraphEdgeData *edgeData;
    size_t *pNumDependentNodes;
} cudaGraphNodeGetDependentNodes_v12030_params;

typedef struct cudaGraphAddDependencies_v12030_params_st {
    cudaGraph_t graph;
    const cudaGraphNode_t *from;
    const cudaGraphNode_t *to;
    const cudaGraphEdgeData *edgeData;
    size_t numDependencies;
} cudaGraphAddDependencies_v12030_params;

typedef struct cudaGraphRemoveDependencies_v12030_params_st {
    cudaGraph_t graph;
    const cudaGraphNode_t *from;
    const cudaGraphNode_t *to;
    const cudaGraphEdgeData *edgeData;
    size_t numDependencies;
} cudaGraphRemoveDependencies_v12030_params;
...
typedef struct cudaGraphAddNode_v12030_params_st {
    cudaGraphNode_t *pGraphNode;
    cudaGraph_t graph;
    const cudaGraphNode_t *pDependencies;
    const cudaGraphEdgeData *dependencyData;
...
} cudaGraphAddNode_v12030_params;
...
typedef struct cudaLibraryLoadData_v12060_params_st {
...
} cudaLibraryLoadData_v12060_params;

typedef struct cudaLibraryLoadFromFile_v12060_params_st {
    cudaLibrary_t *library;
    const char *fileName;
    enum cudaJitOption *jitOptions;
    void **jitOptionsValues;
    ...
    void **libraryOptionValues;
    unsigned int numLibraryOptions;
} cudaLibraryLoadFromFile_v12060_params;

typedef struct cudaLibraryUnload_v12060_params_st {
    cudaLibrary_t library;
} cudaLibraryUnload_v12060_params;

typedef struct cudaLibraryGetKernel_v12060_params_st {
    cudaKernel_t *pKernel;
    cudaLibrary_t library;
    const char *name;
} cudaLibraryGetKernel_v12060_params;

typedef struct cudaLibraryGetGlobal_v12060_params_st {
    void **dptr;
    size_t *bytes;
    cudaLibrary_t library;
    const char *name;
} cudaLibraryGetGlobal_v12060_params;

typedef struct cudaLibraryGetManaged_v12060_params_st {
    void **dptr;
    size_t *bytes;
    cudaLibrary_t library;
    const char *name;
} cudaLibraryGetManaged_v12060_params;

typedef struct cudaLibraryGetUnifiedFunction_v12060_params_st {
    void **fptr;
    cudaLibrary_t library;
    const char *symbol;
} cudaLibraryGetUnifiedFunction_v12060_params;

typedef struct cudaLibraryGetKernelCount_v12060_params_st {
    unsigned int *count;
    cudaLibrary_t lib;
} cudaLibraryGetKernelCount_v12060_params;

typedef struct cudaLibraryEnumerateKernels_v12060_params_st {
    cudaKernel_t *kernels;
    unsigned int numKernels;
    cudaLibrary_t lib;
} cudaLibraryEnumerateKernels_v12060_params;

typedef struct cudaKernelSetAttributeForDevice_v12060_params_st {
    cudaKernel_t kernel;
    enum cudaFuncAttribute attr;
    int value;
    int device;
} cudaKernelSetAttributeForDevice_v12060_params;
...
typedef struct cudaMemcpyBatchAsync_v13000_params_st {
    void *const *dsts;
    const void *const *srcs;
    const size_t *sizes;
    size_t count;
    ...
    size_t numAttrs;
    cudaStream_t stream;
} cudaMemcpyBatchAsync_v13000_params;

typedef struct cudaMemcpy3DBatchAsync_v13000_params_st {
    size_t numOps;
    struct cudaMemcpy3DBatchOp *opList;
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemcpy3DBatchAsync_v13000_params;
...
typedef struct cudaMemPrefetchAsync_v12020_params_st {
    const void *devPtr;
    size_t count;
    struct cudaMemLocation location;
    unsigned int flags;
    cudaStream_t stream;
} cudaMemPrefetchAsync_v12020_params;

typedef struct cudaMemPrefetchBatchAsync_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    struct cudaMemLocation *prefetchLocs;
    ...
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemPrefetchBatchAsync_v13000_params;

typedef struct cudaMemDiscardBatchAsync_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemDiscardBatchAsync_v13000_params;

typedef struct cudaMemDiscardAndPrefetchBatchAsync_v13000_params_st {
    void **dptrs;
    size_t *sizes;
    size_t count;
    struct cudaMemLocation *prefetchLocs;
    ...
    unsigned long long flags;
    cudaStream_t stream;
} cudaMemDiscardAndPrefetchBatchAsync_v13000_params;

typedef struct cudaSignalExternalSemaphoresAsync_v11020_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreSignalParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaSignalExternalSemaphoresAsync_v11020_params;

typedef struct cudaWaitExternalSemaphoresAsync_v11020_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreWaitParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaWaitExternalSemaphoresAsync_v11020_params;
...
typedef struct cudaStreamGetCaptureInfo_v12030_params_st {
    cudaStream_t stream;
    enum cudaStreamCaptureStatus *captureStatus_out;
    unsigned long long *id_out;
    cudaGraph_t *graph_out;
    ...
    const cudaGraphEdgeData **edgeData_out;
    size_t *numDependencies_out;
} cudaStreamGetCaptureInfo_v12030_params;

typedef struct cudaStreamUpdateCaptureDependencies_v12030_params_st {
    cudaStream_t stream;
    cudaGraphNode_t *dependencies;
    const cudaGraphEdgeData *dependencyData;
    size_t numDependencies;
    unsigned int flags;
} cudaStreamUpdateCaptureDependencies_v12030_params;
