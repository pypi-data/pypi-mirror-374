...
typedef enum SANITIZER_CBID_DRIVER_API_enum {
   ...
   SANITIZER_CBID_DRIVER_API_cuGreenCtxGetId                                              = 782,
   SANITIZER_CBID_DRIVER_API_cuStreamCreateForCaptureToCig                                = 783,
   SANITIZER_CBID_DRIVER_API_cuMemPrefetchBatchAsync                                      = 784,
   SANITIZER_CBID_DRIVER_API_cuMemPrefetchBatchAsync_ptsz                                 = 785,
   SANITIZER_CBID_DRIVER_API_cuSemaphoreCreate                                            = 786,
   SANITIZER_CBID_DRIVER_API_cuSemaphoreExport                                            = 787,
   SANITIZER_CBID_DRIVER_API_cuSemaphoreDestroy                                           = 788,
   SANITIZER_CBID_DRIVER_API_cuMemDiscardBatchAsync                                       = 789,
   SANITIZER_CBID_DRIVER_API_cuMemDiscardBatchAsync_ptsz                                  = 790,
   SANITIZER_CBID_DRIVER_API_cuMemDiscardAndPrefetchBatchAsync                            = 791,
   SANITIZER_CBID_DRIVER_API_cuMemDiscardAndPrefetchBatchAsync_ptsz                       = 792,
   SANITIZER_CBID_DRIVER_API_cuMultiKernelCooperativeDomainCreate                         = 793,
   SANITIZER_CBID_DRIVER_API_cuMultiKernelCooperativeDomainDestroy                        = 794,
   SANITIZER_CBID_DRIVER_API_cuCtxGetDevice_v2                                            = 795,
   SANITIZER_CBID_DRIVER_API_cuMemcpyBatchAsync_v2                                        = 796,
   SANITIZER_CBID_DRIVER_API_cuMemcpyBatchAsync_v2_ptsz                                   = 797,
   SANITIZER_CBID_DRIVER_API_cuMemcpy3DBatchAsync_v2                                      = 798,
   SANITIZER_CBID_DRIVER_API_cuMemcpy3DBatchAsync_v2_ptsz                                 = 799,
   SANITIZER_CBID_DRIVER_API_cuCtxSynchronize_v2                                          = 800,
   SANITIZER_CBID_DRIVER_API_cuMemGetDefaultMemPool                                       = 801,
   SANITIZER_CBID_DRIVER_API_cuMemGetMemPool                                              = 802,
   SANITIZER_CBID_DRIVER_API_cuMemSetMemPool                                              = 803,
   SANITIZER_CBID_DRIVER_API_cuDeviceGetP2PAtomicCapabilities                             = 804,
   SANITIZER_CBID_DRIVER_API_cuDeviceGetHostAtomicCapabilities                            = 805,
   SANITIZER_CBID_DRIVER_API_cuDriverGetGpuCodeIsaVersion                                 = 806,
   SANITIZER_CBID_DRIVER_API_SIZE                                                         = 807,
