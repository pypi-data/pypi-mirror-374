        ...
        for tunnel_config in self._tunnel_configs:
            ...
            interfaces.append(
                models.InterfaceConfigurationItem(
                    name=tunnel_config.interface_name or f"wg{self.get_next_available_index()}",
            ...
            peers.append(
                models.WireguardPeerConfigurationItem(
                    wg_if_name=tunnel_config.interface_name or f"wg{self.get_next_available_index()}",
            ...
            routes.append(
                models.RouteConfigurationItem(
                    ...
                    outgoing_interface= tunnel_config.interface_name or f"wg{self.get_next_available_index()}",
                )
            )
        ...
        for i, tunnel_config in enumerate(self._tunnel_configs):
            ...
            created_tunnels.append(
                CreatedWireguardTunnel(
                    ...
                    mapped_name=tunnel_config.interface_name if tunnel_config.interface_name else None,
                )
            )
