        ...
        try:
                    ...
                    try:
                        ...
                        if path_obj.exists():
                            if path_obj.is_file():
                                ...
                                logger.debug(
                                    f"Cleaned up temp file: {temp_path}"
                                )
                                ...
                                logger.debug(
                                    f"Cleaned up temp directory: {temp_path}"
                                )
                        else:
                            logger.debug(
                                f"Temp file already gone: {temp_path}"
                            )
            ...
            if session_dir:
                try:
                    ...
                    logger.warning(
                        f"Error cleaning session temp directory: {e}"
                    )
