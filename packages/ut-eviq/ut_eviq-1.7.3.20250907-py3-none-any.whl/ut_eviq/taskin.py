...
from ut_eviq.utils import Evin, Evex, Evup
...
class TaskTmpIn:
    ...
    def evupadm(
        ...
        """
        _in_path = PathNm.sh_path(Cfg.InPath.evup_tmp, kwargs)
        _sheet = Cfg.sheet_adm
        _wb: TnOpWb = OpIoiPathWb.sh_wb_adm(_in_path, aod_evup_adm, _sheet)
        return _wb
    ...
    def evupdel(
        ...
        _wb: TnOpWb = OpIoiPathWb.sh_wb_del(_in_path, aod_evup_del, _sheet)
        return _wb
    ...
    def evupreg(
        ...
        """
        _in_path = PathNm.sh_path(Cfg.InPath.evup_tmp, kwargs)
        _wb: TnOpWb = OpIoiPathWb.sh_wb_reg(
           _in_path, aod_evup_adm, aod_evup_del, Cfg.sheet_adm, Cfg.sheet_del)
        return _wb
...
class TaskIn:
    ...
    def evupadm(
        ...
        _tup_adm: tuple[TnAoD, TyDoAoD] = Evup.sh_aod_evup_adm(_aod, _df)
        return _tup_adm
    ...
    def evdomap(
        ...
        """
        _d_ecv_iq2umh_iq = Cfg._Utils.d_ecv_iq2umh_iq
