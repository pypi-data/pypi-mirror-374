...
class PropertyProxy(ProxyObject):
	...
	def _getEnumEGSIInputTypeProperty(self, propertyName: str):
		return self._callFunction("getEnumEGSIInputTypeProperty", [propertyName])
	def _setEnumEGSIInputTypeProperty(self, propertyName: str, value):
		return self._callFunction("setEnumEGSIInputTypeProperty", [propertyName, value.value, self.documentProxyID], proxyArgumentIndices=[2])
	...
	def _getEnumEGHBEstimationMethodProperty(self, propertyName: str):
		return self._callFunction("getEnumEGHBEstimationMethodProperty", [propertyName])
	def _setEnumEGHBEstimationMethodProperty(self, propertyName: str, value):
		return self._callFunction("setEnumEGHBEstimationMethodProperty", [propertyName, value.value, self.documentProxyID], proxyArgumentIndices=[2])
	def _getEnumEModulusInputMethodProperty(self, propertyName: str):
		return self._callFunction("getEnumEModulusInputMethodProperty", [propertyName])
	def _setEnumEModulusInputMethodProperty(self, propertyName: str, value):
		return self._callFunction("setEnumEModulusInputMethodProperty", [propertyName, value.value, self.documentProxyID], proxyArgumentIndices=[2])
	...
	def _getEnumEGAInputTypeProperty(self, propertyName: str):
		return self._callFunction("getEnumEGAInputTypeProperty", [propertyName])
	def _setEnumEGAInputTypeProperty(self, propertyName: str, value):
		return self._callFunction("setEnumEGAInputTypeProperty", [propertyName, value.value, self.documentProxyID], proxyArgumentIndices=[2])
