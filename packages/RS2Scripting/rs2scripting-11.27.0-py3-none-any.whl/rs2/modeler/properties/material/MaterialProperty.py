...
from rs2.modeler.properties.material.field_stress.CustomConstant import CustomConstant
from rs2.modeler.properties.material.field_stress.CustomGravity import CustomGravity
...
class MaterialProperty(PropertyProxy):
	...
	Attributes:
		...
		CustomConstant (CustomConstant): Reference object for modifying property.
		CustomGravity (CustomGravity): Reference object for modifying property.
	...
	def __init__(self, client : Client, ID, documentProxyID):
		...
		self.CustomConstant = CustomConstant(client, ID, documentProxyID)
		self.CustomGravity = CustomGravity(client, ID, documentProxyID)
	...
	def getUseCustomFieldStress(self) -> bool:
		return self._getBoolProperty("MP_USE_CUSTOM_FIELD_STRESS")
	def setUseCustomFieldStress(self, value: bool):
		return self._setBoolProperty("MP_USE_CUSTOM_FIELD_STRESS", value)
