...
class MohrCoulombStrength(PropertyProxy):
	...
	def getPeakFrictionAngleBlockModel(self) -> bool:
		return self._getBoolProperty("MP_PEAK_FRICTION_ANGLE_BM")
	def setPeakFrictionAngleBlockModel(self, value: bool):
		return self._setBoolProperty("MP_PEAK_FRICTION_ANGLE_BM", value)
	def getPeakCohesionBlockModel(self) -> bool:
		return self._getBoolProperty("MP_PEAK_COHESION_BM")
	def setPeakCohesionBlockModel(self, value: bool):
		return self._setBoolProperty("MP_PEAK_COHESION_BM", value)
	def getUsePeakValueForResAngleBlockModel(self) -> bool:
		return self._getBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_ANGLE_BM")
	def setUsePeakValueForResAngleBlockModel(self, value: bool):
		return self._setBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_ANGLE_BM", value)
	def getUsePeakValueForResCohesionBlockModel(self) -> bool:
		return self._getBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_COHESION_BM")
	def setUsePeakValueForResCohesionBlockModel(self, value: bool):
		return self._setBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_COHESION_BM", value)
	def setProperties(self, MaterialType : MaterialType = None, PeakTensileStrength : float = None, PeakFrictionAngle : float = None, PeakCohesion : float = None, ResidualTensileStrength : float = None, ResidualFrictionAngle : float = None, ResidualCohesion : float = None, DilationAngle : float = None, ApplySSRShearStrengthReduction : bool = None, PeakFrictionAngleBlockModel : bool = None, PeakCohesionBlockModel : bool = None, UsePeakValueForResAngleBlockModel : bool = None, UsePeakValueForResCohesionBlockModel : bool = None):
		...
		if PeakFrictionAngleBlockModel is not None:
			self._setBoolProperty("MP_PEAK_FRICTION_ANGLE_BM", PeakFrictionAngleBlockModel)
		if PeakCohesionBlockModel is not None:
			self._setBoolProperty("MP_PEAK_COHESION_BM", PeakCohesionBlockModel)
		if UsePeakValueForResAngleBlockModel is not None:
			self._setBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_ANGLE_BM", UsePeakValueForResAngleBlockModel)
		if UsePeakValueForResCohesionBlockModel is not None:
			self._setBoolProperty("MP_USE_PEAK_VALUE_FOR_RES_COHESION_BM", UsePeakValueForResCohesionBlockModel)
	def getProperties(self):
		...
		"PeakFrictionAngleBlockModel" : self.getPeakFrictionAngleBlockModel(), 
		"PeakCohesionBlockModel" : self.getPeakCohesionBlockModel(), 
		"UsePeakValueForResAngleBlockModel" : self.getUsePeakValueForResAngleBlockModel(), 
		"UsePeakValueForResCohesionBlockModel" : self.getUsePeakValueForResCohesionBlockModel(), 
		}
