...
class HoekBrown(PropertyProxy):
	...
	def setProperties(self, MaterialType : MaterialType = None, CompressiveStrength : float = None, MbParameter : float = None, SParameter : float = None, ResidualMbParameter : float = None, ResidualSParameter : float = None, DilationParameter : float = None, ApplySSRShearStrengthReduction : bool = None, UcsBlockModel : bool = None):
		...
		if CompressiveStrength is not None:
			self._setDoubleProperty("MP_UCS", CompressiveStrength)
