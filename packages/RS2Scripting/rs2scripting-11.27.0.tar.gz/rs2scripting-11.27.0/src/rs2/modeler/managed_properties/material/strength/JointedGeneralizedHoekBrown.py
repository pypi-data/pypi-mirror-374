...
class JointedGeneralizedHoekBrownStageFactorLegacy(ProxyObject):
...
class JointedGeneralizedHoekBrownDefinedStageFactorLegacy(JointedGeneralizedHoekBrownStageFactorLegacy):
	def __init__(self, client : Client, ID, propertyID):
...
class JointedGeneralizedHoekBrownLegacy(PropertyProxy):
