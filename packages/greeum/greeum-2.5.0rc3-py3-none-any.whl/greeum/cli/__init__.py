...
@click.option('--quiet', '-q', is_flag=True, help='Suppress logging output (for Claude Desktop compatibility)')
def serve(transport: str, port: int, quiet: bool):
