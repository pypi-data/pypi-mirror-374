...
from kmbbank import kmbbankAsync


async def main():
    mb = kmbbankAsync(username=os.getenv("kmbbank_USERNAME"), password=os.getenv("kmbbank_PASSWORD"))
    ...
    await mb.getAccountByPhone(os.getenv("kmbbank_USERNAME"))
