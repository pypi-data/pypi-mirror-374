...
mod.add_function('gotdf_python_OpentdfConfig_InsecureSkipVerify_Get', retval('bool'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_InsecureSkipVerify_Set', None, [param('int64_t', 'handle'), param('bool', 'val')])
