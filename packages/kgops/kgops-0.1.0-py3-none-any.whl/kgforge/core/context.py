"""
Context Management for kgforge operations
...
from kgforge.core.exceptions import ConfigurationError
...
class Context(BaseModel):
    """
    Context for kgforge operations containing configuration and state information.
    """
