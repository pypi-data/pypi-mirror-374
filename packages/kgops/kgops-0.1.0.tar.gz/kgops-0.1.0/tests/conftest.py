"""
Pytest configuration and fixtures for kgforge tests.
"""
...
from kgforge import KGForge, Resource, Dataset
...
@pytest.fixture
def kg_forge():
    """Create a KGForge instance for testing."""
    return KGForge(backend="networkx")
