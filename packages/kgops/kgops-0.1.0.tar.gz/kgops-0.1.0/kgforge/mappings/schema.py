...
from kgforge.mappings.base import BaseMapping
from kgforge.core.exceptions import ValidationError
from kgforge.utils.validation import validate_property_value
