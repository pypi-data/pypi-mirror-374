"""
File-based storage backend for kgforge.
"""
...
from kgforge.core.exceptions import StorageError, ValidationError
from kgforge.utils.logging import get_logger
from kgforge.utils.serialization import serialize_dataset, deserialize_dataset
...
class FileStorage(BaseStorage):
    ...
    def __init__(self, context: Context, storage_path: Optional[Union[str, Path]] = None):
        ...
        if storage_path:
            ...
            self.storage_path = Path.cwd() / "kgforge_data"
