"""
Main KGForge class - the primary interface for knowledge graph operations.
"""
...
from kgforge.core.context import Context, GraphConfig, TenantConfig
from kgforge.core.resource import Resource
from kgforge.core.dataset import Dataset, Edge
from kgforge.core.exceptions import KGForgeError, ValidationError, StorageError
...
from kgforge.transforms.base import BaseTransform
from kgforge.utils.logging import get_logger


class KGForge:
    """
    Main interface for knowledge graph operations in kgforge.
    ...
    def __init__(self, 
        ...
        self.logger.info(f"KGForge initialized with backend: {self.context.graph.backend}")
    ...
    def create_graph(self, name: str, description: Optional[str] = None, 
        ...
        try:
            ...
            raise KGForgeError(f"Failed to create graph: {e}")
    ...
    def load_graph(self, source: Union[str, Path, Dict[str, Any]], 
        ...
        try:
            ...
            raise KGForgeError(f"Failed to load graph: {e}")
    ...
    def save_graph(self, path: Union[str, Path], format: str = "auto") -> None:
        ...
        try:
            ...
            raise KGForgeError(f"Failed to save graph: {e}")
    ...
    def add_resource(self, resource: Union[Resource, Dict[str, Any]], 
        ...
        try:
            ...
            raise KGForgeError(f"Failed to add resource: {e}")
    ...
    def add_edge(self, source: Union[str, Resource], target: Union[str, Resource],
        ...
        try:
            ...
            raise KGForgeError(f"Failed to add edge: {e}")
    ...
    def query(self, query_type: str = "neighbors", **params) -> Any:
        ...
        try:
            ...
            raise KGForgeError(f"Query failed: {e}")
    ...
    def export(self, format: str = "networkx", **kwargs) -> Any:
        ...
        try:
            ...
            raise KGForgeError(f"Export failed: {e}")
    ...
    def _export_networkx(self, **kwargs) -> Any:
        ...
        try:
            ...
            raise KGForgeError("NetworkX not available for export")
    ...
    def __str__(self) -> str:
        ...
        return f"KGForge(backend={self.context.graph.backend}, {graph_info})"
