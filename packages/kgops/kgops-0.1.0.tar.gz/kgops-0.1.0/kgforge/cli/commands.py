...
from kgforge import KGForge
from kgforge.core.exceptions import KGForgeError
from kgforge.transforms.converter import FormatConverter
from kgforge.transforms.validator import DataValidator
from kgforge.transforms.mapper import DataMapper
...
def ingest_data(ctx, source, format, graph, id_field, label_field):
    ...
    try:
        kg = KGForge(config=ctx.obj.get('config'))
