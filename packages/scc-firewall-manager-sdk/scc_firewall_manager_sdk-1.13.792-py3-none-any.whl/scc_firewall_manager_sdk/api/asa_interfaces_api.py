...
class ASAInterfacesApi:
    ...
    def create_asa_ether_channel_interface(
        ...
        Create an ASA EtherChannel interface. An EtherChannel interface is a logical port-channel interface that aggregates multiple physical Ethernet links into a single logical interface to increase bandwidth and provide redundancy, and it is configured and used like a physical interface for interface-related features, supporting up to 48 EtherChannels depending on the ASA model.
    ...
    def create_asa_sub_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA parent subinterface.")],
        ...
        Create an ASA subinterface. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA parent subinterface. (required)
    ...
    def create_asa_vlan_interface(
        ...
        Create an ASA VLAN interface. A VLAN interface is a logical interface that represents a virtual LAN on a physical interface, allowing multiple VLANs to be configured and segmented on a single physical interface for traffic separation and security purposes.
    ...
    def delete_asa_ether_channel_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA EtherChannel interface.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Delete an ASA EtherChannel interface. An EtherChannel interface is a logical port-channel interface that aggregates multiple physical Ethernet links into a single logical interface to increase bandwidth and provide redundancy, and it is configured and used like a physical interface for interface-related features, supporting up to 48 EtherChannels depending on the ASA model.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA EtherChannel interface. (required)
        :type interface_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def delete_asa_sub_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA subinterface.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Delete an ASA subinterface. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA subinterface. (required)
        :type interface_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def delete_asa_vlan_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA VLAN interface.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Delete an ASA VLAN interface. A VLAN interface is a logical interface that represents a virtual LAN on a physical interface, allowing multiple VLANs to be configured and segmented on a single physical interface for traffic separation and security purposes.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA VLAN interface. (required)
        :type interface_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_asa_ether_channel_interface(
        ...
        Get an ASA EtherChannel interface by UID. An EtherChannel interface is a logical port-channel interface that aggregates multiple physical Ethernet links into a single logical interface to increase bandwidth and provide redundancy, and it is configured and used like a physical interface for interface-related features, supporting up to 48 EtherChannels depending on the ASA model.
    ...
    def get_asa_interface_sub_interfaces(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA parent interface.")],
        limit: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The number of results to retrieve.")] = None,
        offset: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="The query to execute. Use the Lucene Query Syntax to construct your query.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="The fields to sort results by.")] = None,
        ...
        Get a list of ASA interface subinterfaces. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA parent interface. (required)
        :type interface_uid: str
        :param limit: The number of results to retrieve.
        :type limit: str
        :param offset: The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.
    ...
    def get_asa_physical_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA physical interface.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Get an ASA physical interface by UID. A physical interface is a hardware port on the ASA device that can be enabled and configured to connect the firewall to a network.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA physical interface. (required)
        :type interface_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_asa_physical_interfaces(
        ...
        Get a list of ASA physical interfaces. A physical interface is a hardware port on the ASA device that can be enabled and configured to connect the firewall to a network.
    ...
    def get_asa_sub_interface(
        ...
        Get an ASA subinterface by UID. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.
    ...
    def get_asa_sub_interfaces(
        ...
        Get a list of ASA subinterfaces. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.
    ...
    def get_asa_virtual_tunnel_interface(
        self,
        device_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the device.")],
        interface_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the ASA virtual tunnel interface.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Get an ASA virtual tunnel interface by UID. A virtual tunnel interface (VTI) is a logical interface that provides a point-to-point GRE or IPsec tunnel endpoint, enabling simplified VPN configuration and routing integration on the ASA device.

        :param device_uid: The unique identifier, represented as a UUID, of the device. (required)
        :type device_uid: str
        :param interface_uid: The unique identifier, represented as a UUID, of the ASA virtual tunnel interface. (required)
        :type interface_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_asa_virtual_tunnel_interfaces(
        ...
        Get a list of ASA virtual tunnel interfaces. A virtual tunnel interface (VTI) is a logical interface that provides a point-to-point GRE or IPsec tunnel endpoint, enabling simplified VPN configuration and routing integration on the ASA device.
    ...
    def get_asa_vlan_interface(
        ...
        Get an ASA VLAN interface by UID. A VLAN interface is a logical interface that represents a virtual LAN on a physical interface, allowing multiple VLANs to be configured and segmented on a single physical interface for traffic separation and security purposes.
    ...
    def get_asa_vlan_interfaces(
        ...
        Get a list of ASA VLAN interfaces. A VLAN interface is a logical interface that represents a virtual LAN on a physical interface, allowing multiple VLANs to be configured and segmented on a single physical interface for traffic separation and security purposes.
    ...
    def modify_asa_physical_interface(
        ...
        Modify an ASA physical interface. A physical interface is a hardware port on the ASA device that can be enabled and configured to connect the firewall to a network.
    ...
    def modify_asa_sub_interface(
        ...
        Modify an ASA subinterface. A subinterface is a logical interface created on a physical interface that allows the ASA to support multiple VLANs by assigning each subinterface to a different VLAN, enabling segmented network traffic over a single physical port.
    ...
    def modify_asa_vlan_interface(
        ...
        Modify an ASA VLAN interface. A VLAN interface is a logical interface that represents a virtual LAN on a physical interface, allowing multiple VLANs to be configured and segmented on a single physical interface for traffic separation and security purposes.
