...
version_line = open("sensirion_i2c_sen65/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sen65',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SEN65 sensor family',
    license='BSD',
    keywords="""Sensirion SEN65
        I2C
        SEN65""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-i2c-sen65",
        "Repository": "https://github.com/Sensirion/python-i2c-sen65",
        "Changelog": "https://github.com/Sensirion/python-i2c-sen65/blob/master/CHANGELOG.md",
    },
