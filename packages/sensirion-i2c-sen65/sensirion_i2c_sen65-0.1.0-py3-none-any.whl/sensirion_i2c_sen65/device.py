...
#
"""
The class Sen65DeviceBase implements the low level interface of the sensor.
The class Sen65Device extends the Sen65DeviceBase. It provides additional functions to ease the use of the
sensor.
"""
...
from sensirion_i2c_sen65.commands import (ActivateShtHeater, DeviceReset, DeviceStatus, GetDataReady,
...
from sensirion_i2c_sen65.result_types import (SignalHumidity, SignalMassConcentrationPm10p0,
...
class Sen65DeviceBase:
    """Low level API implementation of SEN65"""
...
class Sen65Device(Sen65DeviceBase):
    """Driver class implementation of SEN65"""
