...
# Internal imports
from .jenkins_helpers import _get_jenkins_constants, _get_cache, check_jenkins_credentials
...
def jenkins_get_recent_failed_builds(
    ...
    try:
        ...
        time_threshold = int((datetime.now() - timedelta(hours=hours_ago)).timestamp() * 1000)
