...
class SandboxClient:
    ...
    def get_sandbox_context(self, *, request_options: typing.Optional[RequestOptions] = None) -> Response:
        """
...
class AsyncSandboxClient:
    ...
    async def get_sandbox_context(self, *, request_options: typing.Optional[RequestOptions] = None) -> Response:
        """
        Get sandbox environment information
