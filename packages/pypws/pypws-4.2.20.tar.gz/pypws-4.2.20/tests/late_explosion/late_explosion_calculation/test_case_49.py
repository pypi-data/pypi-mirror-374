...
def test_49():
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((late_explosion_to_OP_levels_calculation.explosion_unif_conf_overpressure_results[0].exploded_mass - 31.04536142489174)/31.04536142489174)>1e-3):
        ...
        if (abs((late_explosion_to_OP_levels_calculation.explosion_unif_conf_overpressure_results[0].ignition_time - 1.1859455812737545)/1.1859455812737545)>1e-3):
        ...
        if (abs((late_explosion_to_OP_levels_calculation.explosion_unif_conf_overpressure_results[0].maximum_distance- 70.52548140876165)/ 70.52548140876165)>1e-3):
