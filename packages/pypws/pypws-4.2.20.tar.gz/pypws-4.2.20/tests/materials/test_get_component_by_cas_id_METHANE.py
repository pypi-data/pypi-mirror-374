...
def test_get_component_by_casid_METHANE():

    """
    Test to get the material component data by CASID for METHANE.
        
    """

    # Invoke the method.
    print ('Running get_component_by_cas_id')
    materialComponentData = get_component_by_cas_id('74828')
    ...
    assert materialComponentData.name == 'METHANE', 'METHANE not returned'
