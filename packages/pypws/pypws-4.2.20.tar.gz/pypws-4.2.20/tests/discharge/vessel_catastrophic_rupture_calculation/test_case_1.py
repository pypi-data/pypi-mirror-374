...
def test_case_1():
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((vessel_catastrophic_rupture_calculation.discharge_result.release_mass - 8403.10476066265)/8403.10476066265)>1e-3):
        ...
        if (abs((vessel_catastrophic_rupture_calculation.discharge_result.expansion_energy - 399.5722780225985)/399.5722780225985)>1e-3):
