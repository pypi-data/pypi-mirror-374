...
def test_case_2():
    ...
    state = State(temperature=300.0, pressure= 5.0e6, liquid_fraction=0.8)
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((vessel_catastrophic_rupture_calculation.discharge_result.release_mass - 4651.875667954904)/4651.875667954904)>1e-3):
        ...
        if (abs((vessel_catastrophic_rupture_calculation.discharge_result.expansion_energy - 385.60331992903724)/385.60331992903724)>1e-3):
