...
def test_butane_vessel_state_calculation():
    # Define the initial state of the vessel.
    state = State(temperature=300.0, pressure=8.0e6, liquid_fraction=0.8)
    # Define the material contained by the vessel.
    material = Material("N-BUTANE", [MaterialComponent("N-BUTANE", 1.0)])
