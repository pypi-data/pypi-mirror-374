...
def test_case_59():
    ...
    if resultCode == ResultCode.SUCCESS:
        if (abs((long_pipe_breach_calculation.discharge_records[1].mass_flow- 395.8218347470558)/ 395.8218347470558)>1e-3):
        ...
        if (abs((long_pipe_breach_calculation.discharge_result.release_mass- 8909.033415824528)/ 8909.033415824528)>1e-3):    
