...
def test_case_56():
    ...
    if resultCode == ResultCode.SUCCESS:
        if (abs((long_pipe_breach_calculation.discharge_records[1].mass_flow-26120.676566180955)/26120.676566180955)>1e-3):
        ...
        if (abs((long_pipe_breach_calculation.discharge_result.release_mass- 11421.86243095664)/ 11421.86243095664)>1e-3):    
