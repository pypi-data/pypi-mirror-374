...
def test_case_58():
    ...
    if resultCode == ResultCode.SUCCESS:
        if (abs((long_pipe_breach_calculation.discharge_records[1].mass_flow- 989.859163055802)/ 989.859163055802)>1e-3):
        ...
        if (abs((long_pipe_breach_calculation.discharge_result.release_mass- 19120.476210344274)/ 19120.476210344274)>1e-3):    
