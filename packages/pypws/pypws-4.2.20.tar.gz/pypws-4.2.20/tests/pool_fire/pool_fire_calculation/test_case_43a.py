...
def test_case_43a():
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((radiation_at_points_for_pool_fires_calculation.radiation[0]-136477.34375)/136477.34375)>1e-3):
            assert False,f'Regression failed with radiation value {radiation_at_points_for_pool_fires_calculation.radiation[0]}'
        if (abs((radiation_at_points_for_pool_fires_calculation.pool_fire_flame_result.flame_diameter-30.674606323242188)/30.674606323242188)>1e-3):
