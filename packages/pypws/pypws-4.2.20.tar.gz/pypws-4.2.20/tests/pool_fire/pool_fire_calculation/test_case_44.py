...
def test_44():
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if (abs((distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points[len(distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points)-1].x-57.950279071403216)/57.950279071403216)> 1e-3):
        ...
        if (abs((distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.pool_fire_flame_result.flame_diameter-41.44367599487305)/41.44367599487305)> 1e-3):
