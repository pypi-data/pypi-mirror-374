...
def case_42():
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if (abs((distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points[len(distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points)-1]-57.57741153697067)/57.57741153697067)> 1e-3):
            assert False,f'Regression failed with distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points[len(distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points)-1] = {distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points[len(distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.contour_points)-1]}'
        if (abs((distances_and_ellipses_to_radiation_levels_for_pool_fires_calculation.pool_fire_flame_result.flame_diameter-36.82126235961914)/36.82126235961914)> 1e-3):
