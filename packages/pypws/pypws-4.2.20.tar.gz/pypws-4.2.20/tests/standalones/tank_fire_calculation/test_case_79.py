...
def test_case_79():
    ...
    if result_code == ResultCode.SUCCESS:
        if (abs((tank_fire_calculation.pool_fire_flame_result.surface_emissive_power - 126425.34375) / 126425.34375) > 1e-3):
        ...
        if (abs((tank_fire_calculation.pool_fire_flame_result.flame_length - 3.9397664070129395) / 3.9397664070129395) > 1e-3):
