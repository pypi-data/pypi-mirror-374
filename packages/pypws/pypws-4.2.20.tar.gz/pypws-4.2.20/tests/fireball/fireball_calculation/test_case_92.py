...
def test_case_92():
    ...
    if result_code == ResultCode.SUCCESS:
        if (abs((fireball_calculation.flame_result.flame_diameter- 46.949886322021484)/46.949886322021484) > 1e-3):
        ...
        if (len(radiation_transect_calculation.radiation_records) != 50):
        ...
        if (abs((radiation_transect_calculation.radiation_records[0].radiation_result - 97828.68190075974)/97828.68190075974)> 1e-3):
