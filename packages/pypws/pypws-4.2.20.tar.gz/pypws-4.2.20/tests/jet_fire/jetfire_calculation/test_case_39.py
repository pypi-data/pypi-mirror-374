...
def test_case_39():
    ...
    if resultCode == ResultCode.SUCCESS:
        if (abs((jet_fire_calculation.flame_result.flame_length- 33.750426875730376)/ 33.750426875730376)>1e-3):
        ...
        if (abs((jet_fire_calculation.flame_result.surface_emissive_power-309079.19061404973)/309079.19061404973)>1e-3):
