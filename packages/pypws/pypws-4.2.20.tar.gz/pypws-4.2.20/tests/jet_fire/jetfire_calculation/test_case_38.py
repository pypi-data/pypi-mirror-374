...
def test_case_38():
    ...
    if resultCode == ResultCode.SUCCESS:
        if (abs((jet_fire_calculation.flame_result.flame_length- 98.19868637938056)/ 98.19868637938056)>1e-3):
        ...
        if (abs((jet_fire_calculation.flame_result.surface_emissive_power-175803.22174161073)/175803.22174161073)>1e-3):
