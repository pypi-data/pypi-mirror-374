...
def test_case_106():
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if (len(max_conc_distance_calculation.concentration_records) >0):
            if (abs((max_conc_distance_calculation.concentration_records[len(max_conc_distance_calculation.concentration_records)-1].concentration-0.0012711289961270592)/0.0012711289961270592) > 1e-3):
        ...
        if (len(max_conc_distance_calculation.concentration_records) != 26):
        ...
        if (len(max_conc_distance_calculation.concentration_records) >0):
            if (abs((max_conc_distance_calculation.concentration_records[len(max_conc_distance_calculation.concentration_records)-1].position.x- 842.991655276627)/847.0777612139595) > 1e-3):
