...
def test_case_108():
    ...
    special_concentration = SpecialConcentration.LFL
    lfl_fraction = 0.3
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(max_conc_distance_calculation.concentration_records) >0):
            if (abs((max_conc_distance_calculation.concentration_records[len(max_conc_distance_calculation.concentration_records)-1].concentration-0.3615707454077038)/0.3615707454077038) > 1e-3):
        ...
        if (len(max_conc_distance_calculation.concentration_records) != 108):
        ...
        if (len(max_conc_distance_calculation.concentration_records) >0):
            if (abs((max_conc_distance_calculation.concentration_records[len(max_conc_distance_calculation.concentration_records)-1].position.x-6.446181601923854)/6.446181601923854) > 1e-3):
