...
def test_case_32():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(max_conc_footprint_calculation.contour_points)!=569):
        ...
        if (abs((max_conc_footprint_calculation.contour_points[len(max_conc_footprint_calculation.contour_points)-3].x-(-5.466432738453024))/(-5.466432738453024))>1e-3):
