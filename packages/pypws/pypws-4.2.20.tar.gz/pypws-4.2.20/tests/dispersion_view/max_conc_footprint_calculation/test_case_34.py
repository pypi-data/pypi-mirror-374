...
def test_case_34():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(max_conc_footprint_calculation.contour_points)!=587):
        ...
        if (abs((max_conc_footprint_calculation.contour_points[len(max_conc_footprint_calculation.contour_points)-3].x-(-0.3224436750622628))/(-0.3224436750622628))>1e-3):
