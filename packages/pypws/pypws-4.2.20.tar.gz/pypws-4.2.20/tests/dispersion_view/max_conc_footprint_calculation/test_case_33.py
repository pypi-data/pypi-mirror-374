...
def test_case_33():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(max_conc_footprint_calculation.contour_points)!=553):
        ...
        if (abs((max_conc_footprint_calculation.contour_points[len(max_conc_footprint_calculation.contour_points)-3].x-(-0.09459660419095317))/(-0.09459660419095317))>1e-3):
