...
def test_case_31():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(max_conc_footprint_calculation.contour_points)!=723):
        ...
        if (abs((max_conc_footprint_calculation.contour_points[len(max_conc_footprint_calculation.contour_points)-3].x-(-7.7737846974650235))/(-7.7737846974650235))>1e-3):
