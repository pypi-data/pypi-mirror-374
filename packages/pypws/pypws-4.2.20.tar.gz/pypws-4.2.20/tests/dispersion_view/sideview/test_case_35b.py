...
def test_case_35b():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(sideview_at_time_calculation.contour_points) != 197):
        ...
        if (len(sideview_at_time_calculation.contour_points) > 0):
            if (abs((sideview_at_time_calculation.contour_points[len(sideview_at_time_calculation.contour_points)-3].x -  130.8644880935483)/ 130.8644880935483) >1e-3):
        ...
        if (len(sideview_at_time_calculation.dispersion_records) > 0):
            if(abs((sideview_at_time_calculation.dispersion_records[len(sideview_at_time_calculation.dispersion_records)-1].centreline_concentration - 1.4451621633042375e-05)/1.4451621633042375e-05)>1e-3):
