...
def test_case_31b():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(sideview_at_time_calculation.contour_points) != 190):
        ...
        if (len(sideview_at_time_calculation.contour_points) > 0):
            if (abs((sideview_at_time_calculation.contour_points[len(sideview_at_time_calculation.contour_points)-3].x -  2.8916389790099224)/ 2.8916389790099224) >1e-3):
        ...
        if (len(sideview_at_time_calculation.dispersion_records) > 0):
            if(abs((sideview_at_time_calculation.dispersion_records[len(sideview_at_time_calculation.dispersion_records)-1].centreline_concentration - 0.004768006933732604)/0.004768006933732604)>1e-3):
