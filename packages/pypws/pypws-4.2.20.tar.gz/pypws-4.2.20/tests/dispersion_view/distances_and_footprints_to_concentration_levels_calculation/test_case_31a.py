...
def test_case_31a():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points) != 723):
        ...
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points)>0):
            if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(-7.7737846974650235))/(-7.7737846974650235)) > 1e-3):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 33.477492122323696)/ 33.477492122323696) > 1e-3):
