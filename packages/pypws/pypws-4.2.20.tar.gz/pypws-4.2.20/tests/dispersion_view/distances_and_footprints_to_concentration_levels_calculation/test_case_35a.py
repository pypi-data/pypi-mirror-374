...
def test_case_35a():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points) !=651):
        ...
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points)>0):
            if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(3.5444266994358022))/(3.5444266994358022)) > 1e-3):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 658.8828694811095)/ 658.8828694811095) > 1e-3):
