...
def test_case_32a():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points) != 569):
        ...
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points)>0):
            if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(-5.466432738453024))/(-5.466432738453024)) > 1e-3):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 14.139820655455761)/ 14.139820655455761) > 1e-3):
