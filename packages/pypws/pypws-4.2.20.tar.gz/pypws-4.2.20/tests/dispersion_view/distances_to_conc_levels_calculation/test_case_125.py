...
def test_case_125():
    ...
    dispersion_output_config = DispersionOutputConfig(concentration = end_point_concentration, elevation=0.0)
    ...
    if resultCode == resultCode.SUCCESS:
        print(f'distances = {distances_to_conc_levels_calculation.distances[0]}')
