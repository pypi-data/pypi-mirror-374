...
def test_case_115():
    ...
    dispersion_output_config = DispersionOutputConfig(concentration = 1e-4, elevation = 3.5, special_concentration = SpecialConcentration.NOT_DEFINED)
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((max_distance_to_conc_calculation.distance - 319.19195887085976 )/ 319.19195887085976) > 1e-3):
