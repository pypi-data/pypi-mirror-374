...
def test_case_126():
	...
	if resultCode == ResultCode.SUCCESS:
		if (abs((load_mass_inventory_vessel_for_line_rupture_scenario_calculation.vessel.diameter-1.521293357476972)/1.521293357476972)>1e-3):
		...
		if (abs((load_mass_inventory_vessel_for_line_rupture_scenario_calculation.vessel.location.z-(-0.3626191519898414))/(-0.3626191519898414))>1e-3):
		...
		if (abs((load_mass_inventory_vessel_for_line_rupture_scenario_calculation.line_rupture.pipe_height_fraction-0.8956978253357473)/0.8956978253357473)>1e-3):
