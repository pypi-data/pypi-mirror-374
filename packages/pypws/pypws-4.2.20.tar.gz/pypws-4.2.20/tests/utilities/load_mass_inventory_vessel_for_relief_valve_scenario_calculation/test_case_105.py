...
def test_case_105():
	...
	if resultCode == ResultCode.SUCCESS:
		if (abs((load_mass_inventory_vessel_for_relief_valve_scenario_calculation.vessel.diameter- 3.0323298714998153)/ 3.0323298714998153)>1e-3):
		...
		if (abs((load_mass_inventory_vessel_for_relief_valve_scenario_calculation.vessel.location.z-(-1.7170445294165657))/(-1.7170445294165657))>1e-3):
		...
		if (abs((load_mass_inventory_vessel_for_relief_valve_scenario_calculation.relief_valve.pipe_height_fraction-0.8960253813259087)/0.8960253813259087)>1e-3):
