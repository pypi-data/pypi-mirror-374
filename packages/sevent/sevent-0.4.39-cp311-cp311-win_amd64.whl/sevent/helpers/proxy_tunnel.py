...
def main(argv):
    ...
    parser.add_argument('-l', dest='listen_port', default=8078, type=int, help='server mode reverse server listen port (default: 8078)')
    ...
    parser.add_argument('-P', dest='connect_port', default=8078, type=int, help='client mode reverse client connect server port (default: 8078)')
