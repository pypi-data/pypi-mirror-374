...
from numpy import absolute, corrcoef, diag, dot, finfo, inf, isnan, \
...
def __leastsq(xyw, func, p, dp, niter=50, mode='print', eps=1e-3):
    ...
    options[:, 1] = ones(len(p)) * inf
    # not yet implemented standards are set (zero for precision, inf for max change)
