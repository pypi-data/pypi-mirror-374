...
class Color:
    ...
    This GTK4 implementation provides integration with modern
    ...
    def get_gdk_color(self):
        ...
        return Gdk.Color(int(self._r * 65535), int(self._g * 65535), int(self._b * 65535))
...
PALETTE_CURSOR_DISTANCE = zoom(10)  #: Cursor invoked palettes will be placed this far from the cursor
