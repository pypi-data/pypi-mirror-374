...
# {
    ...
    # {
        ...
        while attempts < 100:
        # {
            self.v_print(f"SA[{str(self.idnum)}]. Attempt={str(attempts)}")
            ...
            self.v_print(f'attempt number', {attempts})
        # }
        return None
    # }
