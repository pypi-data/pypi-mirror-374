...
# {
    ...
    def predict_setup(self, X_new, varnames, est_coeff, avail_new=None, isvars = None, ids = None, transvars = None, alts =None, y = None, J = None):
        """
        ...
        self.fixedtransvars = self.transvars
        self.X_new, self.Xnames = self.setup_design_matrix(self.X_new)
