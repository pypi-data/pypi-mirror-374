...
integration = AgentRIntegration(name="youtube", api_key="sk_416e4f88-3beb-4a79-a0ef-fb1d2c095aee", base_url="https://api.agentr.dev")
app_instance = YoutubeApp(integration=integration)
tool_manager = ToolManager()
tool_manager.add_tool(app_instance.get_captions)



async def main():
    # Get a specific tool by name
    tool = tool_manager.get_tool("search_videos")
    ...
    result=await tool_manager.call_tool(name="get_captions",arguments={"video_id":"l2p3fZyV254"})
    # result = await tool_manager.call_tool(
    #     name="get_user_id",
    #     arguments={
