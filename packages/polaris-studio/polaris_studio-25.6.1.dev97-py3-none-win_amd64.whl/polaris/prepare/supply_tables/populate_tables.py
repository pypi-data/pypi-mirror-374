...
from polaris.prepare.supply_tables.utils.overture_data import get_pois
...
class Populator:
    ...
    def add_school_locations(self, enrolments: Union[Path, gpd.GeoDataFrame]):
        ...
        places = get_pois(zones)
        prek_places = places.loc[places.main_category == "day_care_preschool"]
        ...
        enrolments = pd.concat([enrolments.to_crs(prek_locs.crs), prek_locs], ignore_index=True)
