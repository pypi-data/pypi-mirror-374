...
readonly SRC_DIR="./examexam"
readonly TMP_ROOT="/tmp"
readonly TMP_DIR="${TMP_ROOT}/examexam"
readonly OUTPUT_MD_BASENAME="examexam.flat.md"
...
# Run strip-docs for each subdirectory of tmp/examexam
...
# in the generated Markdown (examexam.flat.md). Other code fences remain untouched.
