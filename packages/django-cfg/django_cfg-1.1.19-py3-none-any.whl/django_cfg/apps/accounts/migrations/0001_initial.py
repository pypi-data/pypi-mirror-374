# Generated by Django 5.2.5 on 2025-09-05 07:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        help_text="Source URL (e.g., https://unrealon.com)", unique=True
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        blank=True,
                        help_text="Display name for the source",
                        max_length=100,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=django_cfg.apps.accounts.models.user_avatar_path,
                    ),
                ),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
            ...
            managers=[
                (
                    "objects",
                    django_cfg.apps.accounts.managers.user_manager.UserManager(),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether this was the first registration from this source",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="user_registration_sources",
                        to="django_cfg_accounts.registrationsource",
                    ),
                ),
                (
                    "user",
