...
class GraphQLCache:
    ...
    def _make_key(self, operation: str, query: DocumentNode, variables: Optional[Dict[str, Any]]) -> str:
    ...
    def get(self, operation: str, query: DocumentNode, variables: Optional[Dict[str, Any]]) -> Optional[Any]:
    ...
    def set(self, operation: str, query: DocumentNode, variables: Optional[Dict[str, Any]], result: Any) -> None:
        """Cache a result."""
...
class PerformanceMonitor:
    ...
    def record_operation(self, operation: str, duration: float, variables: Optional[Dict[str, Any]] = None) -> None:
    ...
    def get_slow_operations(self, limit: int = 10) -> List[Tuple[str, float, Dict[str, Any]]]:
...
class GraphQLClient(BaseService):
    ...
    def _should_cache(self, operation: str) -> bool:
        ...
        read_only_operations = {
            "GetAccounts", "GetTransactions", "GetCategories", "GetMe",
            "GetMerchants", "GetInstitutions", "GetBudgets", "GetGoals",
            "GetTransactionRules", "GetHoldings", "GetInsights"
        }
    ...
    async def execute_batch(
        ...
        async def execute_single(op_data: Tuple[str, DocumentNode, Optional[Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        for i, result in enumerate(results):
            if isinstance(result, Exception):
                ...
                self.logger.error("Batch operation failed", operation=operation_name, error=str(result))
                raise result
