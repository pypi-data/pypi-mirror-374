...
class HttpTransform(BaseModel):
    ...
    jsonata: Optional[StrictStr] = Field(
        default=None, description="JSONata transformation, if JSONata"
    )
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(
            ["", "bridge", "jsonata", "flatten", "simple", "body", "payload"]
        ):
            raise ValueError(
                "must be one of enum values ('', 'bridge', 'jsonata', 'flatten', 'simple', 'body', 'payload')"
            )
        return value
