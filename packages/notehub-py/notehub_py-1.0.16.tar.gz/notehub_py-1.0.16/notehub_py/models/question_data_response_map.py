...
class QuestionDataResponseMap(BaseModel):
    """
    ...
    title: StrictStr = Field(description="Title of the map.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"type": obj.get("type"), "title": obj.get("title")})
        return _obj
