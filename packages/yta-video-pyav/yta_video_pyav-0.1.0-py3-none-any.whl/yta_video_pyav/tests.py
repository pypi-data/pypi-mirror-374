...
def video_modified_stored():
    ...
    from yta_video_pyav.complete.timeline import Timeline
    ...
    video_60fps = Video(VIDEO_PATH, 0.25, 0.75)
    video_30fps = Video(VIDEO_PATH_30FPS, 5, 6)
    video_29_97fps = Video(VIDEO_PATH_29_97FPS, 6.1, 7.7)
    timeline = Timeline()
