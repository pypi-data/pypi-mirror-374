...
#   timestamp: 2025-08-29T22:05:15+00:00
...
class SubmitOrderMarketDtoData(BaseModel):
    ...
    client_order_id: Optional[str] = Field(
        None,
        alias="clientOrderId",
        description="A subaccount scoped unique client-generated order id (either a valid UUID or alphanumeric string up to 32 characters)",
...
class SubmitOrderCreatedDto(BaseModel):
    ...
    client_order_id: Optional[str] = Field(
        None,
        alias="clientOrderId",
        description="A subaccount scoped unique client-generated order id (max 36 characters)",
    )
    filled: str = Field(
        ...,
        description="Filled amount in native units expressed as a decimal (precision: 9)",
...
class CancelOrderResultDto(BaseModel):
    ...
    client_order_id: Optional[str] = Field(
        None,
        alias="clientOrderId",
        description="Client-generated order id of the order that was canceled",
        examples=["80569be0-afba-43f8-ac20-767d0974c6a3"],
    )
