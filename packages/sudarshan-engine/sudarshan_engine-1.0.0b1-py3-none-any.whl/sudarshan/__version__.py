...
VERSION_MINOR = 0
VERSION_PATCH = 0
VERSION_SUFFIX = "beta.1"  # e.g., "dev", "rc1", "beta.1"
...
DOCUMENTATION_URL = "https://sudarshan-engine.readthedocs.io/"
...
def get_security_advisories() -> list:
    ...
    advisories.append("Beta version: Report any security issues to security@sudarshan.engine")
