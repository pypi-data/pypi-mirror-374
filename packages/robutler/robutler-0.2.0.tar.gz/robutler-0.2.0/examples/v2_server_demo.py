...
from robutler.utils.logging import setup_logging, capture_all_loggers
...
def main():
    ...
    print("🚀 Robutler V2.0 Server Demo")
    print("=" * 50)
    ...
    # Create server
    print("\n🌐 Creating Robutler V2.0 Server...")
    server = RobutlerServer(
        agents=agents,
        title="Robutler V2.0 Demo Server",
