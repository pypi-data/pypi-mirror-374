"""
Prompt Decorator Test - Robutler
...
from robutler.agents.tools.decorators import tool, hook, prompt
from robutler.server.context.context_vars import Context, create_context
...
class TestPromptDecorator:
    ...
    async def test_prompt_execution_owner_scope(self, agent_with_prompts):
        ...
        from robutler.server.context.context_vars import set_context
        set_context(context)
    ...
    async def test_prompt_context_injection(self, agent_with_prompts):
        ...
        # Mock the context
        with patch('robutler.server.context.context_vars.get_context', return_value=context):
            prompt_content = await agent_with_prompts._execute_prompts(context)
