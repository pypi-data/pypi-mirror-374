"""
Integration Tests for Dynamic Agent System - Robutler V2.0
...
from robutler.server.core.app import create_server, RobutlerServer
from robutler.agents.core.dynamic_factory import DynamicAgentFactory
...
class TestDynamicAgentsServerIntegration:
    ...
    def test_dynamic_agent_chat_completion_non_streaming(self, test_client, portal_agent_data):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with patch('robutler.agents.core.base_agent.BaseAgent.run') as mock_run:
