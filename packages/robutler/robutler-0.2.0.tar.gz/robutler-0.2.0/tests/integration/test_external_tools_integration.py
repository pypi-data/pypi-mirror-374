...
1. Client sends request with external tools to real Robutler server
...
# Import Robutler components - ZERO MOCKING - true integration test
...
from robutler.server.models import ChatCompletionRequest
...
class ExternalToolsIntegrationTest:
    ...
    async def setup(self):
        ...
        # Create server
        self.server = RobutlerServer(agents=[agent])
