...
from robutler.agents.skills.base import Skill, Handoff, HandoffResult
...
class TestHTTPDecorator:
    ...
    def test_http_decorator_basic(self):
        ...
        assert hasattr(test_handler, '_robutler_is_http')
        assert test_handler._robutler_is_http is True
    ...
    def test_http_decorator_with_params(self):
        ...
        assert get_weather._robutler_is_http is True
    ...
    def test_http_decorator_post_method(self):
        ...
        assert post_data._robutler_is_http is True
