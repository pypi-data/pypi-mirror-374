"""
Tests for Robutler Tool and Pricing Decorators
...
from robutler.agents.tools.decorators import tool, pricing, PricingInfo, hook, prompt, handoff, http
...
class TestPricingDecorator:
    ...
    def test_pricing_decorator_fixed_pricing(self):
        ...
        assert hasattr(fixed_pricing_tool, '_robutler_pricing')
        pricing_meta = fixed_pricing_tool._robutler_pricing
    ...
    def test_pricing_decorator_dynamic_pricing(self):
        ...
        pricing_meta = dynamic_pricing_tool._robutler_pricing
    ...
    def test_pricing_decorator_with_callbacks(self):
        ...
        pricing_meta = callback_tool._robutler_pricing
    ...
    async def test_pricing_decorator_async_function(self):
        ...
        # Check metadata
        pricing_meta = async_pricing_tool._robutler_pricing
    ...
    def test_pricing_decorator_without_parameters(self):
        ...
        pricing_meta = no_params_tool._robutler_pricing
        assert pricing_meta['credits_per_call'] is None
        assert pricing_meta['supports_dynamic'] is True
...
class TestToolAndPricingIntegration:
    ...
    def test_tool_with_fixed_pricing(self):
        ...
        # Check tool metadata
        assert hasattr(weather_tool, '_robutler_is_tool')
        assert weather_tool._robutler_is_tool is True
        assert weather_tool._tool_name == "weather_service"
        assert weather_tool._tool_description == "Get weather data"
        
        # Check pricing metadata
        assert hasattr(weather_tool, '_robutler_pricing')
        pricing_meta = weather_tool._robutler_pricing
    ...
    def test_tool_with_dynamic_pricing(self):
        ...
        assert hasattr(analyze_tool, '_robutler_is_tool')
        assert hasattr(analyze_tool, '_robutler_pricing')
    ...
    def test_tool_without_pricing(self):
        ...
        assert hasattr(free_tool, '_robutler_is_tool')
        assert not hasattr(free_tool, '_robutler_pricing')
...
class TestOtherDecorators:
    ...
    def test_hook_decorator(self):
        ...
        assert hasattr(message_hook, '_robutler_is_hook')
    ...
    def test_prompt_decorator(self):
        ...
        assert hasattr(system_prompt, '_robutler_is_prompt')
    ...
    def test_handoff_decorator(self):
        ...
        assert hasattr(escalation_handoff, '_robutler_is_handoff')
    ...
    def test_http_decorator(self):
        ...
        assert hasattr(http_endpoint, '_robutler_is_http')
...
class TestDecoratorEdgeCases:
    ...
    def test_multiple_pricing_decorators(self):
        ...
        pricing_meta = multi_pricing_tool._robutler_pricing
    ...
    def test_pricing_with_zero_credits(self):
        ...
        pricing_meta = zero_cost_tool._robutler_pricing
    ...
    def test_pricing_with_negative_credits(self):
        ...
        pricing_meta = refund_tool._robutler_pricing
    ...
    def test_pricing_decorator_preserves_function_attributes(self):
        ...
        assert hasattr(decorated, '_robutler_pricing')
