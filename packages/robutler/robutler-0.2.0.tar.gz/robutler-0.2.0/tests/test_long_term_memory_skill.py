"""
Test suite for LongTermMemorySkill - Persistent memory management with robutler storage
"""
...
async def test_long_term_memory_skill_import():
    ...
    from robutler.agents.skills.core.long_term_memory import LongTermMemorySkill
...
async def test_long_term_memory_skill_initialization():
    ...
    try:
        ...
        assert skill.use_robutler_storage == True
...
async def test_save_memory():
    ...
    try:
        skill = LongTermMemorySkill({
            'fallback_file': temp_file,
            'use_robutler_storage': False  # Use local storage for testing
        })
...
@pytest.mark.asyncio
async def test_robutler_storage_integration():
    """Test integration with robutler storage skill"""
    from robutler.agents.skills.core.long_term_memory import LongTermMemorySkill
    ...
    try:
        ...
        # Save a memory
        result = await skill.save_memory("Test robutler storage", "fact", 7)
        result_data = json.loads(result)
        ...
        print("✅ Robutler storage integration test passed")
    finally:
        pass
...
async def test_skill_info():
    ...
    try:
        ...
        assert "Robutler portal storage integration" in info["description"]
...
if __name__ == "__main__":
    ...
    async def run_long_term_memory_tests():
        ...
        tests = [
            ...
            test_robutler_storage_integration,
            test_memory_stats,
            test_skill_info
        ]
