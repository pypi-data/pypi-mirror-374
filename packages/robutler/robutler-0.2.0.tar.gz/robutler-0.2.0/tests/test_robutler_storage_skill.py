"""
Test suite for RobutlerStorageSkill - Portal content storage integration via RobutlerClient
"""
...
# Add robutler to path for testing
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))


@pytest.mark.asyncio
async def test_robutler_storage_skill_import():
    """Test that RobutlerStorageSkill can be imported successfully"""
    from robutler.agents.skills.robutler.storage import RobutlerStorageSkill
    assert RobutlerStorageSkill is not None
    print("✅ RobutlerStorageSkill import successful")


@pytest.mark.asyncio
async def test_robutler_storage_skill_initialization():
    """Test RobutlerStorageSkill initialization"""
    from robutler.agents.skills.robutler.storage import RobutlerStorageSkill
    
    # Default initialization
    skill = RobutlerStorageSkill({'agent_name': 'test_agent'})
    ...
    skill_custom = RobutlerStorageSkill(config)
    ...
    print("✅ RobutlerStorageSkill initialization test passed")
...
async def test_skill_info():
    ...
    try:
        ...
        assert info["name"] == "RobutlerStorageSkill"
...
if __name__ == "__main__":
    ...
    async def run_storage_tests():
        print("🧪 Running RobutlerStorageSkill Tests...")
        
        tests = [
            test_robutler_storage_skill_import,
            test_robutler_storage_skill_initialization,
        ...
        print("🎯 RobutlerStorageSkill Tests Complete!")
