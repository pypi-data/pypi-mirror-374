...
from robutler.agents.skills.robutler.nli import NLISkill, NLICommunication, AgentEndpoint
...
class TestNLISkillInitialization:
    ...
    async def test_nli_skill_initialization(self, nli_skill):
        ...
        with patch('robutler.agents.skills.robutler.nli.skill.HTTPX_AVAILABLE', True):
            with patch('robutler.agents.skills.robutler.nli.skill.httpx.AsyncClient') as mock_client_class:
    ...
    async def test_nli_skill_initialization_no_httpx(self, nli_skill):
        ...
        with patch('robutler.agents.skills.robutler.nli.skill.HTTPX_AVAILABLE', False):
            await nli_skill.initialize(mock_agent)
...
class TestNLICommunication:
    ...
    async def test_nli_communication_timeout(self, initialized_nli_skill):
        ...
        from robutler.agents.skills.robutler.nli.skill import httpx
