"""
Test suite for Dynamic Agent System - Robutler V2.0
...
from robutler.agents.core.dynamic_factory import DynamicAgentFactory, get_dynamic_agent_factory
from robutler.agents.core.base_agent import BaseAgent
from robutler.server.core.app import RobutlerServer, create_server
...
class TestDynamicAgentFactory:
    ...
    def test_create_agent_from_data(self, factory, sample_agent_data):
        ...
        assert "robutler_discovery" in agent.instructions  # Has discovery tool
...
class TestServerDynamicAgentIntegration:
    ...
    def test_server_creation_with_custom_resolver(self, custom_resolver):
        ...
        server = RobutlerServer(dynamic_agents=custom_resolver)
    ...
    def test_server_creation_with_portal_resolver(self):
        ...
        with patch('robutler.server.core.app.get_dynamic_agent_factory') as mock_get_factory:
            mock_factory = Mock()
            mock_get_factory.return_value = mock_factory
            
            server = RobutlerServer()
    ...
    async def test_resolve_agent_static_first(self):
        ...
        server = RobutlerServer(agents=[static_agent])
    ...
    async def test_resolve_agent_dynamic_async(self, mock_agent):
        ...
        server = RobutlerServer(dynamic_agents=async_resolver)
    ...
    def test_create_server_factory_function(self):
        ...
        with patch('robutler.server.core.app.get_dynamic_agent_factory'):
