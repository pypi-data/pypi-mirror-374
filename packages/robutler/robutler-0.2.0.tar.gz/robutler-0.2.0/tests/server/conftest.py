"""
Server Test Fixtures - Robutler V2.0
...
from robutler.server.models import ChatCompletionRequest, OpenAIResponse
...
def multi_agent_server(multi_agent_setup):
    ...
    return RobutlerServer(agents=multi_agent_setup)
