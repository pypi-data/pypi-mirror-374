...
async def test_vector_memory_skill_import():
    ...
    from robutler.agents.skills.core.vector_memory import VectorMemorySkill, VectorMemoryItem
...
async def test_vector_memory_item():
    ...
    from robutler.agents.skills.core.vector_memory import VectorMemoryItem
...
async def test_vector_memory_with_mocked_dependencies():
    ...
    with patch('robutler.agents.skills.core.vector_memory.vector_memory_skill.MILVUS_AVAILABLE', True), \
         patch('robutler.agents.skills.core.vector_memory.vector_memory_skill.openai') as mock_openai:
