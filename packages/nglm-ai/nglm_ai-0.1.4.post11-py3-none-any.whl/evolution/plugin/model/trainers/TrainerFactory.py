...
class TrainerFactory:
    ...
    def all_subclasses(cls, class_ref: type):
        subclasses = []
        for sub in class_ref.__subclasses__():
            subclasses.append(sub)
            subclasses.extend(cls.all_subclasses(sub))
        return subclasses
    ...
    def create(cls, config) -> BaseTrainer:
        ...
        trainer_cls = cls.all_subclasses(BaseTrainer).get(model_type.lower())
