...
class TrainerFactory:
    ...
    def get_all_subclasses(class_ref: type):
        print(class_ref)
        subclasses = set(class_ref.__subclasses__())
        print(subclasses)
        for subclass in list(subclasses):
            subclasses |= class_ref.get_all_subclasses(subclass)
        print("******* => ", subclasses)
        return subclasses
    ...
    def create(cls, config) -> BaseTrainer:
        ...
        trainer_cls = cls.get_all_subclasses(BaseTrainer).get(model_type.lower())
