...
class VendorCredit(BaseModel):
    ...
    """The monetary amount of the vendor credit, represented as a decimal string.

    When applied to a vendor bill, this amount reduces the outstanding balance owed
    to the vendor.
    """

    credit_amount_in_home_currency: Optional[str] = FieldInfo(alias="creditAmountInHomeCurrency", default=None)
    """
