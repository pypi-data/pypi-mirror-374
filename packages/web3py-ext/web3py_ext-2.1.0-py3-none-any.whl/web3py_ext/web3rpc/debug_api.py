...
class DebugApi(Module):
    ...
    _gasless_info: Method[Callable[..., Any]] = Method(
        namespace + "_gaslessInfo", mungers=[default_root_munger]
    )

    def gasless_info(self, *args) -> Any:
        return self._gasless_info(*args)
    ...
    _is_gasless_tx: Method[Callable[..., Any]] = Method(
        namespace + "_isGaslessTx", mungers=[default_root_munger]
    )

    def is_gasless_tx(self, *args) -> Any:
        return self._is_gasless_tx(*args)
...
class AsyncDebugApi(Module):
    ...
    _gasless_info: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_gaslessInfo", mungers=[default_root_munger]
    )

    async def gasless_info(self, *args) -> Any:
        return await self._gasless_info(*args)
    ...
    _is_gasless_tx: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_isGaslessTx", mungers=[default_root_munger]
    )

    async def is_gasless_tx(self, *args) -> Any:
        return await self._is_gasless_tx(*args)
