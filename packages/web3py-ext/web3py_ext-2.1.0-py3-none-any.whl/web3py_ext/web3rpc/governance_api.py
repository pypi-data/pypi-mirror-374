...
class GovernanceApi(Module):
    ...
    _governance_status: Method[Callable[..., Any]] = Method(
        namespace + "_governanceStatus", mungers=[default_root_munger]
    )

    def governance_status(self, *args) -> Any:
        return self._governance_status(*args)
...
class AsyncGovernanceApi(Module):
    ...
    _governance_status: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_governanceStatus", mungers=[default_root_munger]
    )

    async def governance_status(self, *args) -> Any:
        return await self._governance_status(*args)
