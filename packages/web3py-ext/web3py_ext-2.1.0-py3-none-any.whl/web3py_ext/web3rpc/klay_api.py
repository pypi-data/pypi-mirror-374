...
class KlayApi(Module):
    ...
    _is_console_log_enabled: Method[Callable[..., Any]] = Method(
        namespace + "_isConsoleLogEnabled", mungers=[default_root_munger]
    )

    def is_console_log_enabled(self, *args) -> Any:
        return self._is_console_log_enabled(*args)
    ...
    _send_raw_transactions: Method[Callable[..., Any]] = Method(
        namespace + "_sendRawTransactions", mungers=[default_root_munger]
    )

    def send_raw_transactions(self, *args) -> Any:
        return self._send_raw_transactions(*args)
...
class AsyncKlayApi(Module):
    ...
    _is_console_log_enabled: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_isConsoleLogEnabled", mungers=[default_root_munger]
    )

    async def is_console_log_enabled(self, *args) -> Any:
        return await self._is_console_log_enabled(*args)
    ...
    _send_raw_transactions: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_sendRawTransactions", mungers=[default_root_munger]
    )

    async def send_raw_transactions(self, *args) -> Any:
        return await self._send_raw_transactions(*args)
