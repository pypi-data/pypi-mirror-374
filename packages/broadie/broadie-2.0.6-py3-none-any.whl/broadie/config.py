...
class Settings:
    ...
    def __init__(self):
        ...
        # Database
        self.DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./sqlite_dev.db")
        ...
        # Features
        self.PLAYGROUND_ENABLED: bool = os.getenv("PLAYGROUND_ENABLED", "true").lower() == "true"
        self.PLAYGROUND_ORIGINS: list[str] = os.getenv(
            "PLAYGROUND_ORIGINS",
