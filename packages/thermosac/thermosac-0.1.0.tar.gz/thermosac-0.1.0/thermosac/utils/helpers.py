...
def convert(
    ...
    Parameters:
        x (numpy.ndarray): A 1D or 2D NumPy array representing mole or weight fractions of components in the mixture.
        ...
        Mw (numpy.ndarray): A 1D NumPy array representing the molecular weights of the components in the mixture.
                            It should have the shape (n,) where 'n' is the number of components.
    ...
    # Check if all values of x are NaN
    if np.isnan(x).all():
