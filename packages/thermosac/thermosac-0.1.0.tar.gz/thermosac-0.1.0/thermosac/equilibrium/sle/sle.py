...
from ...mixtures import Component, Mixture
...
class SLE:
    def __init__(self,
                 ...
                 mixture: Optional[Mixture] = None) -> None:
...
# =============================================================================
    def set_args(self,
        ...
        high_res = 1 # higher resolution for publication figures
        if args is None:
...
# =============================================================================
    ...
    def _handle_pure_component(
            self, args: NDArray[np.float64]
            ) -> Tuple[NDArray[np.float64],
                       Union[Dict[str, Union[float, str]], None]]:
