...
class HuggingFaceEmbeddings(BaseModel, Embeddings):
    ...
    Setup:
        Install required packages and set environment variable ``HF_TOKEN`` or ``HUGGINGFACE_API_KEY``.
    ...
    Key init args — embedding params:
        model_name: str
            Name of HuggingFace model to use.
    ...
    def validate_environment(self) -> Self:
        ...
        if self.api_key is None:
            raise ValueError(
                "HuggingFace API key not found. Please set HF_TOKEN or HUGGINGFACE_API_KEY environment variable "
