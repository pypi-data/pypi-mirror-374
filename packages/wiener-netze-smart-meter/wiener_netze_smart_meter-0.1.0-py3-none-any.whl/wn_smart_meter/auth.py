...
class LogWienTokenAuth(httpx.Auth):
    ...
    # Buffer time before token expiry to refresh proactively (in seconds)
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            timeout: Timeout for token requests in seconds
        """
    ...
    def _needs_token_refresh(self) -> bool:
        ...
        return (
            ...
            self._token_expires_at < (time.time() + self.TOKEN_REFRESH_BUFFER)
        )
