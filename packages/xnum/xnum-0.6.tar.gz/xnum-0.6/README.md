...
- Run `pip install xnum==0.6`
### Source code
- Download [Version 0.6](https://github.com/openscilab/xnum/archive/v0.6.zip) or [Latest Source](https://github.com/openscilab/xnum/archive/dev.zip)
- Run `pip install .`
