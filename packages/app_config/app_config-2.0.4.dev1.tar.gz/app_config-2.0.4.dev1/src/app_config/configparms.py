...
class ConfigParms:
    ...
    def custom_init_routine(self,) -> None:
        """ This is where code can be insterted to customize the init of
            the class and set custom values that are not being defined in
    ...
    def set_custom_module_vars(self, config) -> None:
        """ set any custiom vars that are not being defined in the
            config.py module
