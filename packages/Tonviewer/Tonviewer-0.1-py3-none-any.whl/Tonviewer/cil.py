...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-a", "--about", type=str, help="Prints description of the coin")
...
async def run_cli():
    ...
    try:
        if args.balance:
            ...
            Scraping().getCoingeckoAbout(args.about)

        elif args.price:
            print(Scraping().get_coingecko_price(args.price))

        elif args.transactions:
            Scraping().get_transactions(args.transactions , args.limit)
