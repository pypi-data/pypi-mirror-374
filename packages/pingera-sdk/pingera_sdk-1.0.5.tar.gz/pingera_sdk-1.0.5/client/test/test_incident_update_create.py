...
class TestIncidentUpdateCreate(unittest.TestCase):
    """IncidentUpdateCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentUpdateCreate:
        """Test IncidentUpdateCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentUpdateCreate`
        """
    ...
    def testIncidentUpdateCreate(self):
        """Test IncidentUpdateCreate"""
