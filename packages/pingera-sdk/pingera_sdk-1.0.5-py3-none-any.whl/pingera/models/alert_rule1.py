...
class AlertRule1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "channel_ids", "channels", "updated_at", "check_name", "enabled", "condition_parameters", "condition", "check_id", "id", "severity", "cooldown_period", "name", "auto_resolve"]
