...
class AiOptimizationChatGptLlmResponsesLiveRequestInfo(BaseModel):
    """
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description="maximum number of tokens in the AI response. optional field. minimum value for reasoning models (e.g., model_name starts with ‘o’): 1024;. minimum value for non-reasoning models: 16;. maximum value for reasoning models: 4096;. maximum value for non-reasoning models: 2048;. default value for both reasoning and non-reasoning models: 2048;. Note: when web_search is set to true, the output token count may exceed the specified max_output_tokens limit")
    temperature: Optional[StrictFloat] = Field(default=None, description="randomness of the AI response. optional field. higher values make output more diverse;. lower values make output more focused;. minimum value: 0. maximum value: 2. default value: 0.94. Note: not supported in reasoning models")
    top_p: Optional[StrictFloat] = Field(default=None, description="diversity of the AI response. optional field. controls diversity of the response by limiting token selection;. minimum value: 0. maximum value: 1. default value: 0.92. Note: not supported in reasoning models")
    web_search: Optional[StrictBool] = Field(default=None, description="enable web search. optional field. when enabled, the AI model can access and cite current web information;. default value: false;. Note: refer to the Models endpoint for a list of models that support web_search;")
    ...
    web_search_country_iso_code: Optional[StrictStr] = Field(default=None, description="ISO country code of the location. optional field. required if web_search_city is specified;. to enable this parameter, web_search must also be enabled;. when enabled, the AI model will search the web from the country you specify;. Note: not supported in o3-mini, o1-pro, o1 models")
    web_search_city: Optional[StrictStr] = Field(default=None, description="city name of the location. optional field. Note: specify web_search_country_iso_code to use this parameter. Note #2: not supported in o3-mini, o1-pro, o1 models")
