...
class SerpApiKnowledgeGraphAiOverviewItemElementItem(BaseSerpApiKnowledgeGraphElementItem):
    """
    ...
    items: Optional[List[Optional[BaseSerpApiAiOverviewElementItem]]] = Field(default=None, description="additional items present in the element. if there are none, equals null")
