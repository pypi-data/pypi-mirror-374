...
class FindResultsOnSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[FindResultsOnElement]]] = Field(default=None, description="contains arrays of specific images")
