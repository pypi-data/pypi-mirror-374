...
class RankedSerpElement(BaseModel):
    ...
    is_lost: Optional[StrictBool] = Field(default=None, description="lost ranked elements. indicates how many ranked elements of this target were previously presented in SERPs, but weren’t found during the last check")
