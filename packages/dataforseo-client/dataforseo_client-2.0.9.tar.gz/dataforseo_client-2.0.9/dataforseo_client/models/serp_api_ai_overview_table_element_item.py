...
class SerpApiAiOverviewTableElementItem(BaseSerpApiAiOverviewElementItem):
    """
    ...
    references: Optional[List[Optional[AiModeAiOverviewReferenceInfo]]] = Field(default=None, description="references relevant to the element")
