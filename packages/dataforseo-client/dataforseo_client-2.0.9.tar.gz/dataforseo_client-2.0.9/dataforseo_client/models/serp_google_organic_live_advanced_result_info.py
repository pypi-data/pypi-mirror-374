...
class SerpGoogleOrganicLiveAdvancedResultInfo(BaseModel):
    ...
    refinement_chips: Optional[RefinementChipsInfo] = Field(default=None, description="search refinement chips")
    ...
    items: Optional[List[Optional[BaseSerpApiElementItem]]] = Field(default=None, description="contains arrays of elements available in the list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
