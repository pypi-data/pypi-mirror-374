...
class SerpApiPeopleAlsoAskAiOverviewExpandedElementItem(BaseSerpApiPeopleAlsoAskExpandedElementItem):
    """
    SerpApiPeopleAlsoAskAiOverviewExpandedElementItem
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    items: Optional[List[Optional[BaseSerpApiAiOverviewElementItem]]] = Field(default=None, description="contains arrays of elements available in the list")
