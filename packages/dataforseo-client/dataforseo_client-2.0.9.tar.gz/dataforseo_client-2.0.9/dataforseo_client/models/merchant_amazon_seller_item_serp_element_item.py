...
class MerchantAmazonSellerItemSerpElementItem(BaseMerchantAmazonSellersElementItem):
    """
    ...
    percentage_discount: Optional[StrictFloat] = Field(default=None, description="value of the percentage discount")
