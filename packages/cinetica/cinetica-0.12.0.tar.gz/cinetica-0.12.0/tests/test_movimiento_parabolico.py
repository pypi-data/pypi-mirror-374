...
def test_base_init_valid_params():
    ...
    assert mp_base.velocidad_inicial_x.magnitude == pytest.approx(10.0 * math.cos(math.radians(45)))
    assert mp_base.velocidad_inicial_y.magnitude == pytest.approx(10.0 * math.sin(math.radians(45)))
