...
@torch.library.custom_op(
    "cuequivariance_ops::fused_tensor_product_bwd",
    mutates_args=(),
    device_types="cuda",
)
def _(
...
@torch.library.custom_op(
    "cuequivariance_ops::fused_tensor_product_bwd_bwd",
    mutates_args=(),
    device_types="cuda",
)
def _(
...
@torch.library.register_fake("cuequivariance_ops::fused_tensor_product_fwd")
def _(
    in0: torch.Tensor,
    in1: torch.Tensor,
    in2: Optional[torch.Tensor],
...
@torch.library.register_fake("cuequivariance_ops::fused_tensor_product_bwd")
def _(
    grad_out: torch.Tensor,
    in0: torch.Tensor,
    in1: torch.Tensor,
...
@torch.library.register_fake("cuequivariance_ops::fused_tensor_product_bwd_bwd")
def _(
    grad_grad_in0: Optional[torch.Tensor],
    grad_grad_in1: Optional[torch.Tensor],
    grad_grad_in2: Optional[torch.Tensor],
...
def fused_tensor_product_fwd(*args):
    return torch.ops.cuequivariance_ops.fused_tensor_product_fwd(*args)
...
def fused_tensor_product_bwd_bwd(ctx, grad_grads):
    ...
    grads = torch.ops.cuequivariance_ops.fused_tensor_product_bwd_bwd(
        grad_grad_in0,
        grad_grad_in1,
        grad_grad_in2,
        grad_out,
...
def fused_tensor_product_bwd(ctx, grad_output):
    ...
    grads = torch.ops.cuequivariance_ops.fused_tensor_product_bwd(
        grad_output,
        in0,
        in1,
        in2,
...
class FusedTensorProductOp4(nn.Module):
    ...
    def _opcheck(self, in0: torch.Tensor, in1: torch.Tensor, in2: torch.Tensor):
        torch.library.opcheck(
            torch.ops.cuequivariance_ops.fused_tensor_product_fwd,
            (
                in0,
                in1,
                in2,
