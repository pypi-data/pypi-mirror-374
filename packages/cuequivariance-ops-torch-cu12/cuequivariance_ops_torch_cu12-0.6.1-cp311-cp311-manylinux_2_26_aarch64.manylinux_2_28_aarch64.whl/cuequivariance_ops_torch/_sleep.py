...
@torch.library.custom_op("cuequivariance_ops::sleep", mutates_args=())
def _(
...
@torch.library.register_fake("cuequivariance_ops::sleep")
def _(
    seconds: torch.Tensor, input_tensor: torch.Tensor
) -> tuple[torch.Tensor, torch.Tensor]:
...
def sleep(
    ...
    return torch.ops.cuequivariance_ops.sleep(seconds, input_tensor)
