...
Refer to the Terraform Registry for docs: [`datadog_csm_threats_agent_rule`](https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule).
'''
...
class CsmThreatsAgentRule(
    ...
    def __init__(
        ...
        *,
        ...
        :param expression: The SECL expression of the Agent rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#expression CsmThreatsAgentRule#expression}
        :param name: The name of the Agent rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#name CsmThreatsAgentRule#name}
        :param actions: actions block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#actions CsmThreatsAgentRule#actions}
        :param description: A description for the Agent rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#description CsmThreatsAgentRule#description}
        :param enabled: Indicates whether the Agent rule is enabled. Must not be used without policy_id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#enabled CsmThreatsAgentRule#enabled}
        :param policy_id: The ID of the agent policy in which the rule is saved. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#policy_id CsmThreatsAgentRule#policy_id}
        :param product_tags: The list of product tags associated with the rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#product_tags CsmThreatsAgentRule#product_tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CsmThreatsAgentRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#import import section} in the documentation of this resource for the id to use
...
class CsmThreatsAgentRuleActions:
    def __init__(
        ...
        *,
        ...
        '''
        :param hash: hash block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#hash CsmThreatsAgentRule#hash}
        :param set: set block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#set CsmThreatsAgentRule#set}
        '''
...
class CsmThreatsAgentRuleActionsOutputReference(
    ...
    def put_set(
        ...
        *,
        ...
        '''
        :param name: The name of the set action. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#name CsmThreatsAgentRule#name}
        :param append: Whether to append to the set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#append CsmThreatsAgentRule#append}
        :param field: The field to get the value from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#field CsmThreatsAgentRule#field}
        :param scope: The scope of the set action (process, container, cgroup, or empty). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#scope CsmThreatsAgentRule#scope}
        :param size: The maximum size of the set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#size CsmThreatsAgentRule#size}
        :param ttl: The time to live for the set in nanoseconds. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#ttl CsmThreatsAgentRule#ttl}
        :param value: The value to set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/csm_threats_agent_rule#value CsmThreatsAgentRule#value}
        '''
