...
def run_inference_with_pretrained(
    ...
    Examples:
        ...
        ...     model_name="autoencoder_pan_cancer", data_path="my_data.h5ad"
        ... )
        >>>
        ...
        >>> results = scxpand.run_inference_with_pretrained(
        ...     model_name="autoencoder_pan_cancer", adata=adata
        ... )
    """
    # Validate inputs
    ...
    if model_name is not None:
        ...
        logger.info(f"Model type: {model_info.model_type.value}")
        ...
        # For URL models, let pipeline auto-detect model type
        model_type = None
        model_info = None
    ...
    # Add model metadata to results (only for registry models)
    if model_info is not None:
        ...
        # For DOI models, add minimal info
        results["model_info"] = {
            "url": model_url,
            "source": "zenodo",
        }
