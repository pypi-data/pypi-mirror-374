...
def run_prediction_pipeline(
    ...
    Returns:
        Dictionary containing evaluation results (if evaluate_metrics=True)
    ...
    y_pred_prob = inference_utils.run_inference(
    ...
    # Evaluate and save results if requested
    results = {"predictions": y_pred_prob}
    if evaluate_metrics:
        ...
        logger.info("Skipping evaluation (evaluate_metrics=False)")
