...
PRETRAINED_MODELS: Dict[str, PretrainedModelInfo] = {
    "pan_cancer_autoencoder": PretrainedModelInfo(
        ...
        url="https://figshare.com/ndownloader/articles/30067666?folder_path=autoencoder&private_link=37d6ff378c1002ee930a",
        version="1.0.0",
    ),
    "pan_cancer_mlp": PretrainedModelInfo(
        name="pan_cancer_mlp",
        url="https://figshare.com/ndownloader/articles/30067666?folder_path=mlp&private_link=37d6ff378c1002ee930a",
        version="1.0.0",
    ),
    "pan_cancer_lightgbm": PretrainedModelInfo(
        name="pan_cancer_lightgbm",
        url="https://figshare.com/ndownloader/articles/30067666?folder_path=lightgbm&private_link=37d6ff378c1002ee930a",
        version="1.0.0",
    ),
    "pan_cancer_logistic": PretrainedModelInfo(
        name="pan_cancer_logistic",
        url="https://figshare.com/ndownloader/articles/30067666?folder_path=logistic&private_link=37d6ff378c1002ee930a",
        version="1.0.0",
    ),
    "pan_cancer_svm": PretrainedModelInfo(
        name="pan_cancer_svm",
        url="https://figshare.com/ndownloader/articles/30067666?folder_path=svm&private_link=37d6ff378c1002ee930a",
        version="1.0.0",
    ),
}
