...
def load_ae_model(
    ...
    try:
        ...
        prm = load_model_parameters(results_path, AutoEncoderParams)
        ...
        model = load_and_validate_model(model, results_path, device, "Autoencoder")
        ...
        raise ModelLoadingError(f"Unexpected error loading Autoencoder model from {results_path}: {e}") from e
