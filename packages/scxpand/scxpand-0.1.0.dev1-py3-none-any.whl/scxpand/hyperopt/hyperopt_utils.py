...
RESULTS_INDICATORS = [
    "last_ckpt.pt",  # Training in progress (checkpoint saved)
    "best_ckpt.pt",  # Training completed at least one epoch
    "model.pt",  # Final model saved
    "summary_info.json",  # Results summary available
    "results_dev.txt",  # Evaluation results
    "results_table_dev.csv",  # Detailed results table
]
