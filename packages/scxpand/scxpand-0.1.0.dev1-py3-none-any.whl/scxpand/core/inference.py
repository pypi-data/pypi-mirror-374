...
def run_inference(
    ...
    Examples:
        ...
        >>> results = scxpand.run_inference(
        ...     data_path="my_data.h5ad", model_name="autoencoder_pan_cancer"
        ... )
        >>>
        ...
        >>> results = scxpand.run_inference(
        ...     adata=adata, model_name="autoencoder_pan_cancer"
        ... )
    """
    # Validate data input
    ...
    if model_path is not None:
        ...
        # Note: eval_row_inds is not supported for pre-trained models yet
        if eval_row_inds is not None:
            logger.warning("eval_row_inds parameter is not supported for pre-trained models. Ignoring.")
