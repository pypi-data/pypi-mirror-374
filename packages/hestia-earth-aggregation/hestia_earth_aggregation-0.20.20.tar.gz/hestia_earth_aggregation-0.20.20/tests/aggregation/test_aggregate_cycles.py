...
from hestia_earth.aggregation.utils.distribution import (
    ITERATIONS, generate_blank_node_distribution, sample_weighted_distributions
)
...
def _fake_sample_indexes(values: list): return [i % len(values) for i in range(ITERATIONS)]
