    ...
    for i, (w, offset) in enumerate(zip(section_width, offsets)):
        ...
        sections.extend(
            [
                ...
                # gf.Section(layer=LAYER.ISO, width=w + 4, offset=offset),
            ]
        )
...
if __name__ == "__main__":
    ...
    # c = gf.components.straight(cross_section=GSG)
    # c = gf.grid([c, gf.import_gds(PATH.home / "Downloads" / "GSG.gds")], spacing=100)
    # c.pprint_ports()
    c = gf.components.straight(cross_section=DC)
    c = gf.grid([c, gf.import_gds(PATH.home / "Downloads" / "DC.gds")], spacing=100)
    c.show()
    # s = c.to_3d()
    # s.show()
