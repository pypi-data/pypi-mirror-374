...
class SeriesApi:
    ...
    def get_series(
        ...
        :param status: Filter by series status
        :type status: str
    ...
    def get_series_with_http_info(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Filter by series status")] = None,
    ...
    def get_series_by_ticker(
        ...
        _param = self._get_series_by_ticker_serialize(
            ticker=ticker,
            _request_auth=None,
            _content_type=None,
            _headers=None,
    ...
    @validate_call
    def get_series_by_ticker_with_http_info(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSeriesByTickerResponse]:
        """Get Series by Ticker
    ...
    @validate_call
    def get_series_by_ticker_without_preload_content(
        self,
        ticker: Annotated[StrictStr, Field(description="The series ticker")],
        _request_timeout: Union[
            None,
    ...
    def _get_series_by_ticker_serialize(
        self,
        ticker,
        _request_auth,
        _content_type,
