...
from kalshi_api_v2_external.api_response import ApiResponse, T as ApiResponseT
import kalshi_api_v2_external.models
from kalshi_api_v2_external import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kalshi_api_v2_external.models, klass)
