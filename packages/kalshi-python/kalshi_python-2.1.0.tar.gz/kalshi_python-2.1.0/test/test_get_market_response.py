...
class TestGetMarketResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMarketResponse:
        """Test GetMarketResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketResponse`
        """
        model = GetMarketResponse()
        if include_optional:
            return GetMarketResponse(
                market = kalshi_api_v2_external.models.market.Market(
                    ticker = '', 
                    series_ticker = '', 
                    event_ticker = '', 
                    title = '', 
