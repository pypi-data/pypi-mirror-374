...
class PortfolioApi:
    ...
    @validate_call
    def get_fills_without_preload_content(
        self,
        ticker: Annotated[Optional[StrictStr], Field(description="Filter by market ticker")] = None,
        order_id: Annotated[Optional[StrictStr], Field(description="Filter by order ID")] = None,
        min_ts: Annotated[Optional[StrictInt], Field(description="Filter items after this Unix timestamp")] = None,
    ...
    def get_positions(
        ...
        :param event_ticker: Filter by event ticker
        :type event_ticker: str
        :param count_down: Filter positions by minimum count down value
        :type count_down: int
        :param count_up: Filter positions by minimum count up value
        :type count_up: int
        :param limit: Number of results per page. Defaults to 100. Maximum value is 200.
        :type limit: int
        :param cursor: Pagination cursor. Use the cursor value returned from the previous response to get the next page of results. Leave empty for the first page.
    ...
    def get_positions_with_http_info(
        ...
        ticker: Annotated[Optional[StrictStr], Field(description="Filter by market ticker")] = None,
        event_ticker: Annotated[Optional[StrictStr], Field(description="Filter by event ticker")] = None,
        count_down: Annotated[Optional[StrictInt], Field(description="Filter positions by minimum count down value")] = None,
        count_up: Annotated[Optional[StrictInt], Field(description="Filter positions by minimum count up value")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results per page. Defaults to 100. Maximum value is 200.")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor. Use the cursor value returned from the previous response to get the next page of results. Leave empty for the first page.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_positions_serialize(
        ...
        if count_down is not None:
            ...
            _query_params.append(('count_down', count_down))
            
        if count_up is not None:
            
            _query_params.append(('count_up', count_up))
    ...
    def get_queue_positions(
        ...
        **kwargs: Any,
        ...
        :param get_queue_positions_request:  (required)
        :type get_queue_positions_request: GetQueuePositionsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        # Create request object from kwargs
        get_queue_positions_request = GetQueuePositionsRequest(**kwargs) if kwargs else None

        _param = self._get_queue_positions_serialize(
            get_queue_positions_request=get_queue_positions_request,
            _request_auth=kwargs.get('_request_auth'),
            _content_type=kwargs.get('_content_type'),
            _headers=kwargs.get('_headers'),
            _host_index=kwargs.get('_host_index', 0)
    ...
    @validate_call
    def get_queue_positions_with_http_info(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetQueuePositionsResponse]:
        """Get Queue Positions
    ...
    @validate_call
    def get_queue_positions_without_preload_content(
        self,
        get_queue_positions_request: GetQueuePositionsRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_queue_positions_serialize(
        self,
        get_queue_positions_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_queue_positions_request is not None:
            _body_params = get_queue_positions_request
    ...
    def get_total_resting_order_value(
        ...
        _param = self._get_total_resting_order_value_serialize(
            _request_auth=None,
            _content_type=None,
            _headers=None,
            _host_index=0
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTotalRestingOrderValueResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_total_resting_order_value_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTotalRestingOrderValueResponse]:
        """Get Total Resting Order Value
    ...
    @validate_call
    def get_total_resting_order_value_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_total_resting_order_value_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
