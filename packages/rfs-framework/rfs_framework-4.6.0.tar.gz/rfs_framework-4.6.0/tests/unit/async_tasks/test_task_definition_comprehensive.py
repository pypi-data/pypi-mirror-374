...
class TestTaskRegistry:
    ...
    def test_list_scheduled(self):
        ...
        task1 = TaskDefinition("cron_task", TaskType.SCHEDULED, handler1, schedule_cron="0 0 * * *")
        task2 = TaskDefinition("interval_task", TaskType.SCHEDULED, handler2, schedule_interval=timedelta(hours=1))
        task3 = TaskDefinition("at_task", TaskType.SCHEDULED, handler3, schedule_at=datetime.now() + timedelta(hours=1))
