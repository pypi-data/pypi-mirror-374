...
class TestSQLAlchemyModel:
    ...
    @pytest.mark.skipif(not pytest.importorskip("sqlalchemy", reason="SQLAlchemy not installed"), 
...
class TestTortoiseModel:
    ...
    @pytest.mark.skipif(not pytest.importorskip("tortoise", reason="Tortoise ORM not installed"),
