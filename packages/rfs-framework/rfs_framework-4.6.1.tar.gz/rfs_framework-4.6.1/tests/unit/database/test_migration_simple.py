...
class TestMigrationWorkflow:
    ...
    async def test_run_migrations_workflow(self):
        ...
        with patch.object(manager, 'discover_migrations', return_value=Success([migration1, migration2])):
    ...
    async def test_migration_failure_handling(self):
        ...
        with patch.object(manager, 'discover_migrations', return_value=Success([failing_migration])):
            result = await manager.run_migrations()
