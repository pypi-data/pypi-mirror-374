...
class TestAnnotationType:
    ...
    def test_all_annotation_types(self):
        ...
        expected_types = [
            "component", "port", "adapter", "use_case", 
            "controller", "service", "repository", "value", "config"
        ]
...
class TestHexagonalArchitectureValidation:
    ...
    def test_validate_valid_architecture(self):
        ...
        # 검증
        errors = validate_hexagonal_architecture([UserPort, UserAdapter, CreateUserUseCase])
        assert len(errors) == 0
