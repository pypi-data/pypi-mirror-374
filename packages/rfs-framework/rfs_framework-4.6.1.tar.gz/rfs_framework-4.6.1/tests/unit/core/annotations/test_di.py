...
from rfs.core.annotations.di import (
    Component, Port, Adapter, UseCase, Controller,
    Service, Repository, Injectable, Autowired,
    Qualifier, Scope, Primary, Lazy, Value, ConfigProperty
)
...
class TestUseCaseDecorator:
    ...
    def test_use_case_with_dependencies(self):
        ...
        @UseCase(name="transfer_money", dependencies=["account_port", "transaction_port"])
...
class TestControllerDecorator:
    ...
    def test_controller_with_use_cases(self):
        ...
        @Controller(name="order_controller", dependencies=["create_order", "cancel_order"])
