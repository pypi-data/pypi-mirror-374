...
class ConnectCasesClient(AioBaseClient):
    ...
    async def batch_get_case_rule(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#batch_get_case_rule)
        """
    ...
    async def create_case_rule(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#create_case_rule)
        """
    ...
    async def delete_case(self, **kwargs: Unpack[DeleteCaseRequestTypeDef]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#delete_case)
        """
    ...
    async def delete_case_rule(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#delete_case_rule)
        """
    ...
    async def delete_related_item(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#delete_related_item)
        """
    ...
    async def get_layout(
        self, **kwargs: Unpack[GetLayoutRequestTypeDef]
    ) -> GetLayoutResponseTypeDef:
        """
    ...
    async def list_case_rules(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#list_case_rules)
        """
    ...
    async def list_fields(
        self, **kwargs: Unpack[ListFieldsRequestTypeDef]
    ) -> ListFieldsResponseTypeDef:
        """
    ...
    async def update_case_rule(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcases/client/#update_case_rule)
        """
