__all__ = ("user_agent_base", "is_valid_ip", "is_valid_host", "is_has_ipv6")
...
user_agent_base = (
	"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gec"
	"ko) Chrome/129.0.0.0 Mobile Safari/537.36"
)
...
def is_has_ipv6(error = True):
	...
	try:
		...
		if error and not e.errno in (_EAFNOSUPPORT, _EADDRNOTAVAIL):
			raise
		return False
