...
from maleo.database.managers import RedisDatabaseManager
...
from maleo.utils.cache import build_key
...
class GoogleCloudStorage(GoogleClientManager):
    def __init__(
        ...
        *,
        ...
        self._redis = redis
        self._namespace = self._redis._config.additional.namespaces.create(
