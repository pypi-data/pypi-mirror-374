...
document.querySelector("#portMgmtValueType").addEventListener('change', event => {
    let valueType = event.target.value;

    if (valueType.includes('Boolean')) {
        document.querySelector("#portMgmtKeyValueInput").classList.add('hideFromUser');
        document.querySelector("#portMgmtDefaultKeyValueInput").classList.add('hideFromUser');
    } else {
        document.querySelector("#portMgmtKeyValueInput").classList.remove('hideFromUser');
        document.querySelector("#portMgmtDefaultKeyValueInput").classList.remove('hideFromUser');
    }
})
