    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                if result:
                    SystemLogsAssistant().log(user=user, webPage=Vars.labInventory, action='PortConnectionGetRemoveKeys', msgType='Info',
    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='PortMgmtAddFieldOptions', msgType='Info',
    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='PortMgmtRemoveFieldOptions', msgType='Info',
