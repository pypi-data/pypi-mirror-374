                        ...
                        if len(additionalFields) > 0:
                            for field in additionalFields.keys():
                                ...
                                if additionalFields[field]['type'] == 'boolean':
                                    if field in device['inventoryAdditionalKeyValues'] and device['inventoryAdditionalKeyValues'][field]['value'] is True:
...
class GetDeviceVendorDropdownForEditing(APIView):
    #@verifyUserRole(webPage=Vars.webpage, action='GetDeviceVendorDropdownForEditing', exclude=['engineer'])
    def post(self, request):
        """
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                if isPortDeviceExists:
                    SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='AddDevice', msgType='Info',
    ...
    def get(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='ExportCSV', msgType='Info',
    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='RemoveKeys', msgType='Info',
    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='AddFieldOptions', msgType='Info',
    ...
    def post(self, request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            try:
                ...
                SystemLogsAssistant().log(user=user, webPage=Vars.webpage, action='RemoveFieldOptions', msgType='Info',
