...
class FontStyle:
    ...
    bold: builtins.bool
    color: builtins.int
    def __new__(cls, size:typing.Optional[builtins.int], bold:typing.Optional[builtins.bool], color:typing.Optional[builtins.int]) -> FontStyle: ...
    def __repr__(self) -> builtins.str: ...
    def __str__(self) -> builtins.str: ...
...
class TextPosition:
    ...
    @classmethod
    def top(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def top_right(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def right(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def bottom_right(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def bottom(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def bottom_left(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def left(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def top_left(cls, _cls:type) -> TextPosition: ...
    @classmethod
    def inside(cls, _cls:type) -> TextPosition: ...
    def __repr__(self) -> builtins.str: ...
    def __str__(self) -> builtins.str: ...
...
class UIElement:
    ...
    def process_id(self) -> builtins.int:
        ...
        Returns:
            int: The process ID.
        """
    def highlight(self, color:typing.Optional[builtins.int]=None, duration_ms:typing.Optional[builtins.int]=None, text:typing.Optional[builtins.str]=None, text_position:typing.Optional[TextPosition]=None, font_style:typing.Optional[FontStyle]=None) -> HighlightHandle:
        r"""
    ...
    def set_toggled(self, state:builtins.bool) -> None:
        ...
        Returns:
            None
        """
    def execute_browser_script(self, script:builtins.str) -> typing.Any:
        r"""
