cdef extern from "math.h":
    double cos(double t) noexcept nogil
    double sin(double t) noexcept nogil
    double atan(double t) noexcept nogil

cdef inline double deg2rad(double thetadeg) noexcept nogil: # pragma: no cover
