...
def test_linked_ds_iteration(local_auth_ds):
    with local_auth_ds as ds:
        ds.create_tensor(
            "abc", htype="link[image]", sample_compression="jpg", dtype="uint8", create_shape_tensor=False, create_sample_info_tensor=False, verify=False
        )
    ...
    for item in dl:
        ...
        except deeplake.util.exceptions.SampleReadError:
            pass
