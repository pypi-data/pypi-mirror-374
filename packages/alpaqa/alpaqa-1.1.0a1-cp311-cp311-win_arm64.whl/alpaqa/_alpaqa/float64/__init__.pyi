...
__all__: list[str] = ['ALMParams', 'ALMSolver', 'AndersonAccel', 'AndersonDirection', 'Box', 'BoxConstrProblem', 'CUTEstProblem', 'CasADiProblem', 'ConvexNewtonDirection', 'DLProblem', 'FISTAParams', 'FISTAProgressInfo', 'FISTASolver', 'InnerSolveOptions', 'InnerSolver', 'IpoptApplicationReturnStatus', 'IpoptSolver', 'IpoptSolverReturn', 'KKTError', 'LBFGS', 'LBFGSBParams', 'LBFGSBProgressInfo', 'LBFGSBSolver', 'LBFGSDirection', 'LipschitzEstimateParams', 'NewtonTRDirection', 'NewtonTRDirectionParams', 'NoopDirection', 'PANOCDirection', 'PANOCParams', 'PANOCProgressInfo', 'PANOCSolver', 'PANTRDirection', 'PANTRParams', 'PANTRProgressInfo', 'PANTRSolver', 'Problem', 'ProblemWithCounters', 'SteihaugCGParams', 'StructuredLBFGSDirection', 'StructuredNewtonDirection', 'UnconstrProblem', 'ZeroFPRParams', 'ZeroFPRProgressInfo', 'ZeroFPRSolver', 'deserialize_casadi_problem', 'functions', 'kkt_error', 'load_casadi_problem', 'problem_with_counters', 'provided_functions', 'prox', 'prox_step']
...
class InnerSolver:
    ...
    def __init__(self, inner_solver: FISTASolver) -> None:
        ...
        """
    @typing.overload
    def __init__(self, inner_solver: LBFGSBSolver) -> None:
        """
        Explicit conversion.
        """
    @typing.overload
    ...
    def params(self) -> typing.Any:
        ...
class IpoptApplicationReturnStatus:
    """
    ...
    Members:
      ...
      Internal_Error
    """
    Diverging_Iterates: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Diverging_Iterates: 4>
    Error_In_Step_Computation: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Error_In_Step_Computation: -3>
    Feasible_Point_Found: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Feasible_Point_Found: 6>
    Infeasible_Problem_Detected: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Infeasible_Problem_Detected: 2>
    Insufficient_Memory: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Insufficient_Memory: -102>
    Internal_Error: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Internal_Error: -199>
    Invalid_Number_Detected: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Invalid_Number_Detected: -13>
    Invalid_Option: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Invalid_Option: -12>
    Invalid_Problem_Definition: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Invalid_Problem_Definition: -11>
    Maximum_CpuTime_Exceeded: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Maximum_CpuTime_Exceeded: -4>
    Maximum_Iterations_Exceeded: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Maximum_Iterations_Exceeded: -1>
    Maximum_WallTime_Exceeded: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Maximum_WallTime_Exceeded: -5>
    NonIpopt_Exception_Thrown: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.NonIpopt_Exception_Thrown: -101>
    Not_Enough_Degrees_Of_Freedom: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Not_Enough_Degrees_Of_Freedom: -10>
    Restoration_Failed: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Restoration_Failed: -2>
    Search_Direction_Becomes_Too_Small: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Search_Direction_Becomes_Too_Small: 3>
    Solve_Succeeded: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Solve_Succeeded: 0>
    Solved_To_Acceptable_Level: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Solved_To_Acceptable_Level: 1>
    Unrecoverable_Exception: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.Unrecoverable_Exception: -100>
    User_Requested_Stop: typing.ClassVar[IpoptApplicationReturnStatus]  # value = <IpoptApplicationReturnStatus.User_Requested_Stop: 5>
    __members__: typing.ClassVar[dict[str, IpoptApplicationReturnStatus]]  # value = {'Solve_Succeeded': <IpoptApplicationReturnStatus.Solve_Succeeded: 0>, 'Solved_To_Acceptable_Level': <IpoptApplicationReturnStatus.Solved_To_Acceptable_Level: 1>, 'Infeasible_Problem_Detected': <IpoptApplicationReturnStatus.Infeasible_Problem_Detected: 2>, 'Search_Direction_Becomes_Too_Small': <IpoptApplicationReturnStatus.Search_Direction_Becomes_Too_Small: 3>, 'Diverging_Iterates': <IpoptApplicationReturnStatus.Diverging_Iterates: 4>, 'User_Requested_Stop': <IpoptApplicationReturnStatus.User_Requested_Stop: 5>, 'Feasible_Point_Found': <IpoptApplicationReturnStatus.Feasible_Point_Found: 6>, 'Maximum_Iterations_Exceeded': <IpoptApplicationReturnStatus.Maximum_Iterations_Exceeded: -1>, 'Restoration_Failed': <IpoptApplicationReturnStatus.Restoration_Failed: -2>, 'Error_In_Step_Computation': <IpoptApplicationReturnStatus.Error_In_Step_Computation: -3>, 'Maximum_CpuTime_Exceeded': <IpoptApplicationReturnStatus.Maximum_CpuTime_Exceeded: -4>, 'Maximum_WallTime_Exceeded': <IpoptApplicationReturnStatus.Maximum_WallTime_Exceeded: -5>, 'Not_Enough_Degrees_Of_Freedom': <IpoptApplicationReturnStatus.Not_Enough_Degrees_Of_Freedom: -10>, 'Invalid_Problem_Definition': <IpoptApplicationReturnStatus.Invalid_Problem_Definition: -11>, 'Invalid_Option': <IpoptApplicationReturnStatus.Invalid_Option: -12>, 'Invalid_Number_Detected': <IpoptApplicationReturnStatus.Invalid_Number_Detected: -13>, 'Unrecoverable_Exception': <IpoptApplicationReturnStatus.Unrecoverable_Exception: -100>, 'NonIpopt_Exception_Thrown': <IpoptApplicationReturnStatus.NonIpopt_Exception_Thrown: -101>, 'Insufficient_Memory': <IpoptApplicationReturnStatus.Insufficient_Memory: -102>, 'Internal_Error': <IpoptApplicationReturnStatus.Internal_Error: -199>}
...
class IpoptSolver:
    ...
    """
    def __call__(self, problem: Problem, x: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, y: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, w: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None) -> tuple:
        ...
    def __init__(self, options: dict = {}) -> None:
        ...
class IpoptSolverReturn:
    """
    ...
    Members:
      ...
      UNASSIGNED
    """
    CPUTIME_EXCEEDED: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.CPUTIME_EXCEEDED: 2>
    DIVERGING_ITERATES: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.DIVERGING_ITERATES: 9>
    ERROR_IN_STEP_COMPUTATION: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.ERROR_IN_STEP_COMPUTATION: 11>
    FEASIBLE_POINT_FOUND: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.FEASIBLE_POINT_FOUND: 8>
    INTERNAL_ERROR: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.INTERNAL_ERROR: 16>
    INVALID_NUMBER_DETECTED: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.INVALID_NUMBER_DETECTED: 12>
    INVALID_OPTION: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.INVALID_OPTION: 14>
    LOCAL_INFEASIBILITY: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.LOCAL_INFEASIBILITY: 6>
    MAXITER_EXCEEDED: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.MAXITER_EXCEEDED: 1>
    OUT_OF_MEMORY: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.OUT_OF_MEMORY: 15>
    RESTORATION_FAILURE: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.RESTORATION_FAILURE: 10>
    STOP_AT_ACCEPTABLE_POINT: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.STOP_AT_ACCEPTABLE_POINT: 5>
    STOP_AT_TINY_STEP: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.STOP_AT_TINY_STEP: 4>
    SUCCESS: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.SUCCESS: 0>
    TOO_FEW_DEGREES_OF_FREEDOM: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.TOO_FEW_DEGREES_OF_FREEDOM: 13>
    UNASSIGNED: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.UNASSIGNED: 17>
    USER_REQUESTED_STOP: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.USER_REQUESTED_STOP: 7>
    WALLTIME_EXCEEDED: typing.ClassVar[IpoptSolverReturn]  # value = <IpoptSolverReturn.WALLTIME_EXCEEDED: 3>
    __members__: typing.ClassVar[dict[str, IpoptSolverReturn]]  # value = {'SUCCESS': <IpoptSolverReturn.SUCCESS: 0>, 'MAXITER_EXCEEDED': <IpoptSolverReturn.MAXITER_EXCEEDED: 1>, 'CPUTIME_EXCEEDED': <IpoptSolverReturn.CPUTIME_EXCEEDED: 2>, 'WALLTIME_EXCEEDED': <IpoptSolverReturn.WALLTIME_EXCEEDED: 3>, 'STOP_AT_TINY_STEP': <IpoptSolverReturn.STOP_AT_TINY_STEP: 4>, 'STOP_AT_ACCEPTABLE_POINT': <IpoptSolverReturn.STOP_AT_ACCEPTABLE_POINT: 5>, 'LOCAL_INFEASIBILITY': <IpoptSolverReturn.LOCAL_INFEASIBILITY: 6>, 'USER_REQUESTED_STOP': <IpoptSolverReturn.USER_REQUESTED_STOP: 7>, 'FEASIBLE_POINT_FOUND': <IpoptSolverReturn.FEASIBLE_POINT_FOUND: 8>, 'DIVERGING_ITERATES': <IpoptSolverReturn.DIVERGING_ITERATES: 9>, 'RESTORATION_FAILURE': <IpoptSolverReturn.RESTORATION_FAILURE: 10>, 'ERROR_IN_STEP_COMPUTATION': <IpoptSolverReturn.ERROR_IN_STEP_COMPUTATION: 11>, 'INVALID_NUMBER_DETECTED': <IpoptSolverReturn.INVALID_NUMBER_DETECTED: 12>, 'TOO_FEW_DEGREES_OF_FREEDOM': <IpoptSolverReturn.TOO_FEW_DEGREES_OF_FREEDOM: 13>, 'INVALID_OPTION': <IpoptSolverReturn.INVALID_OPTION: 14>, 'OUT_OF_MEMORY': <IpoptSolverReturn.OUT_OF_MEMORY: 15>, 'INTERNAL_ERROR': <IpoptSolverReturn.INTERNAL_ERROR: 16>, 'UNASSIGNED': <IpoptSolverReturn.UNASSIGNED: 17>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class LBFGSBProgressInfo:
    ...
    def τ(self) -> float:
        """
        Line search parameter :math:`\\tau` (or :math:`\\tau_\\mathrm{rel}`)
        """
    @property
    def τ_max(self) -> float:
        """
        Maximum line search parameter :math:`\\tau_\\mathrm{max}`
        """
    @property
    def ψ(self) -> float:
        """
...
class LBFGSBSolver:
    """
    C++ documentation: :cpp:class:`alpaqa::LBFGSBSolver`
    """
    Params = LBFGSBParams
    def __call__(self, problem: Problem, opts: InnerSolveOptions = {}, x: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, y: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, Σ: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, *, asynchronous: bool = True, suppress_interrupt: bool = False) -> tuple:
        """
        ...
        :return: * Solution :math:`x`
                 ...
                 * Statistics
        """
    def __copy__(self) -> LBFGSBSolver:
        ...
    def __deepcopy__(self, memo: dict) -> LBFGSBSolver:
        ...
    @typing.overload
    def __init__(self, other: LBFGSBSolver) -> None:
        """
        Create a copy
        """
    @typing.overload
    def __init__(self, lbfgsb_params: LBFGSBParams | dict = {}) -> None:
        """
        Create a LBFGSB solver using structured L-BFGS directions.
        """
    def __str__(self) -> str:
        ...
    def set_progress_callback(self, callback: typing.Callable[[LBFGSBProgressInfo], None]) -> LBFGSBSolver:
        """
        Specify a callable that is invoked with some intermediate results on each iteration of the algorithm.
        """
    def stop(self) -> None:
