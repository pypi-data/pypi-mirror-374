#!/usr/bin/env python3
"""
Basic test suite for holographic-memory
=====================================
...
class TestBasicFunctionality:
    ...
    def test_module_import(self):
        ...
        assert holographic_memory.__version__
        assert hasattr(holographic_memory, '__all__')
        
    def test_module_components(self):
        """Test that main components are available"""
        # Check that main classes/functions are available
        for component in holographic_memory.__all__:
            assert hasattr(holographic_memory, component), f"Missing component: {component}"
    ...
    def test_attribution_display(self):
        ...
        import importlib
        importlib.reload(holographic_memory)
...
class TestModuleSpecific:
    ...
    def test_main_class_instantiation(self):
        ...
        try:
            ...
            main_classes = [getattr(holographic_memory, name) for name in holographic_memory.__all__ 
                           if hasattr(getattr(holographic_memory, name), '__init__')]
    ...
    def test_version_format(self):
        ...
        version = holographic_memory.__version__
