# Auto-generated stubs for PyOpenColorIO
# Generated with generate_stubs.py
...
class Exception(_BuiltinException): ...
...
class LogCameraTransform(Transform):
    def __init__(self, linSideBreak, base: float = ..., logSideSlope=..., logSideOffset=..., linSideSlope=..., linSideOffset=..., linearSlope: list[float] = ..., direction: TransformDirection = ...) -> None: ...
