...
class PredictSystem:
    def __init__(
            self,
            det_model_name: TextLineModels | DetModels | RecModels | TableModels | ImageModels = "PP-OCRv5_mobile_det_infer.onnx",
            cls_model_name: TextLineModels | DetModels | RecModels | TableModels | ImageModels = "PP-LCNet_x0_25_text_line_ori_infer.onnx",
            rec_model_name: TextLineModels | DetModels | RecModels | TableModels | ImageModels = "PP-OCRv5_mobile_rec_infer.onnx",
            doc_cls_model_name: TextLineModels | DetModels | RecModels | TableModels | ImageModels = "PP-LCNet_x1_0_doc_ori.onnx",
            uvdoc_model_name: TextLineModels | DetModels | RecModels | TableModels | ImageModels = "UVDoc.onnx",
    ...
    async def predict(
        ...
        if det_result["num_boxes"] == 0:
            return OCRResults(image=numpy_image)
    ...
    ) -> AsyncGenerator[OCRResults, None]:
        """
        批量处理多张图像
        :param images: 图像列表
