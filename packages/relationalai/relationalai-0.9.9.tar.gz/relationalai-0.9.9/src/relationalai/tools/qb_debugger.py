...
def span_code(span:SpanNode):
    if span.type == "rule":
        ...
        if toggles["lqp"]:
            code_with_header("lqp model", span.end_attrs.get("lqp_debug", ';; No LQP was emitted.'), language="lqp")
        if toggles["sql"]:
        ...
        if toggles["lqp"]:
            code_with_header("lqp query", span.end_attrs.get("lqp_debug", ';; No LQP was emitted.'), language="lqp")
        if toggles["sql"]:
