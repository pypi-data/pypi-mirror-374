...
class RTGeneric:
    ...
    def generic_lit_values(cls, l: LiteralGenericAlias) -> tuple:  # type: ignore[valid-type]
       ...
       """
        ...
        if l != None and "__args__" in l.__dict__:  # type: ignore[attr-defined,operator]
    ...
    def generic_false(cls, l: LiteralGenericAlias) -> bool:  # type: ignore[valid-type]
        ...
        result = False
        for v in values:
            result |= v in set([False, "False", "F", "false", "f", "No", "N", "no", "n", 0, None])
        return result
    ...
    def generic_true(cls, l: LiteralGenericAlias) -> bool:  # type: ignore[valid-type]
        ...
        result = True
        for v in values:
            result &= v in set([True, "true", "t", "True", "T", "yes", "y", "Yes", "Y", 1])
        return result
