...
if (3, 10) > version_info:
    ...
    class E_Cls2(  # type: ignore[no-redef]
        E_Cls1[int, TrueT, tuple[tuple[T, ...], list[dict[str, T]]]],  # type: ignore[misc]
        RTGeneric,
    ):
        def __init__(self):
            # print(f"initialize E_Cls2")
        ...
        if (3, 10) > version_info:
            ...
            self.assertEqual(
                ...
                (
                    ...
                    TrueT,
                    # mypy is not handling if/else on version here
                    tuple[tuple[float, ...], list[dict[str, float]]],  # type: ignore[misc]
                ),
            )
            self.assertEqual(
                c5.fn1(),
                # mypy is not handling if/else on version here
                (int, TrueT, tuple[tuple[float, ...], list[dict[str, float]]]),  # type: ignore[misc]
            )
        c5.fn2()
