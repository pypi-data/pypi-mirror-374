...
class TestKnowledgeKnowledgeEntity(unittest.TestCase):
    """KnowledgeKnowledgeEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KnowledgeKnowledgeEntity:
        """Test KnowledgeKnowledgeEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KnowledgeKnowledgeEntity`
        """
        model = KnowledgeKnowledgeEntity()
        if include_optional:
            return KnowledgeKnowledgeEntity(
                client_id = 'cli_...',
                data = None,
    ...
    def testKnowledgeKnowledgeEntity(self):
        """Test KnowledgeKnowledgeEntity"""
