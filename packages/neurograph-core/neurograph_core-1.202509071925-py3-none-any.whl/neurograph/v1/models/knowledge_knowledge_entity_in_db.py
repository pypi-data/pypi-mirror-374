...
class KnowledgeKnowledgeEntityInDb(BaseModel):
    """
    KnowledgeKnowledgeEntityInDb
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="nullable.")
    data: Optional[Dict[str, Any]] = None
    ext: Optional[KnowledgeKnowledgeEntityExtra] = None
    extra: Optional[Dict[str, Any]] = None
    id: Optional[StrictStr] = None
    kind: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    relations: Optional[KnowledgeKnowledgeEntityRelations] = None
    var_schema: Optional[KnowledgeKnowledgeEntitySchema] = Field(default=None, alias="schema")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KnowledgeKnowledgeEntityInDb from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KnowledgeKnowledgeEntityInDb from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "ext": KnowledgeKnowledgeEntityExtra.from_dict(obj["ext"]) if obj.get("ext") is not None else None,
            "extra": obj.get("extra"),
            "id": obj.get("id"),
            "kind": obj.get("kind"),
            "name": obj.get("name"),
            "relations": KnowledgeKnowledgeEntityRelations.from_dict(obj["relations"]) if obj.get("relations") is not None else None,
            "schema": KnowledgeKnowledgeEntitySchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
