...
from cogents.core.base.llm.base import BaseLLMClient
from cogents.core.base.logging import get_logger
from cogents.core.base.tracing import configure_opik, estimate_token_usage, get_token_tracker, is_opik_enabled
            ...
            if stream:
                ...
                try:
                    if hasattr(response, "usage") and response.usage:
                        ...
                        from cogents.core.base.tracing import TokenUsage
