...
from core.utils.data.distributed import DistributedSampler
...
class ElasticDistributedSampler(DistributedSampler):
    ...
    :class:`core.nn.parallel.DistributedDataParallel`. In such case, each
    ...
    def __iter__(self):
        ...
        indices = (
            core.randperm(len(self.dataset) - self.start_index, generator=g)  # type: ignore[arg-type]
