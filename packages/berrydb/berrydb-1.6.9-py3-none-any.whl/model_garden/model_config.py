...
class ModelConfig:
    ...
    class VertexAIModelConfigBuilder:
        def __init__(self):
            ...
            self.__subcategory:str|None = None
        ...
        def category(self, category:str|None) -> "ModelConfig.VertexAIModelConfigBuilder":
            self.__category = category
            return self

        def subcategory(self, subcategory:str|None) -> "ModelConfig.VertexAIModelConfigBuilder":
            self.__subcategory = subcategory
            return self
    ...
    class BerryDBModelConfigBuilder:
        ...
        def category(self, category:str|None) -> "ModelConfig.BerryDBModelConfigBuilder":
            self.__category = category
            return self

        def subcategory(self, subcategory:str|None) -> "ModelConfig.BerryDBModelConfigBuilder":
            self.__subcategory = subcategory
            return self
