...
class SimpleLinksClient:
    ...
    def __init__(self, host: str, port: int, server_secret: str, subnet: str = "default",
                 auto_reconnect: bool = True, internal_routing: bool = True):
        self.host = host
        self.port = port
...
def join(host: str, secret: str, subnet: str = "default", port: int = 20001,
         auto_reconnect: bool = True, internal_routing: bool = True) -> None:
    """
    ...
    Args:
        ...
        internal_routing: Enable internal network routing optimization (default: True, v2.0)
    """
