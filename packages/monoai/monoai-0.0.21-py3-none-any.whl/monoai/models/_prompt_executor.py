...
class PromptExecutorMixin:
    ...
    def _execute(self, prompt: Union[str, Prompt, PromptChain], metadata: Dict = None) -> Dict:
        """
    ...
    def _completion(self, prompt: str|list, response_type: str = None, metadata: Dict = None) -> Dict:
