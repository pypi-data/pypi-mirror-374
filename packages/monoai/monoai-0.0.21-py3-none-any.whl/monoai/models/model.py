...
class Model(BaseModel, ResponseProcessorMixin, PromptExecutorMixin):
    ...
    async def _ask_async(self, prompt: Union[str, Prompt, PromptChain], metadata: Dict = None) -> Dict:
        """
    ...
    async def ask_stream(self, prompt: Union[str, Prompt, PromptChain], metadata: Dict = None) -> AsyncGenerator[Dict, None]:
        """
