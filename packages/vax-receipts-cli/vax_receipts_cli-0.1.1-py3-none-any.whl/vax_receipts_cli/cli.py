...
RECEIPTS = [
    # add your new posts when live (or keep placeholders until then)
    {"key":"anti-suit","title":"Anti-Influence Suit — Armor for the Feed","url":"https://vibeaxis.com/anti-influence-suit/"},
    {"key":"rage-olympics","title":"Rage-Click Olympics — UI Fails vs Your Sanity","url":"https://vibeaxis.com/rage-click-olympics/"},
    # existing anchors
