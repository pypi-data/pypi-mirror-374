...
class EPUBValidator:
    ...
    def _check_container(self, zip_ref: zipfile.ZipFile, container_path: str) -> Optional[str]:
    ...
    def _get_opf_path(self, zip_ref: zipfile.ZipFile, container_path: str) -> Optional[str]:
