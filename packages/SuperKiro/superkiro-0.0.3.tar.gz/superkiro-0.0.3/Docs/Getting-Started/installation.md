...
#sk_brainstorm "test project"     # Should trigger discovery questions
#sk_analyze README.md              # Should provide structured analysis
...
**Ready to start?** Try `#sk_brainstorm` in Kiro for your first experience!
