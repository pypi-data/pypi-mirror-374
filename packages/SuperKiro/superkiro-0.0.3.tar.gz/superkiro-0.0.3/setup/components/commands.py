...
class CommandsComponent(Component):
    ...
    def _get_source_dir(self) -> Path:
        ...
        # Locate command templates in repo (prefer SuperKiro, fallback to SuperClaude)
        project_root = Path(__file__).parent.parent.parent
        sk = project_root / "SuperKiro" / "Commands"
        if sk.exists():
            return sk
        ...
        try:
            ...
            if commands_to_migrate:
                ...
                if migrated_count > 0:
                    ...
                    self.logger.info("Commands are now available as #sk_analyze, #sk_build, etc.")
