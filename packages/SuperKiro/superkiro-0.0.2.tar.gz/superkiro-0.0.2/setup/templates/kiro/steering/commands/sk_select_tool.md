...
# #sk_select_tool - Intelligent MCP Tool Selection
...
## Usage
```
#sk_select_tool [operation] [--analyze] [--explain]
```
...
```
#sk_select_tool "rename function across 10 files" --analyze
...
```
#sk_select_tool "update console.log to logger.info across project" --explain
...
```
#sk_select_tool "save project context and discoveries"
