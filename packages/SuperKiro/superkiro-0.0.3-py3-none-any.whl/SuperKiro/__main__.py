...
def get_operation_modules() -> Dict[str, str]:
    ...
    return {
        "install": "Initialize .kiro/steering (alias of kiro-init)",
        "update": "Update existing SuperKiro installation",
        "uninstall": "Remove SuperKiro installation",
        "backup": "Backup and restore operations",
        "kiro-init": "Initialize .kiro/steering templates in a directory"
    }
...
def main() -> int:
    ...
    try:
        ...
        # Alias: make 'install' behave like 'kiro-init'
        try:
            from setup.cli.commands import kiro_init as _kiro_init
            operations['install'] = _kiro_init.run
        except Exception:
            pass
