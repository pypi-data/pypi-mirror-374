...
# Add StarCoder2_3B to path for offline functionality
STARCODER_PATH = Path(__file__).parent.parent.parent.parent / "StarCoder2_3B"
sys.path.insert(0, str(STARCODER_PATH))
...
def generate(file_path, positive, negative, framework, language, output, timeout):
    ...
    try:
        ...
        models_dir = str(STARCODER_PATH / "models")
