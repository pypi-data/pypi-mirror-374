                    ...
                    for field_name, value in validated_data.items():
                        ...
                        if hasattr(model_class, field_name):
                            ...
                            if hasattr(field, "related_model") and field.related_model:
                                ...
                                original_serializer_field = serializer.fields.get(
                                    field_name
                                )
                                is_slug_related = (
                                    original_serializer_field
                                    and hasattr(original_serializer_field, "__class__")
                                    and "SlugRelatedField"
                                    in original_serializer_field.__class__.__name__
                                )
                                print(
                                    f"BulkOperationsMixin._handle_array_upsert_direct() - DEBUG: Field '{field_name}' was originally SlugRelatedField: {is_slug_related}",
                                    file=sys.stderr,
                                )
                                ...
                                if is_slug_related:
                                    ...
                                    slug_field_name = (
                                        original_serializer_field.slug_field
                                    )
                                    print(
