...
class OpenAIDataExtractor:
    ...
    def OpenAIDataExtract(self,file_path : str, jsonData : str, templates : str):
        ...
        try:
            ...
            landscape_file_path = cust_font_file_path
            ...
            if ai_proc_templ:
                ...
                if 'PPH' != proc_mtd_value[0]: 
                    if 'GEM' in proc_mtd_value[1] or isEncrypted == True:
                        finalResult = self.extractdatausing_gemini(geminiAI_APIKey, landscape_file_path, ai_proc_variables)
            ...
            if os.path.isfile(landscape_file_path):
