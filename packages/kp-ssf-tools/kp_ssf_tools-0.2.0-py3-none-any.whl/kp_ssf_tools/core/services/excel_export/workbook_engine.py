...
from kp_ssf_tools.core.services.excel_export.interfaces import WorkbookEngineProtocol


class DefaultWorkbookEngine(WorkbookEngineProtocol):
    """
    Default implementation of the WorkbookEngineProtocol for Excel export.
