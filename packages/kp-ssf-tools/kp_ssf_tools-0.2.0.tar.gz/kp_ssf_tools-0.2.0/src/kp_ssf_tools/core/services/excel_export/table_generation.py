...
class DefaultTableGenerator(TableGeneratorProtocol):
    ...
    def __init__(
        ...
        table_styler: TableStylerProtocol,
    ) -> None:
        """
        ...
        """
        self.formatter: ExcelFormatterProtocol = formatter
        ...
        self.table_styler: TableStylerProtocol = table_styler
