...
class SheetNameSanitizerProtocol(Protocol):
...
class ColumnWidthAdjusterProtocol(Protocol):
...
class DateFormatterProtocol(Protocol):
...
class RowHeightAdjusterProtocol(Protocol):
...
class ExcelFormatterProtocol(Protocol):
...
class TableGeneratorProtocol(Protocol):
...
class WorkbookEngineProtocol(Protocol):
...
class ExcelExportServiceProtocol(Protocol):
