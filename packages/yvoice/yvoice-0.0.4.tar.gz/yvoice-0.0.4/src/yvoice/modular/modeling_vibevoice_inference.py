...
from yvoice.schedule.dpm_solver import DPMSolverMultistepScheduler
       ...
       # Define all valid tokens that can be generated
        ...
        for step in progress_bar:
            ...
            if diffusion_start_indices.numel() > 0 and kwargs.get('refresh_negative', True):
                ...
                # for layer_idx, (k_cache, v_cache) in enumerate(zip(negative_model_kwargs['past_key_values'].k_cache, 
                #                                                         negative_model_kwargs['past_key_values'].v_cache)):
