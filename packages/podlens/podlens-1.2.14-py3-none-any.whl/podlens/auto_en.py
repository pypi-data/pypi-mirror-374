    ...
    def save_settings(self, settings: Dict):
        ...
        try:
            with open(self.setting_file, 'w', encoding='utf-8') as f:
                ...
                # YouTube download authentication (optional, to bypass sign-in checks)
                f.write("\n# YouTube download authentication (optional)\n")
                f.write("# If you see ‘Sign in to confirm you’re not a bot’, configure one of: \n")
                f.write("# Option 1: Use cookies from a logged-in browser:\n")
                f.write("# youtube_cookies_from_browser = chrome  # or safari / edge / brave / firefox\n")
                f.write("# Option 2: Use a cookies.txt file:\n")
