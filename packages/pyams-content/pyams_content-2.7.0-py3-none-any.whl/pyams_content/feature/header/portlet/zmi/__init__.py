...
@adapter_config(required=(Interface, IPyAMSLayer, Interface, IPageHeaderPortletSettings),
                provides=IPortletPreviewer)
@template_config(template='templates/header-preview.pt', layer=IPyAMSLayer)
class PageHeaderPortletPreviewer(PortletPreviewer):
    """MSC header portlet previewer"""
