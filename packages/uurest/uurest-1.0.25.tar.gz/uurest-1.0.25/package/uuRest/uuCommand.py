...
from .common import (uuRestMethod, uuDict, escape_text, convert_to_str, convert_to_dict,
...
# def detect_header(key: str, headers: dict) -> str | None:
#     """
#     Try to find key in headers using case-insensitive way.
#     Returns key name if the key is found otherwise returns None
#     The key name should be passed as content-type
#     The function automatically searches for Content-Type, content-type and CONTENT-TYPE
#     :param key:
#     :param headers:
#     :return:
#     """
#     # TODO delete
#     # check if key exists in headers in a case-insensitive way
#     # and return the key name as it is stored in headers
#     for k in headers.keys():
#         if k.lower() == key.lower():
#             return k
#     # if key was not found then return None
#     return None


# def get_header_value(key: str, headers: dict) -> str | None:
#     """
#     Get value of a specific header in a case-insensitive way
#     :param key:
#     :param headers:
#     :return:
#     """
...
def _http_call_without_files(url: str, method: str, request_body: HttpBody, setup: Dict):
    ...
    try:
        ...
        elif method == str(uuRestMethod.PATCH):
