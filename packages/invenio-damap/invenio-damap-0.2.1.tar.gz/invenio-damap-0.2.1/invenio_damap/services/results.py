...
"""Result items for Invenio-DAMAP services."""
...
class DMPItem(BaseServiceItemResult):
    """Single Invenio-DAMAP set result item."""


class DMPList(BaseServiceListResult):
    """List of Invenio-DAMAP set result items."""
