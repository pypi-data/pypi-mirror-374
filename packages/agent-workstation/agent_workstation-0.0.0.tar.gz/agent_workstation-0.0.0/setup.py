...
version_file = 'agent_workstation/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        version=get_version(),
        description=
        'Agent-Workstation: An fully self-hosted multimodal agent framework for building local AI applications.',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='wangxingjun778',
        author_email='wangxingjun778@163.com',
        keywords='Agent, LLM, Multimodal, Self-Hosted',
        url='https://github.com/wangxingjun778/agent-workstation',
        ...
        entry_points={
            'console_scripts': ['agent-workstation=agent_workstation.cli.cli:run_cmd']
        },
