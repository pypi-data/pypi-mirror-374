...
#   timestamp: 2025-08-29T13:09:30+00:00
...
class Healthcheck(BaseModel):
    ...
    timeout: Optional[Union[str, timedelta]] = None
    start_period: Optional[Union[str, timedelta]] = None
    start_interval: Optional[Union[str, timedelta]] = None
...
class RollbackConfig(BaseModel):
    ...
    monitor: Optional[timedelta] = None
...
class EnvFile(RootModel[Union[str, List[Union[str, EnvFile1]]]]):
    root: Union[str, List[Union[str, EnvFile1]]]
...
class ListOrDict(
    RootModel[Union[Dict[str, Optional[Union[str, float, bool]]], ListOrDict1]]
):
...
class Service(BaseModel):
    ...
    stop_grace_period: Optional[timedelta] = None
...
class ComposeSpecification(BaseModel):
    ...
    include: Optional[List[Include]] = Field(
