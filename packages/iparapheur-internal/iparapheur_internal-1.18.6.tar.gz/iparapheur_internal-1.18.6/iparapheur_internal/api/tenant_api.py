...
class TenantApi:
    ...
    def _get_tenant_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/tenant/{tenantId}',
    ...
    def list_tenants_for_user(
        ...
        with_admin_rights: Annotated[Optional[StrictBool], Field(description="filtering the ones as administrator")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type sort: List[str]
        :param with_admin_rights: filtering the ones as administrator
        :type with_admin_rights: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_tenants_for_user_serialize(
            ...
            size=size,
            sort=sort,
            with_admin_rights=with_admin_rights,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _list_tenants_for_user_serialize(
        ...
        if with_admin_rights is not None:
            
            _query_params.append(('withAdminRights', with_admin_rights))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/tenant',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
