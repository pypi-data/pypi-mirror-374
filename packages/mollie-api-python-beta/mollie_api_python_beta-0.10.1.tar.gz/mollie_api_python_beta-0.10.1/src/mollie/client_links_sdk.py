...
class ClientLinksSDK(BaseSDK):
    def create(
        self,
        *,
        request: Optional[
            Union[
                models.CreateClientLinkRequest, models.CreateClientLinkRequestTypedDict
            ]
        ] = None,
    ...
    ) -> models.CreateClientLinkResponse:
        ...
        * `approval_prompt` _string_
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.CreateClientLinkRequest])
        request = cast(Optional[models.CreateClientLinkRequest], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.CreateClientLinkRequest]
            ),
        ...
        if utils.match_response(http_res, "201", "application/hal+json"):
            return unmarshal_json_response(models.CreateClientLinkResponse, http_res)
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.CreateClientLinkNotFoundHalJSONErrorData, http_res
            )
            raise models.CreateClientLinkNotFoundHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "422", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.CreateClientLinkUnprocessableEntityHalJSONErrorData, http_res
            )
            raise models.CreateClientLinkUnprocessableEntityHalJSONError(
