...
class EntityCapabilityRequirementStatus(str, Enum):
...
class EntityCapabilityRequirementTypedDict(TypedDict):
    ...
    """
    status: NotRequired[EntityCapabilityRequirementStatus]
    r"""The status of the requirement depends on its due date.
    If no due date is given, the status will be `requested`.
    """
...
class EntityCapabilityRequirement(BaseModel):
    ...
    status: Optional[EntityCapabilityRequirementStatus] = None
    r"""The status of the requirement depends on its due date.
    If no due date is given, the status will be `requested`.
    """
