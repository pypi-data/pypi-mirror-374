...
class CancelRefundDocumentationTypedDict(TypedDict):
...
class CancelRefundDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class CancelRefundLinksTypedDict(TypedDict):
    documentation: CancelRefundDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class CancelRefundLinks(BaseModel):
