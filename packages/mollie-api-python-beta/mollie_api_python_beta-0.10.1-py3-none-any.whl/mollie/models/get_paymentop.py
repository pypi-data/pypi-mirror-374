...
class GetPaymentMode(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentLineType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCategory(str, Enum, metaclass=utils.OpenEnumMeta):
    MEAL = "meal"
    ECO = "eco"
    GIFT = "gift"
...
class GetPaymentLine(BaseModel):
    ...
    type: Annotated[
        Optional[GetPaymentLineType], PlainValidator(validate_open_enum(False))
    ] = None
    r"""The type of product purchased. For example, a physical or a digital product.
    ...
    categories: Optional[
        List[Annotated[GetPaymentCategory, PlainValidator(validate_open_enum(False))]]
    ] = None
    r"""An array with the voucher categories, in case of a line eligible for a voucher. See the
    [Integrating Vouchers](https://docs.mollie.com/docs/integrating-vouchers/) guide for more information.
    """
...
class GetPaymentLocale(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCaptureMode(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentRoutingMode(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Whether this entity was created in live mode or in test mode."""
...
class GetPaymentDestinationType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentDestinationTypedDict(TypedDict):
    ...
    type: GetPaymentDestinationType
    r"""The type of destination. Currently only the destination type `organization` is supported."""
    organization_id: str
...
class GetPaymentDestination(BaseModel):
    ...
    type: Annotated[
        GetPaymentDestinationType, PlainValidator(validate_open_enum(False))
    ]
    r"""The type of destination. Currently only the destination type `organization` is supported."""
...
class GetPaymentRouting(BaseModel):
    ...
    mode: Annotated[GetPaymentRoutingMode, PlainValidator(validate_open_enum(False))]
    r"""Whether this entity was created in live mode or in test mode."""
...
class GetPaymentSequenceType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentStatusEnum(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCode(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentStatusReason(BaseModel):
    ...
    code: Annotated[GetPaymentCode, PlainValidator(validate_open_enum(False))]

    message: str
    r"""A description of the status reason, localized according to the payment `locale`."""


class GetPaymentCardAudition(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCardLabel(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCardFunding(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""The card type."""
...
class GetPaymentCardSecurity(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentFeeRegion(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentFailureReason(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentWallet(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""The wallet used when creating the payment."""

    APPLEPAY = "applepay"


class GetPaymentSellerProtection(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentPaypalFeeTypedDict(TypedDict):
...
class GetPaymentPaypalFee(BaseModel):
    r"""An amount object containing the fee PayPal will charge for this transaction. The field may be omitted if
    PayPal will not charge a fee for this transaction.
    """
...
class GetPaymentCardReadMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentCardVerificationMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class GetPaymentReceiptTypedDict(TypedDict):
    ...
    card_read_method: NotRequired[Nullable[GetPaymentCardReadMethod]]
    r"""The method by which the card was read by the terminal."""
    card_verification_method: NotRequired[Nullable[GetPaymentCardVerificationMethod]]
    r"""The method used to verify the cardholder's identity."""
...
class GetPaymentReceipt(BaseModel):
    ...
    card_read_method: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardReadMethod],
    ...
    card_verification_method: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardVerificationMethod],
            PlainValidator(validate_open_enum(False)),
        ],
...
class GetPaymentQrCodeTypedDict(TypedDict):
...
class GetPaymentQrCode(BaseModel):
    r"""Optional include. If a QR code was requested during payment creation for a QR-compatible payment method,
    the QR code details will be available in this object.
...
class GetPaymentRemainderAmountTypedDict(TypedDict):
...
class GetPaymentRemainderAmount(BaseModel):
    r"""An amount object for the amount that remained after all gift cards or vouchers were applied."""
...
class GetPaymentDetailsTypedDict(TypedDict):
    ...
    card_audition: NotRequired[Nullable[GetPaymentCardAudition]]
    r"""The card's target audience, if known."""
    card_label: NotRequired[Nullable[GetPaymentCardLabel]]
    r"""The card's label, if known."""
    ...
    card_funding: NotRequired[Nullable[GetPaymentCardFunding]]
    r"""The card type."""
    card_security: NotRequired[Nullable[GetPaymentCardSecurity]]
    r"""The level of security applied during card processing."""
    fee_region: NotRequired[Nullable[GetPaymentFeeRegion]]
    r"""The applicable card fee region."""
    ...
    failure_reason: NotRequired[Nullable[GetPaymentFailureReason]]
    r"""A failure code to help understand why the payment failed."""
    ...
    """
    wallet: NotRequired[Nullable[GetPaymentWallet]]
    r"""The wallet used when creating the payment."""
    ...
    seller_protection: NotRequired[Nullable[GetPaymentSellerProtection]]
    r"""Indicates to what extent the payment is eligible for PayPal's Seller Protection. Only available for PayPal
    payments, and if the information is made available by PayPal.
    """
    paypal_fee: NotRequired[Nullable[GetPaymentPaypalFeeTypedDict]]
    r"""An amount object containing the fee PayPal will charge for this transaction. The field may be omitted if
    PayPal will not charge a fee for this transaction.
    """
    ...
    receipt: NotRequired[GetPaymentReceiptTypedDict]
    r"""The Point of sale receipt object."""
    ...
    qr_code: NotRequired[GetPaymentQrCodeTypedDict]
    r"""Optional include. If a QR code was requested during payment creation for a QR-compatible payment method,
    the QR code details will be available in this object.
    ...
    remainder_amount: NotRequired[GetPaymentRemainderAmountTypedDict]
    r"""An amount object for the amount that remained after all gift cards or vouchers were applied."""
...
class GetPaymentDetails(BaseModel):
    ...
    card_audition: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardAudition],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    card_label: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardLabel],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    card_funding: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardFunding],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    card_security: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCardSecurity],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    fee_region: Annotated[
        Annotated[
            OptionalNullable[GetPaymentFeeRegion],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    failure_reason: Annotated[
        Annotated[
            OptionalNullable[GetPaymentFailureReason],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    wallet: Annotated[
        OptionalNullable[GetPaymentWallet], PlainValidator(validate_open_enum(False))
    ] = UNSET
    r"""The wallet used when creating the payment."""
    ...
    seller_protection: Annotated[
        Annotated[
            OptionalNullable[GetPaymentSellerProtection],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    paypal_fee: Annotated[
        OptionalNullable[GetPaymentPaypalFee], pydantic.Field(alias="paypalFee")
    ] = UNSET
    r"""An amount object containing the fee PayPal will charge for this transaction. The field may be omitted if
    PayPal will not charge a fee for this transaction.
    """
    ...
    receipt: Optional[GetPaymentReceipt] = None
    r"""The Point of sale receipt object."""
    ...
    qr_code: Annotated[Optional[GetPaymentQrCode], pydantic.Field(alias="qrCode")] = (
        None
    )
    r"""Optional include. If a QR code was requested during payment creation for a QR-compatible payment method,
    the QR code details will be available in this object.
    ...
    remainder_amount: Annotated[
        Optional[GetPaymentRemainderAmount], pydantic.Field(alias="remainderAmount")
    ] = None
    r"""An amount object for the amount that remained after all gift cards or vouchers were applied."""
...
class GetPaymentLinksStatusTypedDict(TypedDict):
...
class GetPaymentLinksStatus(BaseModel):
    r"""Link to customer-facing page showing the status of the bank transfer (to verify if the transaction was
    successful).
    """
...
class GetPaymentPayOnlineTypedDict(TypedDict):
...
class GetPaymentPayOnline(BaseModel):
    r"""Link to Mollie Checkout page allowing customers to select a different payment method instead of legacy
    bank transfer.
    """
...
class GetPaymentLinksTypedDict(TypedDict):
    ...
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    status: NotRequired[GetPaymentLinksStatusTypedDict]
    r"""Link to customer-facing page showing the status of the bank transfer (to verify if the transaction was
    successful).
    """
    pay_online: NotRequired[GetPaymentPayOnlineTypedDict]
    r"""Link to Mollie Checkout page allowing customers to select a different payment method instead of legacy
    bank transfer.
    """
...
class GetPaymentLinks(BaseModel):
    ...
    status: Optional[GetPaymentLinksStatus] = None
    r"""Link to customer-facing page showing the status of the bank transfer (to verify if the transaction was
    successful).
    """

    pay_online: Annotated[
        Optional[GetPaymentPayOnline], pydantic.Field(alias="payOnline")
    ] = None
    r"""Link to Mollie Checkout page allowing customers to select a different payment method instead of legacy
    bank transfer.
    """
...
class GetPaymentResponseTypedDict(TypedDict):
    ...
    details: NotRequired[Nullable[GetPaymentDetailsTypedDict]]
    r"""An object containing payment details collected during the payment process. For example, details may include the
    customer's card or bank details and a payment reference. For the full list of details, please refer to the
    [method-specific parameters](extra-payment-parameters) guide.
    """
...
class GetPaymentResponse(BaseModel):
    ...
    mode: Annotated[GetPaymentMode, PlainValidator(validate_open_enum(False))]
    r"""Whether this entity was created in live mode or in test mode."""
    ...
    sequence_type: Annotated[
        Annotated[
            Nullable[GetPaymentSequenceType], PlainValidator(validate_open_enum(False))
        ],
    ...
    status: Annotated[GetPaymentStatusEnum, PlainValidator(validate_open_enum(False))]
    r"""The payment's status. Refer to the [documentation regarding statuses](https://docs.mollie.com/docs/status-change#/) for more info about which
    statuses occur at what point.
    """
    ...
    locale: Annotated[
        OptionalNullable[GetPaymentLocale], PlainValidator(validate_open_enum(False))
    ] = UNSET
    r"""Allows you to preset the language to be used in the hosted payment pages shown to the customer. Setting a locale
    is highly recommended and will greatly improve your conversion rate. When this parameter is omitted the browser
    language will be used instead if supported by the payment method. You can provide any `xx_XX` format ISO 15897
    ...
    method: Annotated[
        OptionalNullable[GetPaymentMethod], PlainValidator(validate_open_enum(False))
    ] = UNSET
    r"""The payment method used for this transaction. If a specific method was selected during payment initialization,
    this field reflects that choice.
    """
    ...
    capture_mode: Annotated[
        Annotated[
            OptionalNullable[GetPaymentCaptureMode],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    details: OptionalNullable[GetPaymentDetails] = UNSET
    r"""An object containing payment details collected during the payment process. For example, details may include the
    customer's card or bank details and a payment reference. For the full list of details, please refer to the
    [method-specific parameters](extra-payment-parameters) guide.
    """
