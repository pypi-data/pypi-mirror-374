...
class TestSecurityIntegration:
    ...
    def test_security_critical_failure_blocks_publishing_standard_workflow(self):
        ...
        with patch.object(pipeline, '_check_security_critical_failures', return_value=True):
    ...
    def test_security_passes_allows_publishing_with_partial_success(self):
        ...
        with patch.object(pipeline, '_check_security_critical_failures', return_value=False):
    ...
    def test_fail_safe_behavior_on_security_check_error(self):
        ...
        with patch.object(pipeline, '_check_security_critical_failures', side_effect=Exception("Security check failed")):
            options = MockOptions(publish="patch")
