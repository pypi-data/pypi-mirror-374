...
from crackerjack.security.audit import SecurityAuditor, SecurityCheckResult
...
class TestSecurityAuditor:
    ...
    def test_security_level_classification(self):
        ...
        assert auditor._get_hook_security_level("validate-regex-patterns") == SecurityLevel.HIGH
    ...
    def test_security_recommendations(self):
        ...
        assert any("Fix all CRITICAL security issues" in rec for rec in audit_report.recommendations)
