...
"""Logging configuration module for nvidia-eval-commons.
...
DO:
- from nvidia_eval_commons.common.logging_utils import logger
- from nvidia_eval_commons.common.logging_utils import get_logger
...
def _ensure_log_dir(log_dir: str = None) -> pathlib.Path:
    ...
    Args:
        log_dir: Custom log directory path. If None, uses default ~/.nvidia-eval-commons/logs/
    ...
    if log_dir:
        ...
        log_dir_path = pathlib.Path.home() / ".nvidia-eval-commons" / "logs"
