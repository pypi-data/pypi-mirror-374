...
def get_args() -> argparse.Namespace:
    ...
    if args.debug:
        ...
        logger.warning(
            f"This flag is deprecated and will be removed in the future, please set environment variable NV_EVAL_LOG_LEVEL=DEBUG instead!"
        )
        logger.warning(f"Setting NV_EVAL_LOG_LEVEL=DEBUG")
