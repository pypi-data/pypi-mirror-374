...
class MeterHealthStatus(str, Enum):
...
class MeterHealthLinkingStatus(str, Enum):
...
class MeterHealthTypedDict(TypedDict):
    vendor: MeterVendor
...
class MeterHealth(BaseModel):
    ...
    linking_status: Annotated[
        MeterHealthLinkingStatus, pydantic.Field(alias="linkingStatus")
    ]
    r"""Ready-state for linking with the Vendor.
