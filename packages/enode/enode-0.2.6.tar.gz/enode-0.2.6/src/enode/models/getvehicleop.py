...
class GetVehicleLocationTypedDict(TypedDict):
...
class GetVehicleLocation(BaseModel):
    r"""Vehicle's GPS coordinates with timestamp"""
...
class GetVehicleResponseTypedDict(TypedDict):
    r"""Successful"""
    ...
    location: GetVehicleLocationTypedDict
    r"""Vehicle's GPS coordinates with timestamp"""
