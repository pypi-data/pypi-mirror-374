...
class GetInterventionLanguage(str, Enum):
...
GetInterventionVendorTypedDict = TypeAliasType(
...
GetInterventionVendor = TypeAliasType(
...
class GetInterventionRequestTypedDict(TypedDict):
    intervention_id: str
    language: NotRequired[GetInterventionLanguage]
    r"""Preferred BCP47 language code - Request translation for the specified language. Falls back to `en-US` if not provided or provided language code is unsupported."""
    vendor_type: NotRequired[VendorType]
    r"""Only return interventions for the specified vendor type."""
    vendor: NotRequired[GetInterventionVendorTypedDict]
    r"""Only return interventions for the specified vendor."""


class GetInterventionRequest(BaseModel):
    intervention_id: Annotated[
        str,
        pydantic.Field(alias="interventionId"),
        FieldMetadata(path=PathParamMetadata(style="simple", explode=False)),
    ]

    language: Annotated[
        Optional[GetInterventionLanguage],
    ...
    vendor: Annotated[
        Optional[GetInterventionVendor],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Only return interventions for the specified vendor."""
