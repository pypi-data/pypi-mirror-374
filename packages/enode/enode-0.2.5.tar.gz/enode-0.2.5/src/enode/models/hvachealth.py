...
class HvacHealthStatus(str, Enum):
...
class HvacHealthLinkingStatus(str, Enum):
...
class HvacHealthTypedDict(TypedDict):
    vendor: HvacVendor
...
class HvacHealth(BaseModel):
    ...
    linking_status: Annotated[
        HvacHealthLinkingStatus, pydantic.Field(alias="linkingStatus")
    ]
    r"""Ready-state for linking with the Vendor.
