...
class UpdateHVACRequestTypedDict(TypedDict):
    hvac_id: str
    hvac_update_payload: HvacUpdatePayloadTypedDict


class UpdateHVACRequest(BaseModel):
    hvac_id: Annotated[
        str,
    ...
    hvac_update_payload: Annotated[
        HvacUpdatePayload,
        FieldMetadata(request=RequestMetadata(media_type="application/json")),
    ]


class UpdateHVACCategory(str, Enum):
...
class UpdateHVACInformationTypedDict(TypedDict):
...
class UpdateHVACInformation(BaseModel):
    r"""Descriptive information about the HVAC unit"""
...
class UpdateHVACTemperatureStateTypedDict(TypedDict):
...
class UpdateHVACTemperatureState(BaseModel):
    r"""Latest information about temperature. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
...
class UpdateHVACHoldType(str, Enum):
...
class UpdateHVACThermostatStateTypedDict(TypedDict):
    ...
    * `HEAT`: The HVAC unit will only heat to the given setpoint
    ...
    hold_type: Nullable[UpdateHVACHoldType]
    last_updated: Nullable[datetime]
...
class UpdateHVACThermostatState(BaseModel):
    r"""Latest information about the thermostat state. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    ...
    * `HEAT`: The HVAC unit will only heat to the given setpoint
    ...
    hold_type: Annotated[Nullable[UpdateHVACHoldType], pydantic.Field(alias="holdType")]
...
class UpdateHVACCapabilitiesTypedDict(TypedDict):
...
class UpdateHVACCapabilities(BaseModel):
    r"""An object describing valid states for this HVAC unit."""
...
class UpdateHVACLocationTypedDict(TypedDict):
    id: Nullable[str]
    r"""ID of the charging location the HVAC unit is housed at (if any)"""


class UpdateHVACLocation(BaseModel):
    id: Nullable[str]
    r"""ID of the charging location the HVAC unit is housed at (if any)"""
...
class UpdateHVACResponseTypedDict(TypedDict):
    r"""Successfully updated HVAC unit"""
    ...
    information: UpdateHVACInformationTypedDict
    r"""Descriptive information about the HVAC unit"""
    temperature_state: UpdateHVACTemperatureStateTypedDict
    r"""Latest information about temperature. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    thermostat_state: UpdateHVACThermostatStateTypedDict
    r"""Latest information about the thermostat state. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    scopes: List[str]
    r"""Scopes that the user has granted for this HVAC unit."""
    capabilities: UpdateHVACCapabilitiesTypedDict
    r"""An object describing valid states for this HVAC unit."""
    location: UpdateHVACLocationTypedDict


class UpdateHVACResponse(BaseModel):
    r"""Successfully updated HVAC unit"""
    ...
    information: UpdateHVACInformation
    r"""Descriptive information about the HVAC unit"""

    temperature_state: Annotated[
        UpdateHVACTemperatureState, pydantic.Field(alias="temperatureState")
    ]
    r"""Latest information about temperature. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""

    thermostat_state: Annotated[
        UpdateHVACThermostatState, pydantic.Field(alias="thermostatState")
    ]
    r"""Latest information about the thermostat state. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    ...
    capabilities: UpdateHVACCapabilities
    r"""An object describing valid states for this HVAC unit."""

    location: UpdateHVACLocation
