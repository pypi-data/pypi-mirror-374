...
class HvacActionPermanentHoldTargetType(str, Enum):
    HVAC = "hvac"


class HvacActionPermanentHoldTypedDict(TypedDict):
    id: str
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    target_type: HvacActionPermanentHoldTargetType
    target: PermanentHoldTargetStateTypedDict


class HvacActionPermanentHold(BaseModel):
    id: str
    r"""The ID of the action."""
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    target_type: Annotated[
        HvacActionPermanentHoldTargetType, pydantic.Field(alias="targetType")
    ]

    target: PermanentHoldTargetState
