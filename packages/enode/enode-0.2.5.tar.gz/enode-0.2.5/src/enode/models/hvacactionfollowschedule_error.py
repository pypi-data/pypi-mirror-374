...
class HvacActionFollowScheduleTargetType(str, Enum):
    HVAC = "hvac"


class HvacActionFollowScheduleTypedDict(TypedDict):
    id: str
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    target_type: HvacActionFollowScheduleTargetType
    target: ScheduledTargetStateTypedDict


class HvacActionFollowSchedule(BaseModel):
    id: str
    r"""The ID of the action."""
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    target_type: Annotated[
        HvacActionFollowScheduleTargetType, pydantic.Field(alias="targetType")
    ]

    target: ScheduledTargetState
