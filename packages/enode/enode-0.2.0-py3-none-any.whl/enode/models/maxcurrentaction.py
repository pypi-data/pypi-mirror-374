...
class MaxCurrentActionType(str, Enum):
...
class MaxCurrentActionFailureReasonTypedDict(TypedDict):
    r"""Information about why was this action not executed successfully."""

    type: MaxCurrentActionType
    r"""A machine-readable high level error category.
...
class MaxCurrentActionFailureReason(BaseModel):
    r"""Information about why was this action not executed successfully."""
...
class MaxCurrentActionTypedDict(TypedDict):
    id: str
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    failure_reason: Nullable[MaxCurrentActionFailureReasonTypedDict]


class MaxCurrentAction(BaseModel):
    id: str
    r"""The ID of the action."""
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    failure_reason: Annotated[
        Nullable[MaxCurrentActionFailureReason], pydantic.Field(alias="failureReason")
    ]
