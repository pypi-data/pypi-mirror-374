...
class InformationTypedDict(TypedDict):
...
class TemperatureStateTypedDict(TypedDict):
...
class PaginatedHVACListHoldType(str, Enum):
...
class ThermostatStateTypedDict(TypedDict):
    ...
    * `HEAT`: The HVAC unit will only heat to the given setpoint
    ...
    hold_type: Nullable[PaginatedHVACListHoldType]
    last_updated: Nullable[datetime]
...
class ThermostatState(BaseModel):
    ...
    * `HEAT`: The HVAC unit will only heat to the given setpoint
    ...
    hold_type: Annotated[
        Nullable[PaginatedHVACListHoldType], pydantic.Field(alias="holdType")
    ]
...
class PaginatedHVACListLocationTypedDict(TypedDict):
    id: Nullable[str]
    r"""ID of the charging location the HVAC unit is housed at (if any)"""


class PaginatedHVACListLocation(BaseModel):
    id: Nullable[str]
    r"""ID of the charging location the HVAC unit is housed at (if any)"""
...
class PaginatedHVACListDataTypedDict(TypedDict):
    id: str
    r"""HVAC unit ID"""
    user_id: str
    ...
    information: InformationTypedDict
    r"""Descriptive information about the HVAC unit"""
    temperature_state: TemperatureStateTypedDict
    r"""Latest information about temperature. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    thermostat_state: ThermostatStateTypedDict
    r"""Latest information about the thermostat state. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    scopes: List[str]
    r"""Scopes that the user has granted for this HVAC unit."""
    capabilities: CapabilitiesTypedDict
    r"""An object describing valid states for this HVAC unit."""
    location: PaginatedHVACListLocationTypedDict


class PaginatedHVACListData(BaseModel):
    id: str
    r"""HVAC unit ID"""
    ...
    temperature_state: Annotated[
        TemperatureState, pydantic.Field(alias="temperatureState")
    ]
    r"""Latest information about temperature. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""

    thermostat_state: Annotated[
        ThermostatState, pydantic.Field(alias="thermostatState")
    ]
    r"""Latest information about the thermostat state. `null` values indicate we are unable to determine a value for the field based on the information coming from the vendor."""
    ...
    location: PaginatedHVACListLocation
...
class PaginatedHVACListTypedDict(TypedDict):
    r"""Paginated response of HVAC units"""

    data: List[PaginatedHVACListDataTypedDict]
    r"""List of paginated HVAC units"""
...
class PaginatedHVACList(BaseModel):
    r"""Paginated response of HVAC units"""

    data: List[PaginatedHVACListData]
    r"""List of paginated HVAC units"""
