...
class BatteryHealthLinkingStatus(str, Enum):
...
class BatteryHealthTypedDict(TypedDict):
    ...
    linking_status: BatteryHealthLinkingStatus
    r"""Ready-state for linking with the Vendor.
...
class BatteryHealth(BaseModel):
    ...
    linking_status: Annotated[
        BatteryHealthLinkingStatus, pydantic.Field(alias="linkingStatus")
    ]
    r"""Ready-state for linking with the Vendor.
