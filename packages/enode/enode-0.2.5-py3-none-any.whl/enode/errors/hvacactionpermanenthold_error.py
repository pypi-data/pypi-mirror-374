...
from enode.models import (
    ...
    hvacactionpermanenthold_error as models_hvacactionpermanenthold_error,
    permanentholdtargetstate as models_permanentholdtargetstate,
)
...
class HvacActionPermanentHoldErrorData(BaseModel):
    id: str
    ...
    * `CANCELLED`: A required precondition was not met during the action's timeout window or another action has been sent to the target, overriding this one.
    ...
    target_type: Annotated[
        models_hvacactionpermanenthold_error.HvacActionPermanentHoldTargetType,
        pydantic.Field(alias="targetType"),
    ]

    target: models_permanentholdtargetstate.PermanentHoldTargetState


class HvacActionPermanentHoldError(EnodeError):
    data: HvacActionPermanentHoldErrorData
