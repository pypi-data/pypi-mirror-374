...
class VehicleHealthStatus(str, Enum):
...
class VehicleHealthLinkingStatus(str, Enum):
...
class VehicleHealthTypedDict(TypedDict):
    ...
    linking_status: VehicleHealthLinkingStatus
    r"""Ready-state for linking with the Vendor.
...
class VehicleHealth(BaseModel):
    ...
    linking_status: Annotated[
        VehicleHealthLinkingStatus, pydantic.Field(alias="linkingStatus")
    ]
    r"""Ready-state for linking with the Vendor.
