...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("ENODE_CLIENT_ID"):
        security_dict["client_id"] = os.getenv("ENODE_CLIENT_ID")

    if os.getenv("ENODE_CLIENT_SECRET"):
        security_dict["client_secret"] = os.getenv("ENODE_CLIENT_SECRET")

    if os.getenv("ENODE_TOKEN_URL"):
        security_dict["token_url"] = os.getenv("ENODE_TOKEN_URL")
