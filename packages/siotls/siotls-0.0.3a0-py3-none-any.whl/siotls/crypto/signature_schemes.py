...
from siotls.oid import EllipticCurveOID, HashOID, PublicKeyAlgorithmOID, SignatureAlgorithmOID
...
class TLSSignatureScheme(ISign, metaclass=RegistryMeta):
    ...
    def for_key_algo(
        cls,
        asn1_key_algo: asn1crypto.keys.PrivateKeyAlgorithm | asn1crypto.keys.PublicKeyAlgorithm
    ) -> Collection:
        """
