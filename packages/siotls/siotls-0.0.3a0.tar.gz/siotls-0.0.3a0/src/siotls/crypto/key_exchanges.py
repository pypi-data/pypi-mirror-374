...
class IKeyExchange(metaclass=abc.ABCMeta):
    """
    Interface that must be implemented by every concrete key exchange
    algorithm.
    """

    @classmethod
    @abc.abstractmethod
    def init(cls) -> tuple[bytes, bytes]:  # pragma: no cover
        """ Create a new private key and public key pair. """
        raise NotImplementedError

    @classmethod
    @abc.abstractmethod
    def resume(cls, private_key: bytes, peer_key_share: bytes) -> bytes:  # pragma: no cover
        """
        Compute a secret shared key using our private key and the public
        key of the peer.

        :param private_key: Our private key.
        :param peer_key_share: Their public key.
        """
        raise NotImplementedError


class TLSKeyExchange(IKeyExchange, metaclass=RegistryMeta):
    """
    Abstract base class and registry for :class:`siotls.iana.NamedGroup`.
    """
    ...
    def install(cls, *, duplicate='raise'):  # pragma: no cover
        ...
        way of installing key exchange algorithms.
        """
        if other_cls := cls._key_exchange_registry.get(cls.iana_id):
            match duplicate:
                case 'skip':
                    return
                case 'override':
...
class X25519Mixin:
    ...
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.x25519`.
...
class X448Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.x448`.
...
class Secp256R1Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.secp256r1`.
...
class Secp384R1Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.secp384r1`.
...
class Secp521R1Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.secp521r1`.
...
class Ffdhe2048Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.ffdhe2048`.

    Specifically, this mixin has values for:
    :attr:`~TLSKeyExchange.iana_id`, ``p``, ``q``, ``g``, ``p_length``,
    and ``min_key_length``.
    """
...
class Ffdhe3072Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.ffdhe3072`.
...
class Ffdhe4096Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.ffdhe4096`.
...
class Ffdhe6144Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.ffdhe6144`.
...
class Ffdhe8192Mixin:
    ...
    This mixin can be inherited by crypto backends to feed all the
    attributes required by :class:`TLSKeyExchange` that are specific to
    :attr:`~siotls.iana.NamedGroup.ffdhe8192`.
