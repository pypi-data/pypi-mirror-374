...
from siotls.language import Serializable, SerializableBody
...
class Extension(Serializable, metaclass=RegistryMeta):
    """
    Abstract base class and registry for :class:`siotls.iana.ExtensionType`.
    """

    _registry_key = '_extension_registry'
    _extension_registry: typing.ClassVar = {}

    _handshake_types: Collection[HandshakeType | HandshakeType_] = dataclasses.field(repr=False)
...
class UnknownExtension(SerializableBody):
    """ An extension whose :attr:`extension_type` was unknown to siotls. """
    ...
    def __init__(self, extension_data: bytes):
