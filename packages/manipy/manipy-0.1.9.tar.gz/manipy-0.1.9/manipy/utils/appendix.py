...
sample_points_from_convex_distribution = lambda n, X, device: torch.cat([sample_polytope(n=n//(10+n//200) +1, x_points=X, k=3, device=device) for _ in range(10+n//200)])[torch.randperm((n//(10+n//200)+1)*(10+n//200))[:n]]
