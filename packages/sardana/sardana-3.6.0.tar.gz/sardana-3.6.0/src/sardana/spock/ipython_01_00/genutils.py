...
def load_config(config):
    ...
    d = {"version": spockver,
         "Normal": SpockTermColors.Normal,
         "Purple": SpockTermColors.Purple,
    }

    gui_mode = get_gui_mode()

    banner = """\
{Purple}Spock {version}{Normal} -- An interactive laboratory application.
...
"""
    ...
    if ipy_ver < Version("9.0.0"):
        # color_info removed in ipython 9
        i_shell.color_info = True
    # Use Neutral color for ipy_ver >= 5.0.0 due to
