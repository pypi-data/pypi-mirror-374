...
class SardanaLibrary(SardanaBaseObject):
    ...
    def add_meta_class(self, meta_class: Type["SardanaClass"]) -> None:
    ...
    def get_meta_class(self, meta_class_name: str) -> Type["SardanaClass"]:
    ...
    def get_meta_classes(self) -> Sequence[Type["SardanaClass"]]:
    ...
    def has_meta_class(self, meta_class_name: str) -> bool:
    ...
    def add_meta_function(self, meta_function: Type["SardanaFunction"]) -> None:
    ...
    def get_meta_function(self, meta_function_name: str) -> Type["SardanaFunction"]:
    ...
    def get_meta_functions(self) -> Sequence[Type["SardanaFunction"]]:
    ...
    def has_meta_function(self, meta_function_name: str) -> bool:
    ...
    def get_meta(self, meta_name: str) -> Type["SardanaCode"]:
    ...
    def has_meta(self, meta_name: str) -> bool:
    ...
    def get_metas(self) -> Sequence["SardanaCode"]:
