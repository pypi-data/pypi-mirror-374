...
class Moveable:
    ...
    def abort(self, synch=True, timeout=None):
        pass
...
class MotionGroup(BaseMotion):
    ...
    def abort(self, synch=True, timeout=None, **kwargs):
        ...
        for moveable in self.moveable_list:
            try:
                moveable.abort(synch=synch, timeout=timeout)
            except:
                pass
    ...
    def stop(self, synch=True, timeout=None, **kwargs):
        ...
        for moveable in self.moveable_list:
            try:
                moveable.stop(synch=synch, timeout=timeout)
            except:
                pass
