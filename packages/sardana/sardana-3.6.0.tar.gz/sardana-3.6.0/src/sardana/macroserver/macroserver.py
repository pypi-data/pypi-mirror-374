...
from sardana.taurus.core.tango.sardana.pool import registerExtensions, Pool
...
class MacroServer(MSContainer, MSObject, SardanaElementManager, SardanaIDManager):
    ...
    def set_environment_db(self, environment_db: str) -> None:
    ...
    def set_macro_path(self, macro_path: Sequence[str]) -> None:
        """Sets the macro path.
    ...
    def set_recorder_path(self, recorder_path: Sequence[str]) -> None:
    ...
    def report(self, msg: str, *args: Any, **kwargs: Any) -> None:
        ...
        *kwargs* are the same as :meth:`logging.Logger.debug` plus an optional
        ...
        self.report_logger.log(level, msg, *args, **kwargs)

    # --------------------------------------------------------------------------
    # Pool related methods
    # --------------------------------------------------------------------------

    def set_pool_names(self, pool_names: Sequence[str]) -> None:
    ...
    def get_pool_names(self) -> Sequence[str]:
    ...
    def get_pool(self, pool_name: str) -> Pool:
    ...
    def get_pools(self) -> Sequence[Pool]:
    ...
    def get_or_create_macro_lib(self, lib_name: str, macro_name: Optional[str] = None) -> Tuple[str, str, int]:
    ...
    def get_env(self, key: Optional[str] = None, door_name: Optional[str] = None, macro_name: Optional[str] = None) -> Dict:
