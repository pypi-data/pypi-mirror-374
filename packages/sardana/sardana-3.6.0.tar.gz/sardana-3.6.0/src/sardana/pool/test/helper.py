...
def createCTAcquisitionConfiguration(ctrls: Sequence[PoolController], ctrl_channels: Sequence[Sequence[PoolCounterTimer]]) -> Dict:
...
def createMGUserConfiguration(pool: Any, channels: Sequence[Sequence[Tuple[str]]]) -> Tuple[Dict[str, Any], Sequence[int], Sequence[str]]:
