...
class SardanaBuffer(EventGenerator):
    ...
    def __init__(self, obj: Any = None, name: Optional[str] = None, persistent: bool = False, **kwargs: Any) -> None:
    ...
    def get_value(self, idx: int) -> SardanaValue:
    ...
    def get_value_obj(self, idx: int) -> SardanaValue:
    ...
    def append(self, value: Any, idx: Optional[int] = None) -> None:
    ...
    def extend(self, values: List[Any], initial_idx: Optional[int] = None) -> None:
    ...
    def fire_add_event(self, propagate: int = 1) -> None:
