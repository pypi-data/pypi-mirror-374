...
class RouterAugmentedAttention(nn.Module):
    # ... (متد __init__ بدون تغییر باقی می‌ماند) ...
    ...
    # --- تغییر کلیدی اینجاست ---
    # ما **kwargs را اضافه می‌کنیم تا هر آرگومان اضافی را بپذیرد
    def forward(self, hidden_states, attention_mask=None, **kwargs):
        ...
        # تغییر ابعاد ماسک برای اعمال روی Q, K, V
        # (batch_size, num_heads) -> (batch_size, 1, 1, num_heads) -> (batch_size, num_heads, 1, 1) for broadcasting
        ...
        # اعمال ماسک (خاموش کردن سرهای غیرفعال)
        ...
        # ترکیب خروجی سرها و لایه خروجی نهایی
