...
class ServiceEventApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.define_service_event_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/processmanager/v1/service-event/define',
                'operation_id': 'define_service_event',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'define_service_event_request_dto',
                    'authorization',
                ],
                'required': [
                    'define_service_event_request_dto',
            ...
            root_map={
                ...
                'location_map': {
                    'define_service_event_request_dto': 'body',
        ...
        self.list_service_events_endpoint = _Endpoint(
            settings={
                'response_type': (ListServiceEventsResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/processmanager/v1/service-event',
                'operation_id': 'list_service_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def define_service_event(
        self,
        define_service_event_request_dto,
        **kwargs
    ):
        """define_service_event  # noqa: E501

        undefined  **Required Permissions**  \"process-management.workflows.create\"  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.define_service_event(define_service_event_request_dto, async_req=True)
        >>> result = thread.get()

        Args:
            define_service_event_request_dto (DefineServiceEventRequestDto):
        ...
        kwargs['define_service_event_request_dto'] = \
            define_service_event_request_dto
        return self.define_service_event_endpoint.call_with_http_info(**kwargs)

    def list_service_events(
        self,
        **kwargs
    ):
        """list_service_events  # noqa: E501

        undefined  **Required Permissions**  \"process-management.workflows.view\"  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_service_events(async_req=True)
        >>> result = thread.get()
        ...
        Returns:
            ListServiceEventsResponseClass
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_service_events_endpoint.call_with_http_info(**kwargs)
