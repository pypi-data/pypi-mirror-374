...
class MyMainWindow(QMainWindow, Ui_MainWindow, object):
    ...
    def __init__(self, workplace=None, parent=None):
        ...
        MDGUI = QAction(QIcon(":/picture/resourses/M.svg"), "Import to MCMCTree/r8s", self,
                             statusTip="MDGUI",
        ...
        def popup(qpoint):
            ...
            dict_ = {"extract_results": [mafft, MACSE, MUSCLE, rscu, compareTable, drawGO, rsl_dups],
                     ...
                     "IQtree_results": [tree_suite, ASTRAL, MDGUI],
                     "MrBayes_results": [tree_suite, MDGUI],
                     "FastTree_results": [ASTRAL, MDGUI]
                     }
            list_actions = [mafft, gblocks, trimAl, HmmCleaner, cvtFMT, catSeq, iqtree, FastTree,
                            ...
                            rsl_dups, tree_suite, MDGUI, ASTRAL, MUSCLE]
