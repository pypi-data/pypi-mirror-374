        ...
        *,
        ...
        request = models.ContainerChatCompletionBody(
            ...
            response_format=utils.get_pydantic_model(
                response_format,
                OptionalNullable[models.ResponseFormat],
            ),
            seed=seed,
            stop=stop,
            stream=stream,
            ...
            tool_choice=utils.get_pydantic_model(
                tool_choice,
                Optional[models.ContainerChatCompletionBodyToolChoice],
            ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.ContainerChatCompletionBody,
            ),
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.ContainerChatCompletionStreamBody,
            ),
            timeout_ms=timeout_ms,
        )
        if retries == UNSET:
        ...
        if utils.match_response(http_res, "200", "text/event-stream"):
            return eventstreaming.EventStream(
                ...
                lambda raw: utils.unmarshal_json(
                    raw,
                    models.ContainerChatCompletionStreamSuccess,
                ),
                sentinel="[DONE]",
                client_ref=self,
            )
