...
from test_project_3 import TestProject3, AsyncTestProject3, APIResponseValidationError
from test_project_3._types import Omit
from test_project_3._utils import asyncify
from test_project_3._models import BaseModel, FinalRequestOptions
from test_project_3._exceptions import APIStatusError, APITimeoutError, TestProject3Error, APIResponseValidationError
from test_project_3._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: TestProject3 | AsyncTestProject3) -> int:
...
class TestTestProject3:
    client = TestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "test_project_3/_legacy_response.py",
                        "test_project_3/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "test_project_3/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TestProject3Error):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = TestProject3(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: TestProject3) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TEST_PROJECT_3_BASE_URL="http://localhost:5000/from/env"):
            client = TestProject3(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: TestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: TestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: TestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = TestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = TestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("test_project_3._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: TestProject3) -> None:
    ...
    @mock.patch("test_project_3._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: TestProject3) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: TestProject3, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncTestProject3:
    client = AsyncTestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TestProject3Error):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncTestProject3(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTestProject3) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TEST_PROJECT_3_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTestProject3(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTestProject3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTestProject3(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncTestProject3
    ) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncTestProject3,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTestProject3, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
