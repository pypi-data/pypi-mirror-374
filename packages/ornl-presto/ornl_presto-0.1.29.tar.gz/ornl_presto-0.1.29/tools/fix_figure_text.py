...
im = plt.imshow(similarity_array, cmap='Blues', aspect='auto', vmin=0, vmax=1)  # Changed to Blues colormap
...
print(f"\nUpdated comprehensive visualization saved to: {output_path}")
print("Fixed issues:")
print("- All numbers are now BLACK and clearly visible")
print("- Changed heatmap colormap to 'Blues' for better contrast")
print("- Explicitly set color='black' for all text annotations")
print("- Maintained professional appearance with improved readability")
