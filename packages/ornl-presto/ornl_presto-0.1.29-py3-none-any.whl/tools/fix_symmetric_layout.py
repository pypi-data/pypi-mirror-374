...
fig = plt.figure(figsize=(20, 16))  # Back to original size
...
# 9. Similarity metrics heatmap - BACK TO ORIGINAL WIDE SIZE
ax9 = plt.subplot(4, 4, (13, 16))  # Back to full width
similarity_data = []
metrics_names = ['KS Statistic', 'Jensen-Shannon Div', 'Pearson Correlation']  # Full names back
...
# Add labels
plt.xticks(range(len(metrics_names)), metrics_names, rotation=45, ha='right', fontsize=10)
...
# Add algorithm ranking text box (LEFT SIDE - same as before)
...
# Add performance summary text box (RIGHT SIDE - same size and style as rankings)
...
print(f"\nProper layout comprehensive visualization saved to: {output_path}")
print("Layout corrections:")
print("- Restored heatmap to full width (13,16)")
print("- Performance Summary now same size as Algorithm Rankings")
print("- Both text boxes positioned symmetrically at bottom")
print("- Same font size (11) and styling for both boxes")
print("- Proper spacing with no overlap issues")
