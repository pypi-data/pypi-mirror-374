...
const fe = /[^\p{L}\p{N}]+/u, ue = /(\d{3})/g, ce = /(\D)(\d{3})/g, ge = /(\d{3})(\D)/g, Ht = /[\u0300-\u036f]/g;
function ft(t = {}) {
  if (!this || this.constructor !== ft) return new ft(...arguments);
  if (arguments.length) for (t = 0; t < arguments.length; t++) this.assign(arguments[t]);
  else this.assign(t);
}
y = ft.prototype;
y.assign = function(t) {
  this.normalize = J(t.normalize, !0, this.normalize);
  ...
  if (e || e === "") {
    ...
    this.numeric = J(t.numeric, s);
  } else {
    try {
      this.split = J(this.split, fe);
    } catch {
      this.split = /\s+/;
    }
    this.numeric = J(t.numeric, J(this.numeric, !0));
  }
  if (this.prepare = J(t.prepare, null, this.prepare), this.finalize = J(t.finalize, null, this.finalize), e = t.filter, this.filter = typeof e == "function" ? e : J(e && new Set(e), null, this.filter), this.dedupe = J(t.dedupe, !0, this.dedupe), this.matcher = J((e = t.matcher) && new Map(e), null, this.matcher), this.mapper = J((e = t.mapper) && new Map(e), null, this.mapper), this.stemmer = J(
    (e = t.stemmer) && new Map(e),
    null,
    this.stemmer
  ), this.replacer = J(t.replacer, null, this.replacer), this.minlength = J(t.minlength, 1, this.minlength), this.maxlength = J(t.maxlength, 1024, this.maxlength), this.rtl = J(t.rtl, !1, this.rtl), (this.cache = e = J(t.cache, !0, this.cache)) && (this.F = null, this.L = typeof e == "number" ? e : 2e5, this.B = /* @__PURE__ */ new Map(), this.D = /* @__PURE__ */ new Map(), this.I = this.H = 128), this.h = "", this.J = null, this.A = "", this.K = null, this.matcher) for (const n of this.matcher.keys()) this.h += (this.h ? "|" : "") + n;
...
y.encode = function(t, i) {
  ...
  this.normalize && (typeof this.normalize == "function" ? t = this.normalize(t) : t = Ht ? t.normalize("NFKD").replace(Ht, "").toLowerCase() : t.toLowerCase()), this.prepare && (t = this.prepare(t)), this.numeric && t.length > 3 && (t = t.replace(ce, "$1 $2").replace(ge, "$1 $2").replace(ue, "$1 "));
  const e = !(this.dedupe || this.mapper || this.filter || this.matcher || this.stemmer || this.replacer);
  let s = [], n = O(), r, h, l = this.split || this.split === "" ? t.split(this.split) : [t];
  for (let f = 0, u, g; f < l.length; f++) if ((u = g = l[f]) && !(u.length < this.minlength || u.length > this.maxlength)) {
    if (i) {
      if (n[u]) continue;
      n[u] = 1;
    } else {
    ...
    if (e) s.push(u);
      ...
      if (u && (this.mapper || this.dedupe && u.length > 1)) {
        o = "";
        for (let m = 0, d = "", a, c; m < u.length; m++) a = u.charAt(m), a === d && this.dedupe || ((c = this.mapper && this.mapper.get(a)) || c === "" ? c === d && this.dedupe || !(d = c) || (o += c) : o += d = a);
        u = o;
      }
...
function Pt(t, i, e) {
  ...
  let s = "" + (i || 0);
  e && (s += (e.offset || 0) + !!e.context + !!e.suggest + (e.resolve !== !1) + (e.resolution || this.resolution) + (e.boost || 0)), t = ("" + t).toLowerCase(), this.cache || (this.cache = new U());
...
const Wt = { normalize: !1, numeric: !1, dedupe: !1 }, pt = {}, St = /* @__PURE__ */ new Map([["b", "p"], ["v", "f"], ["w", "f"], ["z", "s"], ["x", "s"], ["d", "t"], ["n", "m"], ["c", "k"], ["g", "k"], ["j", "k"], ["q", "k"], ["i", "e"], ["y", "e"], ["u", "o"]]), Kt = /* @__PURE__ */ new Map([["ae", "a"], ["oe", "o"], ["sh", "s"], ["kh", "k"], ["th", "t"], ["ph", "f"], ["pf", "f"]]), Zt = [/([^aeo])h(.)/g, "$1$2", /([aeo])h([^aeo]|$)/g, "$1$2", /(.)\1+/g, "$1"], Qt = { a: "", e: "", i: "", o: "", u: "", y: "", b: 1, f: 1, p: 1, v: 1, c: 2, g: 2, j: 2, k: 2, q: 2, s: 2, x: 2, z: 2, ß: 2, d: 3, t: 3, l: 4, m: 5, n: 5, r: 6 };
var Et = { Exact: Wt, Default: pt, Normalize: pt, LatinBalance: { mapper: St }, LatinAdvanced: { mapper: St, matcher: Kt, replacer: Zt }, LatinExtra: { mapper: St, replacer: Zt.concat([/(?!^)[aeo]/g, ""]), matcher: Kt }, LatinSoundex: { dedupe: !1, include: { letter: !0 }, finalize: function(t) {
  for (let e = 0; e < t.length; e++) {
    var i = t[e];
    let s = i.charAt(0), n = Qt[s];
    for (let r = 1, h; r < i.length && (h = i.charAt(r), h === "h" || h === "w" || !(h = Qt[h]) || h === n || (s += h, n = h, s.length !== 4)); r++) ;
    t[e] = s;
  }
} }, CJK: { split: "" }, LatinExact: Wt, LatinDefault: pt, LatinSimple: pt };
function Vt(t, i, e, s) {
  let n = [];
  for (let r = 0, h; r < t.index.length; r++) if (h = t.index[r], i >= h.length) i -= h.length;
    ...
    const l = i.length;
    if (l && (n = n.length ? n.concat(i) : i, e -= l, s && (t.length -= l), !e)) break;
    i = 0;
  }
  return n;
}
function et(t) {
  ...
  return new Proxy([], { get(e, s) {
    ...
    if (s === "slice") return function(n, r) {
      return Vt(i, n || 0, r || i.length, !1);
    };
    if (s === "splice") return function(n, r) {
      return Vt(i, n || 0, r || i.length, !0);
    };
...
function F(t = 8) {
  ...
  this.index = O(), this.h = [], this.size = 0, t > 32 ? (this.B = te, this.A = BigInt(t)) : (this.B = qt, this.A = t);
}
F.prototype.get = function(t) {
  const i = this.index[this.B(t)];
  return i && i.get(t);
};
F.prototype.set = function(t, i) {
  var e = this.B(t);
  let s = this.index[e];
...
y = F.prototype;
y.has = H.prototype.has = function(t) {
  const i = this.index[this.B(t)];
  return i && i.has(t);
};
y.delete = H.prototype.delete = function(t) {
  const i = this.index[this.B(t)];
  i && i.delete(t) && this.size--;
};
y.clear = H.prototype.clear = function() {
  this.index = O(), this.h = [], this.size = 0;
};
y.values = H.prototype.values = function* () {
  for (let t = 0; t < this.h.length; t++) for (let i of this.h[t].values()) yield i;
};
y.keys = H.prototype.keys = function* () {
  for (let t = 0; t < this.h.length; t++) for (let i of this.h[t].keys()) yield i;
};
y.entries = H.prototype.entries = function* () {
...
async function pe(t) {
  ...
  switch (i) {
    case "init":
      ht = t.options || {}, (i = t.factory) ? (Function("return " + i)()(self), E = new self.FlexSearch.Index(ht), delete self.FlexSearch) : E = new W(ht), postMessage({ id: e });
      break;
    default:
      let n;
...
function q(t) {
  this[t + "Async"] = function() {
    ...
    var e = i[i.length - 1];
    let s;
    if (typeof e == "function" && (s = e, delete i[i.length - 1]), zt ? mt || (mt = Date.now() - Xt >= this.priority * this.priority * 3) : (zt = setTimeout(de, 0), Xt = Date.now()), mt) {
      const r = this;
...
function it(t = {}, i) {
  function e(l) {
    ...
    if (this.worker = l, this.h = O(), this.worker)
      return n ? this.worker.on("message", o) : this.worker.onmessage = o, t.config ? new Promise(function(f) {
  ...
  s && (s = s.toString());
  const n = typeof window > "u", r = this, h = ae(s, n, t.worker);
...
function ae(t, i, e) {
  ...
  }) : t ? new window.Worker(URL.createObjectURL(new Blob(["onmessage=" + pe.toString()], { type: "text/javascript" }))) : new window.Worker(typeof e == "string" ? e : import.meta.url.replace("/worker.js", "/worker/worker.js").replace(
    "flexsearch.bundle.module.min.js",
    "module/worker/worker.js"
  ), { type: "module" });
}
nt.prototype.add = function(t, i, e) {
  if (lt(t) && (i = t, t = ot(i, this.key)), i && (t || t === 0)) {
    ...
    for (let l = 0, o; l < this.field.length; l++) {
      ...
      if (typeof o == "function") {
        var n = o(i);
        n && s.add(t, n, e, !0);
      } else n = o.G, (!n || n(i)) && (o.constructor === String ? o = ["" + o] : N(o) && (o = [o]), Ct(i, o, this.D, 0, s, t, o[0], e));
    }
    if (this.tag) for (s = 0; s < this.A.length; s++) {
      ...
      if (typeof r == "function") {
        ...
        var h = r.G;
        if (h && !h(i)) continue;
        r.constructor === String && (r = "" + r), r = ot(i, r);
      }
      if (n && r) {
        N(r) && (r = [r]);
        for (let o = 0, f, u; o < r.length; o++) if (f = r[o], !l[f] && (l[f] = 1, (h = n.get(f)) ? u = h : n.set(f, u = []), !e || !u.includes(t))) {
          if (u.length === 2 ** 31 - 1) {
    ...
    if (this.store && (!e || !this.store.has(t))) {
      ...
      if (this.h) {
        ...
        for (let o = 0, f; o < this.h.length; o++) {
          if (f = this.h[o], (e = f.G) && !e(i)) continue;
          let u;
      ...
      this.store.set(t, l || i);
    }
    this.worker && (this.fastupdate || this.reg.add(t));
  }
  return this;
};
function Bt(t, i, e, s, n, r) {
  if (t = t[n], s === e.length - 1) i[n] = r || t;
  else if (t) if (t.constructor === Array) for (i = i[n] = Array(t.length), n = 0; n < t.length; n++) Bt(t, i, e, s, n);
  else i = i[n] || (i[n] = O()), n = e[++s], Bt(t, i, e, s, n);
}
function Ct(t, i, e, s, n, r, h, l) {
  if (t = t[h]) if (s === i.length - 1) {
    ...
    n.add(r, t, l, !0);
  } else if (t.constructor === Array) for (h = 0; h < t.length; h++) Ct(t, i, e, s, n, r, h, l);
  else h = i[++s], Ct(t, i, e, s, n, r, h, l);
}
function Jt(t, i, e, s) {
  if (!t.length) return t;
  if (t.length === 1) return t = t[0], t = e || t.length > i ? t.slice(e, e + i) : t, s ? tt.call(this, t) : t;
  let n = [];
  for (let r = 0, h, l; r < t.length; r++) if ((h = t[r]) && (l = h.length)) {
    if (e) {
      if (e >= l) {
        e -= l;
        continue;
      }
      h = h.slice(e, e + i), l = h.length, e = 0;
    }
    if (l > i && (h = h.slice(0, i), l = i), !n.length && l >= i) return s ? tt.call(this, h) : h;
...
function bt(t, i, e, s) {
  ...
  let r = [], h = 0, l = 0, o, f, u, g, m;
  for (i = 0; i < s.length; i++) if (n = s[i]) {
    var d = void 0;
    if (n.constructor === B) d = n.await || n.result;
    else if (n.then || n.constructor === Array) d = n;
    else {
      h = n.limit || 0, l = n.offset || 0, u = n.suggest, f = n.resolve, o = ((g = n.highlight || t.highlight) || n.enrich) && f, d = n.queue;
      ...
      } else if (n.and) d = dt(n, "and", c);
      else if (n.or) d = dt(n, "or", c);
      else if (n.not) d = dt(n, "not", c);
      else if (n.xor) d = dt(n, "xor", c);
      else continue;
    }
  ...
  if (m && !t.await && (t.await = new Promise(function(a) {
    ...
    return e.call(t, r, h, l, o, f, u, g);
  });
  else return e.call(t, r, h, l, o, f, u, g);
  return f ? t.await || t.result : t;
}
function dt(t, i, e) {
  t = t[i];
  const s = t[0] || t;
  return s.index || (s.index = e), e = new B(s), t.length > 1 && (e = e[i].apply(e, t.slice(1))), e;
}
B.prototype.or = function() {
  return bt(this, "or", me, arguments);
};
function me(t, i, e, s, n, r, h) {
...
B.prototype.and = function() {
  return bt(this, "and", we, arguments);
};
function we(t, i, e, s, n, r, h) {
  ...
  if (t.length) if (this.result.length && t.unshift(this.result), t.length < 2) this.result = t[0];
    ...
    let o = 0;
    for (let f = 0, u, g; f < t.length; f++) if ((u = t[f]) && (g = u.length)) o < g && (o = g);
    else if (!r) {
      o = 0;
      break;
    }
    o ? (this.result = yt(t, o, i, e, r, this.h, n), l = !0) : this.result = [];
  }
  else r || (this.result = t);
  return n && (this.await = null), n ? this.resolve(i, e, s, h, l) : this;
}
B.prototype.xor = function() {
  return bt(this, "xor", ye, arguments);
};
    ...
    t: {
      ...
      for (let g = 0, m, d = 0; g < u; g++) for (let a = 0, c; a < t.length; a++) if ((c = t[a]) && (m = c[g])) {
        for (let p = 0, x; p < m.length; p++) if (x = m[p], f[x] === 1) if (r) r--;
          ...
          if (o.push(x), o.length === i) {
            t = o;
            break t;
          }
        } else {
          const w = g + (a ? l : 0);
          if (o[w] || (o[w] = []), o[w].push(x), ++d === i) {
            t = o;
            break t;
          }
        }
...
B.prototype.not = function() {
  return bt(this, "not", xe, arguments);
};
...
function wt(t, i, e, s, n) {
  ...
  let d, a;
  typeof o == "object" && (d = o.before, d === 0 && (d = -1), a = o.after, a === 0 && (a = -1), o = o.total || 9e5), g = /* @__PURE__ */ new Map();
  for (let jt = 0, Y, Ft, st; jt < i.length; jt++) {
    let rt;
    if (s) rt = i, st = s;
    else {
      var c = i[jt];
    ...
    Ft = e.get(st), Y = Ft.encoder, c = g.get(Y), typeof c != "string" && (c = Y.encode(t), g.set(Y, c));
    for (let ct = 0; ct < rt.length; ct++) {
      var p = rt[ct].doc;
      if (!p || (p = ot(p, st), !p)) continue;
      ...
      for (var b = -1, _ = -1, z = 0, S = 0; S < x.length; S++) {
        ...
        let v;
        if (k && j) {
          for (var M = j.length, I = (Y.split ? j.replace(Y.split, "") : j).length - k.length, A = "", $ = 0, R = 0; R < c.length; R++) {
            var T = c[R];
            if (T) {
              var P = T.length;
              P += I, $ && P <= $ || (T = k.indexOf(T), T > -1 && (A = (T ? j.substring(0, T) : "") + h + j.substring(T, T + P) + l + (T + P < M ? j.substring(T + P) : ""), $ = P, v = !0));
            }
          }
          A && (o && (b < 0 && (b = p.length + (p ? 1 : 0)), _ = p.length + (p ? 1 : 0) + A.length, z += M, gt.push(w.length), w.push({ match: A })), p += (p ? " " : "") + A);
        }
        if (!v) j = x[S], p += (p ? " " : "") + j, o && w.push({ text: j });
        else if (o && z >= o) break;
      }
      if (z = gt.length * (r.length - 2), d || a || o && p.length - z > o) if (z = o + z - m * 2, S = _ - b, d > 0 && (S += d), a > 0 && (S += a), S <= z) x = d ? b - (d > 0 ? d : 0) : b - ((z - S) / 2 | 0), w = a ? _ + (a > 0 ? a : 0) : x + z, f || (x > 0 && p.charAt(x) !== " " && p.charAt(x - 1) !== " " && (x = p.indexOf(" ", x), x < 0 && (x = 0)), w < p.length && p.charAt(w - 1) !== " " && p.charAt(w) !== " " && (w = p.lastIndexOf(" ", w), w < _ ? w = _ : ++w)), p = (x ? n : "") + p.substring(x, w) + (w < p.length ? n : "");
      else {
        for (_ = [], b = {}, z = {}, S = {}, j = {}, k = {}, A = I = M = 0, R = $ = 1; ; ) {
          var K = void 0;
          for (let v = 0, C; v < gt.length; v++) {
            if (C = gt[v], A) if (I !== A) {
              if (S[v + 1]) continue;
              if (C += A, b[C]) {
                M -= m, z[v + 1] = 1, S[v + 1] = 1;
              ...
              if (C >= w.length - 1) {
                if (C >= w.length) {
                  S[v + 1] = 1, C >= x.length && (z[v + 1] = 1);
                  continue;
                }
                M -= m;
              }
              if (p = w[C].text, P = a && k[v]) if (P > 0) {
              ...
              if (M + p.length + 1 <= o) p = " " + p, _[v] += p;
              else if (f) K = o - M - 1, K > 0 && (p = " " + p.substring(0, K), _[v] += p), S[v + 1] = 1;
              else {
                S[v + 1] = 1;
                continue;
              }
              ...
              if (M + p.length + 1 <= o) p += " ", _[v] = p + _[v];
              else if (f) K = p.length + 1 - (o - M), K >= 0 && K < p.length && (p = p.substring(K) + " ", _[v] = p + _[v]), S[v] = 1;
              else {
                S[v] = 1;
                continue;
              }
              ...
              p = w[C].match, d && (j[v] = d), a && (k[v] = a), v && M++;
              let Mt;
              if (C ? !v && m && (M += m) : (z[v] = 1, S[v] = 1), C >= x.length - 1 || C < w.length - 1 && w[C + 1].match ? Mt = 1 : m && (M += m), M -= r.length - 2, !v || M + p.length <= o) _[v] = p;
              else {
                K = $ = R = z[v] = 0;
                break;
              }
          ...
          if (K) I === A ? A++ : I++;
            ...
            if (I === A ? $ = 0 : R = 0, !$ && !R) break;
            $ ? (I++, A = I) : A++;
          }
        }
        p = "";
        for (let v = 0, C; v < _.length; v++) C = (v && z[v] ? " " : (v && !n ? " " : "") + n) + _[v], p += C;
        n && !z[_.length] && (p += n);
      }
      u && (p = p.replace(u, " ")), rt[ct].highlight = p;
    }
    if (s) break;
  }
  return i;
...
function B(t, i) {
  if (!this || this.constructor !== B) return new B(t, i);
  let e = 0, s, n, r, h, l, o;
  if (t && t.index) {
    const f = t;
  ...
  if (t && t.then) {
    const f = this;
    t = t.then(function(u) {
      f.C[0] = f.result = u.result || u, Rt(f);
    }), s = [t], t = [], l = new Promise(function(u) {
      o = u;
    });
  }
  this.index = i || null, this.result = t || [], this.h = e, this.C = s || [], this.await = l || null, this.return = o || null, this.highlight = h || null, this.query = n || "", this.field = r || "";
}
y = B.prototype;
y.limit = function(t) {
  if (this.await) {
...
y.resolve = function(t, i, e, s, n) {
  let r = this.await ? Rt(this, !0) : this.result;
  if (r.then) {
    const h = this;
  ...
  return r.length && (typeof t == "object" ? (s = t.highlight || this.highlight, e = !!s || t.enrich, i = t.offset, t = t.limit) : (s = s || this.highlight, e = !!s || e), r = n ? e ? tt.call(this.index, r) : r : Jt.call(this.index, r, t || 100, i, e)), this.finalize(r, s);
};
y.finalize = function(t, i) {
  ...
  i && t.length && this.query && (t = wt(this.query, t, this.index.index, this.field, i));
  const e = this.return;
  return this.highlight = this.index = this.result = this.C = this.await = this.return = null, this.query = this.field = "", e && e(t), t;
};
function yt(t, i, e, s, n, r, h) {
  const l = t.length;
  let o = [], f, u;
  f = O();
  for (let g = 0, m, d, a, c; g < i; g++) for (let p = 0; p < l; p++) if (a = t[p], g < a.length && (m = a[g])) for (let x = 0; x < m.length; x++) {
    if (d = m[x], (u = f[d]) ? f[d]++ : (u = 0, f[d] = 1), c = o[u] || (o[u] = []), !h) {
      let w = g + (p || !n ? 0 : r || 0);
      c = c[w] || (c[w] = []);
    }
    if (c.push(d), h && e && u === l - 1 && c.length - s === e) return s ? c.slice(s) : c;
  }
  if (t = o.length) if (n) o = o.length > 1 ? ee(o, e, s, h, r) : (o = o[0]) && e && o.length > e || s ? o.slice(s, e + s) : o;
  else {
    if (t < l) return [];
    if (o = o[t - 1], e || s) if (h)
      (o.length > e || s) && (o = o.slice(s, e + s));
    else {
      n = [];
      for (let g = 0, m; g < o.length; g++) if (m = o[g]) {
...
function ee(t, i, e, s, n) {
  ...
  } else for (let u = o - 1, g, m = 0; u >= 0; u--) {
    g = t[u];
    for (let d = 0; d < g.length; d++) if (f = (s = g[d]) && s.length) {
      for (let a = 0; a < f; a++) if (l = s[a], !h[l]) if (h[l] = 1, e) e--;
      else {
        let c = (d + (u < o - 1 && n || 0)) / (u + 1) | 0;
        if ((r[c] || (r[c] = [])).push(l), ++m === i) return r;
      }
    }
  }
  return r;
...
function ke(t, i, e) {
  ...
  if (e) for (let r = 0, h; r < t.length; r++) h = t[r], s[h] && (n.push(h), s[h] = 0);
  else for (let r = 0, h, l; r < t.result.length; r++) for (h = t.result[r], i = 0; i < h.length; i++) l = h[i], s[l] && ((n[r] || (n[r] = [])).push(l), s[l] = 0);
  return n;
}
nt.prototype.search = function(t, i, e, s) {
  e || (!i && lt(t) ? (e = t, t = "") : lt(i) && (e = i, i = 0));
  let n = [];
  var r = [];
  let h, l, o, f, u, g, m = 0, d = !0, a;
  if (e) {
    e.constructor === Array && (e = { index: e }), t = e.query || t, h = e.pluck, l = e.merge, f = e.boost, g = h || e.field || (g = e.index) && (g.index ? null : g);
    var c = this.tag && e.tag;
    o = e.suggest, d = e.resolve !== !1, u = e.cache, a = d && this.store && e.highlight;
    ...
    if (i || (i = d ? 100 : 0), c && (!this.db || !s)) {
      ...
      for (let j = 0, k; j < c.length; j++) if (k = c[j], k.field && k.tag) {
        ...
        b = Object.keys(k);
        for (let M = 0, I, A; M < b.length; M++) if (I = b[M], A = k[I], A.constructor === Array) for (_ = 0; _ < A.length; _++) w.push(I, A[_]);
        else w.push(I, A);
      }
      if (c = w, !t) {
        if (r = [], w.length) for (c = 0; c < w.length; c += 2) {
          ...
          } else s = ve.call(this, w[c], w[c + 1], i, x, p);
        ...
        if (r.length) {
          ...
          return Promise.all(r).then(function(k) {
            ...
            return d ? n : new B(n.length > 1 ? yt(n, 1, 0, 0, o, f) : n[0], j);
          });
        }
        return d ? n : new B(n.length > 1 ? yt(n, 1, 0, 0, o, f) : n[0], this);
      }
    }
  ...
  for (let j = 0, k, M, I; j < g.length; j++) {
    if (M = g[j], this.db && this.tag && !this.B[j]) continue;
    let A;
    if (N(M) || (A = M, M = A.field, t = A.query || t, i = G(A.limit, i), x = G(A.offset, x), o = G(A.suggest, o), a = d && this.store && G(A.highlight, a), p = !!a || d && this.store && G(A.enrich, p), u = G(A.cache, u)), s) k = s[j];
    else {
      b = A || e || {}, _ = b.enrich;
      var S = this.index.get(M);
      if (c && (this.db && (b.tag = c, z = S.db.support_tag_search, b.field = g), !z && _ && (b.enrich = !1)), k = u ? S.searchCache(t, i, b) : S.search(t, i, b), _ && (b.enrich = _), w) {
        w[j] = k;
        continue;
      }
    }
    if (I = (k = k.result || k) && k.length, c && I) {
      if (b = [], _ = 0, this.db && s) {
        if (!z) for (S = g.length; S < s.length; S++) {
          let $ = s[S];
          if ($ && $.length) _++, b.push($);
          else if (!o) return d ? n : new B(n, this);
        }
      } else for (let $ = 0, R, T; $ < c.length; $ += 2) {
        if (R = this.tag.get(c[$]), !R) {
          if (o) continue;
          return d ? n : new B(n, this);
        }
        if (T = (R = R && R.get(c[$ + 1])) && R.length) _++, b.push(R);
        else if (!o) return d ? n : new B(n, this);
      }
      if (_) {
        if (k = ke(k, b, d), I = k.length, !I && !o) return d ? k : new B(k, this);
        _--;
      }
    }
    if (I) r[m] = M, n.push(k), m++;
    else if (g.length === 1) return d ? n : new B(n, this);
  }
  if (w) {
  ...
  if (h && (!p || !this.store)) return n = n[0], d ? n : new B(n, this);
  for (w = [], x = 0; x < r.length; x++) {
    if (c = n[x], p && c.length && typeof c[0].doc > "u" && (this.db ? w.push(c = this.index.get(this.field[0]).db.enrich(c)) : c = tt.call(this, c)), h) return d ? a ? wt(t, c, this.index, h, a) : c : new B(c, this);
  ...
  if (p && this.db && w.length) {
    ...
    return Promise.all(w).then(function(k) {
      ...
      return a && (n = wt(t, n, j.index, h, a)), l ? Yt(n) : n;
    });
  }
  return a && (n = wt(t, n, this.index, h, a)), l ? Yt(n) : n;
};
function Yt(t) {
  const i = [], e = O(), s = O();
  for (let n = 0, r, h, l, o, f, u, g; n < t.length; n++) {
    r = t[n], h = r.field, l = r.result;
    for (let m = 0; m < l.length; m++) f = l[m], typeof f != "object" ? f = { id: o = f } : o = f.id, (u = e[o]) ? u.push(h) : (f.field = e[o] = [h], i.push(f)), (g = f.highlight) && (u = s[o], u || (s[o] = u = {}, f.highlight = u), u[h] = g);
  }
  return i;
}
...
function nt(t) {
  ...
  let e, s;
  if (this.B = [], this.field = [], this.D = [], this.key = (e = i.key || i.id) && xt(e, this.D) || "id", (s = t.keystore || 0) && (this.keystore = s), this.fastupdate = !!t.fastupdate, this.reg = !this.fastupdate || t.worker || t.db ? s ? new H(s) : /* @__PURE__ */ new Set() : s ? new F(s) : /* @__PURE__ */ new Map(), this.h = (e = i.store || null) && e && e !== !0 && [], this.store = e ? s ? new F(s) : /* @__PURE__ */ new Map() : null, this.cache = (e = t.cache || null) && new U(e), t.cache = !1, this.worker = t.worker || !1, this.priority = t.priority || 4, this.index = be.call(this, t, i), this.tag = null, (e = i.tag) && (typeof e == "string" && (e = [e]), e.length)) {
    ...
    for (let n = 0, r, h; n < e.length; n++) {
      ...
      r.custom ? this.A[n] = r.custom : (this.A[n] = xt(h, this.D), r.filter && (typeof this.A[n] == "string" && (this.A[n] = new String(this.A[n])), this.A[n].G = r.filter)), this.F[n] = h, this.tag.set(h, /* @__PURE__ */ new Map());
    }
  }
  if (this.worker) {
    this.fastupdate = !1, t = [];
...
y.mount = function(t) {
  ...
  if (this.tag) for (let r = 0, h; r < this.F.length; r++) {
    h = this.F[r];
    var e = void 0;
    this.index.set(h, e = new W({}, this.reg)), i === this.field && (i = i.slice(0)), i.push(h), e.tag = this.tag.get(h);
  }
  e = [];
  const s = { db: t.db, type: t.type, fastupdate: t.fastupdate };
  for (let r = 0, h, l; r < i.length; r++) {
    s.field = l = i[r], h = this.index.get(l);
    const o = new t.constructor(t.id, s);
    o.id = t.id, e[r] = o.mount(h), h.document = !0, r ? h.bypass = !0 : h.store = this.store;
  }
  const n = this;
...
function be(t, i) {
  ...
  for (let r = 0, h, l; r < s.length; r++) {
    if (h = s[r], N(h) || (l = h, h = h.field), l = lt(l) ? Object.assign({}, t, l) : t, this.worker) {
      var n = void 0;
      n = (n = l.encoder) && n.encode ? n : new ft(typeof n == "string" ? Et[n] : n || {}), n = new it(l, n), e.set(h, n);
    }
    this.worker || e.set(h, new W(l, this.reg)), l.custom ? this.B[r] = l.custom : (this.B[r] = xt(h, this.D), l.filter && (typeof this.B[r] == "string" && (this.B[r] = new String(this.B[r])), this.B[r].G = l.filter)), this.field[r] = h;
  }
  if (this.h) {
    t = i.store, N(t) && (t = [t]);
    for (let r = 0, h, l; r < t.length; r++) h = t[r], l = h.field || h, h.custom ? (this.h[r] = h.custom, h.custom.O = l) : (this.h[r] = xt(l, this.D), h.filter && (typeof this.h[r] == "string" && (this.h[r] = new String(this.h[r])), this.h[r].G = h.filter));
  }
  return e;
}
function xt(t, i) {
...
y.set = function(t, i) {
  return typeof t == "object" && (i = t, t = ot(i, this.key)), this.store.set(t, i), this;
};
y.searchCache = Pt;
y.export = je;
y.import = Me;
...
function ie(t, i = 0) {
  let e = [], s = [];
  i && (i = 25e4 / i * 1e3 | 0);
  for (const n of t.entries()) s.push([n[0], Tt(n[1])[0]]), s.length === i && (e.push(s), s = []);
  return s.length && e.push(s), e;
}
function ne(t, i) {
  i || (i = /* @__PURE__ */ new Map());
  for (let e = 0, s, n; e < t.length; e++) s = t[e], n = i.get(s[0]), i.set(s[0], Nt(s[1], n));
  return i;
}
function se(t) {
  let i = [], e = [];
...
function kt(t, i, e, s, n, r, h = 0) {
  const l = s && s.constructor === Array;
  var o = l ? s.shift() : s;
  if (!o) return this.export(t, i, n, r + 1);
  if ((o = t((i ? i + "." : "") + (h + 1) + "." + e, JSON.stringify(o))) && o.then) {
    const f = this;
    return o.then(function() {
      return kt.call(f, t, i, e, l ? s : null, n, r, h + 1);
    });
  }
  return kt.call(this, t, i, e, l ? s : null, n, r, h + 1);
}
function je(t, i, e = 0, s = 0) {
  if (e < this.field.length) {
    const h = this.field[e];
    if ((i = this.index.get(h).export(t, h, e, s = 1)) && i.then) {
      const l = this;
      return i.then(function() {
        return l.export(t, h, e + 1);
      });
    }
  ...
  switch (s) {
    ...
    case 1:
      ...
      break;
    case 2:
      n = "doc", r = this.store && Tt(this.store), i = null;
      break;
    default:
      return;
  }
  return kt.call(this, t, i, n, r || null, e, s);
}
function Me(t, i) {
  var e = t.split(".");
...
W.prototype.remove = function(t, i) {
  ...
  if (e) {
    ...
    } else ut(this.map, t), this.depth && ut(this.ctx, t);
    i || this.reg.delete(t);
  }
...
function ut(t, i) {
  ...
  var s = typeof i > "u";
  if (t.constructor === Array) {
    for (let n = 0, r, h, l; n < t.length; n++)
      if ((r = t[n]) && r.length) {
        if (s) return 1;
  ...
  } else for (let n of t.entries()) s = n[0], ut(n[1], i) ? e++ : t.delete(s);
  return e;
}
const Se = { memory: { resolution: 1 }, performance: { resolution: 3, fastupdate: !0, context: { depth: 1, resolution: 1 } }, match: { tokenize: "forward" }, score: { resolution: 9, context: { depth: 2, resolution: 3 } } };
W.prototype.add = function(t, i, e, s) {
  if (i && (t || t === 0)) {
    if (!s && !e && this.reg.has(t)) return this.update(t, i);
    s = this.depth, i = this.encoder.encode(i, !s);
    const f = i.length;
    if (f) {
      const u = O(), g = O(), m = this.resolution;
      for (let d = 0; d < f; d++) {
        let a = i[this.rtl ? f - 1 - d : d];
        var n = a.length;
        if (n && (s || !g[a])) {
          var r = this.score ? this.score(i, a, d, null, 0) : at(m, f, d), h = "";
          switch (this.tokenize) {
            case "tolerant":
              if (Z(this, g, a, r, t, e), n > 2) {
                for (let c = 1, p, x, w, b; c < n - 1; c++) p = a.charAt(c), x = a.charAt(c + 1), w = a.substring(0, c) + x, b = a.substring(c + 2), h = w + p + b, Z(this, g, h, r, t, e), h = w + b, Z(this, g, h, r, t, e);
                Z(this, g, a.substring(0, a.length - 1), r, t, e);
              }
              break;
            case "full":
              if (n > 2) {
                for (let c = 0, p; c < n; c++) for (r = n; r > c; r--) {
                  ...
                  var l = this.score ? this.score(i, a, d, h, p) : at(m, f, d, n, p);
                  Z(this, g, h, l, t, e);
                }
                break;
              }
            ...
            case "reverse":
              if (n > 1) {
                for (l = n - 1; l > 0; l--) {
                  h = a[this.rtl ? n - 1 - l : l] + h;
                  var o = this.score ? this.score(i, a, d, h, l) : at(m, f, d, n, l);
                  Z(this, g, h, o, t, e);
                }
                h = "";
              }
            case "forward":
              if (n > 1) {
                for (l = 0; l < n; l++) h += a[this.rtl ? n - 1 - l : l], Z(
                  this,
                  g,
                  h,
                  r,
            ...
            default:
              if (Z(this, g, a, r, t, e), s && f > 1 && d < f - 1) for (n = this.N, h = a, r = Math.min(s + 1, this.rtl ? d + 1 : f - d), l = 1; l < r; l++) {
                a = i[this.rtl ? f - 1 - d - l : d + l], o = this.bidirectional && a > h;
                const c = this.score ? this.score(i, h, d, a, l - 1) : at(n + (f / 2 > n ? 0 : 1), f, d, r - 1, l - 1);
                Z(this, u, o ? h : a, c, t, e, o ? a : h);
              }
          }
        }
      }
...
function Z(t, i, e, s, n, r, h) {
  let l, o;
  if (!(l = i[e]) || h && !l[h]) {
    if (h ? (i = l || (i[e] = O()), i[h] = 1, o = t.ctx, (l = o.get(h)) ? o = l : o.set(h, o = t.keystore ? new F(t.keystore) : /* @__PURE__ */ new Map())) : (o = t.map, i[e] = 1), (l = o.get(e)) ? o = l : o.set(e, o = l = []), r) {
    ...
    if (o = o[s] || (o[s] = []), o.push(n), o.length === 2 ** 31 - 1) {
      if (i = new et(o), t.fastupdate) for (let f of t.reg.values()) f.includes(o) && (f[f.indexOf(o)] = i);
      l[s] = o = i;
    }
    t.fastupdate && ((s = t.reg.get(n)) ? s.push(o) : t.reg.set(n, [o]));
  }
}
function at(t, i, e, s, n) {
  return e && t > 1 ? i + (s || 0) <= t ? e + (n || 0) : (t - 1) / (i + (s || 0)) * (e + (n || 0)) + 1 | 0 : 0;
}
W.prototype.search = function(t, i, e) {
  if (e || (i || typeof t != "object" ? typeof i == "object" && (e = i, i = 0) : (e = t, t = "")), e && e.cache) return e.cache = !1, t = this.searchCache(t, i, e), e.cache = !0, t;
  let s = [], n, r, h, l = 0, o, f, u, g, m;
  e && (t = e.query || t, i = e.limit || i, l = e.offset || 0, r = e.context, h = e.suggest, m = (o = e.resolve) && e.enrich, u = e.boost, g = e.resolution, f = this.db && e.tag), typeof o > "u" && (o = this.resolve), r = this.depth && r !== !1;
  let d = this.encoder.encode(t, !r);
  if (n = d.length, i = i || (o ? 100 : 0), n === 1) return Ut.call(
    this,
    d[0],
    "",
    i,
  ...
  if (n === 2 && r && !h) return Ut.call(this, d[1], d[0], i, l, o, m, f);
  let a = O(), c = 0, p;
  if (r && (p = d[0], c = 1), g || g === 0 || (g = p ? this.N : this.resolution), this.db) {
    if (this.db.search && (e = this.db.search(this, d, i, l, h, o, m, f), e !== !1)) return e;
    const x = this;
    return async function() {
      for (let w, b; c < n; c++) {
        if ((b = d[c]) && !a[b]) {
          if (a[b] = 1, w = await Ot(x, b, p, 0, 0, !1, !1), w = Gt(w, s, h, g)) {
            s = w;
            break;
          }
          p && (h && w && s.length || (p = b));
        }
        h && p && c === n - 1 && !s.length && (g = x.resolution, p = "", c = -1, a = O());
      }
      return Dt(s, g, i, l, h, u, o);
    }();
  }
  for (let x, w; c < n; c++) {
    if ((w = d[c]) && !a[w]) {
      if (a[w] = 1, x = Ot(this, w, p, 0, 0, !1, !1), x = Gt(x, s, h, g)) {
        s = x;
        break;
      }
      p && (h && x && s.length || (p = w));
    }
    h && p && c === n - 1 && !s.length && (g = this.resolution, p = "", c = -1, a = O());
  }
  return Dt(s, g, i, l, h, u, o);
};
function Dt(t, i, e, s, n, r, h) {
  let l = t.length, o = t;
  if (l > 1) o = yt(t, i, e, s, n, r, h);
  else if (l === 1) return h ? Jt.call(null, t[0], e, s) : new B(t[0], this);
  return h ? o : new B(o, this);
}
function Ut(t, i, e, s, n, r, h) {
  return t = Ot(this, t, i, e, s, n, r, h), this.db ? t.then(function(l) {
    return n ? l || [] : new B(l, this);
  }) : t && t.length ? n ? Jt.call(this, t, e, s) : new B(t, this) : n ? [] : new B([], this);
}
function Gt(t, i, e, s) {
  let n = [];
  if (t && t.length) {
...
function Ot(t, i, e, s, n, r, h, l) {
  let o;
  return e && (o = t.bidirectional && i > e) && (o = e, e = i, i = o), t.db ? t.db.get(i, e, s, n, r, h, l) : (t = e ? (t = t.ctx.get(e)) && t.get(i) : t.map.get(i), t);
}
function W(t, i) {
  if (!this || this.constructor !== W) return new W(t);
  if (t) {
    var e = N(t) ? t : t.preset;
    e && (t = Object.assign({}, Se[e], t));
  } else t = {};
  e = t.context;
  const s = e === !0 ? { depth: 1 } : e || {}, n = N(t.encoder) ? Et[t.encoder] : t.encode || t.encoder || {};
  this.encoder = n.encode ? n : typeof n == "object" ? new ft(n) : { encode: n }, this.resolution = t.resolution || 9, this.tokenize = e = (e = t.tokenize) && e !== "default" && e !== "exact" && e || "strict", this.depth = e === "strict" && s.depth || 0, this.bidirectional = s.bidirectional !== !1, this.fastupdate = !!t.fastupdate, this.score = t.score || null, (e = t.keystore || 0) && (this.keystore = e), this.map = e ? new F(e) : /* @__PURE__ */ new Map(), this.ctx = e ? new F(e) : /* @__PURE__ */ new Map(), this.reg = i || (this.fastupdate ? e ? new F(e) : /* @__PURE__ */ new Map() : e ? new H(e) : /* @__PURE__ */ new Set()), this.N = s.resolution || 3, this.rtl = n.rtl || t.rtl || !1, this.cache = (e = t.cache || null) && new U(e), this.resolve = t.resolve !== !1, (e = t.db) && (this.db = this.mount(e)), this.M = t.commit !== !1, this.commit_task = [], this.commit_timer = null, this.priority = t.priority || 4;
}
y = W.prototype;
y.mount = function(t) {
...
y.cleanup = function() {
  return this.fastupdate ? (ut(this.map), this.depth && ut(this.ctx), this) : this;
};
y.searchCache = Pt;
y.export = function(t, i, e = 0, s = 0) {
  ...
  switch (s) {
    ...
    case 1:
      ...
      break;
    case 2:
      n = "map", r = Tt(this.map, this.reg.size);
      break;
    case 3:
  ...
  return kt.call(this, t, i, n, r, e, s);
};
...
y.serialize = function(t = !0) {
  ...
  if (this.reg.size) {
    ...
    i = "index.reg=new Set([" + i + "]);", e = Lt(this.map, r), e = "index.map=new Map([" + e + "]);";
...
$t(W.prototype);
const le = typeof window < "u" && (window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB), vt = ["map", "ctx", "tag", "reg", "cfg"], L = O();
function It(t, i = {}) {
...
y.open = function() {
  ...
  let t = this;
  navigator.storage && navigator.storage.persist(), L[t.id] || (L[t.id] = []), L[t.id].push(t.field);
  const i = le.open(t.id, 1);
  return i.onupgradeneeded = function() {
    const e = t.db = this.result;
    for (let s = 0, n; s < vt.length; s++) {
      n = vt[s];
      for (let r = 0, h; r < L[t.id].length; r++) h = L[t.id][r], e.objectStoreNames.contains(n + (n !== "reg" && h ? ":" + h : "")) || e.createObjectStore(n + (n !== "reg" && h ? ":" + h : ""));
    }
  }, t.db = X(i, function(e) {
...
y.clear = function() {
  const t = [];
  for (let e = 0, s; e < vt.length; e++) {
    s = vt[e];
    for (let n = 0, r; n < L[this.id].length; n++) r = L[this.id][n], t.push(s + (s !== "reg" && r ? ":" + r : ""));
  }
...
y.get = function(t, i, e = 0, s = 0, n = !0, r = !1) {
  ...
  const h = this;
  return X(t).then(function(l) {
    let o = [];
    if (!l || !l.length) return o;
    if (n) {
      if (!e && !s && l.length === 1) return l[0];
      for (let f = 0, u; f < l.length; f++) if ((u = l[f]) && u.length) {
        ...
        for (let m = s; m < g; m++) o.push(u[m]);
        if (s = 0, o.length === e) break;
      }
      ...
      h.length && (s.get(r).onsuccess = function() {
        ...
        if (l && l.length) {
          ...
          for (let u = 0, g, m; u < f; u++) if ((m = h[u]) && m.length) {
            if ((g = l[u]) && g.length) for (o = 0; o < m.length; o++) g.push(m[o]);
            else l[u] = m;
            o = 1;
          }
        } else l = h, o = 1;
...
self.onmessage = (t) => {
  switch (t.data.type) {
    case "clear":
      At = new oe(), postMessage({ identifier: t.data.identifier });
      break;
    case "points":
      ...
      break;
    case "query":
      let i = At.search(t.data.query, { limit: t.data.limit });
