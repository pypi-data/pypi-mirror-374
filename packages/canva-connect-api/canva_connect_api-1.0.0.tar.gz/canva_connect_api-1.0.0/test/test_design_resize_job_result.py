...
class TestDesignResizeJobResult(unittest.TestCase):
    """DesignResizeJobResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignResizeJobResult:
        """Test DesignResizeJobResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignResizeJobResult`
        """
        model = DesignResizeJobResult()
        if include_optional:
            return DesignResizeJobResult(
    ...
    def testDesignResizeJobResult(self):
        """Test DesignResizeJobResult"""
