...
class TestGetAssetUploadJobResponse(unittest.TestCase):
    """GetAssetUploadJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAssetUploadJobResponse:
        """Test GetAssetUploadJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAssetUploadJobResponse`
        """
        model = GetAssetUploadJobResponse()
        if include_optional:
            return GetAssetUploadJobResponse(
    ...
    def testGetAssetUploadJobResponse(self):
        """Test GetAssetUploadJobResponse"""
