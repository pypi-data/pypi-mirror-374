...
class TestCreateDesignImportJobResponse(unittest.TestCase):
    """CreateDesignImportJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDesignImportJobResponse:
        """Test CreateDesignImportJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDesignImportJobResponse`
        """
        model = CreateDesignImportJobResponse()
        if include_optional:
    ...
    def testCreateDesignImportJobResponse(self):
        """Test CreateDesignImportJobResponse"""
