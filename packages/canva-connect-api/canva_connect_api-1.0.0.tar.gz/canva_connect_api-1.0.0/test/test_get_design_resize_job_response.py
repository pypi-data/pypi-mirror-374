...
class TestGetDesignResizeJobResponse(unittest.TestCase):
    """GetDesignResizeJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDesignResizeJobResponse:
        """Test GetDesignResizeJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDesignResizeJobResponse`
        """
        model = GetDesignResizeJobResponse()
        if include_optional:
            return GetDesignResizeJobResponse(
    ...
    def testGetDesignResizeJobResponse(self):
        """Test GetDesignResizeJobResponse"""
