...
class TestCreateUrlImportJobResponse(unittest.TestCase):
    """CreateUrlImportJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateUrlImportJobResponse:
        """Test CreateUrlImportJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateUrlImportJobResponse`
        """
        model = CreateUrlImportJobResponse()
        if include_optional:
            return CreateUrlImportJobResponse(
    ...
    def testCreateUrlImportJobResponse(self):
        """Test CreateUrlImportJobResponse"""
