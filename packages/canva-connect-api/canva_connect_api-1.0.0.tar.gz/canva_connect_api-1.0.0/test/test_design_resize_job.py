...
class TestDesignResizeJob(unittest.TestCase):
    """DesignResizeJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignResizeJob:
        """Test DesignResizeJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignResizeJob`
        """
        model = DesignResizeJob()
        if include_optional:
            return DesignResizeJob(
