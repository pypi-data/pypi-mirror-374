...
class TestNewCommentEvent(unittest.TestCase):
    """NewCommentEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewCommentEvent:
        """Test NewCommentEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewCommentEvent`
        """
        model = NewCommentEvent()
        if include_optional:
