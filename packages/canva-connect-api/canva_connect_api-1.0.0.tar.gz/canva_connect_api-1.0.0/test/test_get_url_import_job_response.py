...
class TestGetUrlImportJobResponse(unittest.TestCase):
    """GetUrlImportJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUrlImportJobResponse:
        """Test GetUrlImportJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUrlImportJobResponse`
        """
        model = GetUrlImportJobResponse()
        if include_optional:
            return GetUrlImportJobResponse(
    ...
    def testGetUrlImportJobResponse(self):
        """Test GetUrlImportJobResponse"""
