...
class TestCreateDesignAutofillJobResult(unittest.TestCase):
    """CreateDesignAutofillJobResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDesignAutofillJobResult:
        """Test CreateDesignAutofillJobResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDesignAutofillJobResult`
        """
        model = CreateDesignAutofillJobResult()
        if include_optional:
    ...
    def testCreateDesignAutofillJobResult(self):
        """Test CreateDesignAutofillJobResult"""
