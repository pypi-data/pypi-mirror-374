...
class TestDesignImportJobResult(unittest.TestCase):
    """DesignImportJobResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignImportJobResult:
        """Test DesignImportJobResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignImportJobResult`
        """
        model = DesignImportJobResult()
        if include_optional:
    ...
    def testDesignImportJobResult(self):
        """Test DesignImportJobResult"""
