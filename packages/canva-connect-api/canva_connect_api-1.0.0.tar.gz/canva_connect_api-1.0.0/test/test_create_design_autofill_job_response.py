...
class TestCreateDesignAutofillJobResponse(unittest.TestCase):
    """CreateDesignAutofillJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDesignAutofillJobResponse:
        """Test CreateDesignAutofillJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDesignAutofillJobResponse`
        """
        model = CreateDesignAutofillJobResponse()
        if include_optional:
            return CreateDesignAutofillJobResponse(
                job = openapi_client.models.design_autofill_job.DesignAutofillJob(
    ...
    def testCreateDesignAutofillJobResponse(self):
        """Test CreateDesignAutofillJobResponse"""
