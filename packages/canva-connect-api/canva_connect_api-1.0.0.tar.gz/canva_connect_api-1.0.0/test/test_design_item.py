...
class TestDesignItem(unittest.TestCase):
    """DesignItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignItem:
        """Test DesignItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignItem`
        """
        model = DesignItem()
        if include_optional:
            return DesignItem(
