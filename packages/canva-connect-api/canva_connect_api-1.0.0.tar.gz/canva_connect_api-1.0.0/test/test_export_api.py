...
class TestExportApi(unittest.TestCase):
    ...
    def test_create_design_export_job(self) -> None:
        """Test case for create_design_export_job

        """
        pass

    def test_get_design_export_job(self) -> None:
        """Test case for get_design_export_job
