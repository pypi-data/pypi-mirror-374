...
class TestBrandTemplate(unittest.TestCase):
    """BrandTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandTemplate:
        """Test BrandTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandTemplate`
        """
        model = BrandTemplate()
        if include_optional:
