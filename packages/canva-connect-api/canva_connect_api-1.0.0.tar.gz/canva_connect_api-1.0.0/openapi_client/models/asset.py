...
class Asset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "name", "tags", "import_status", "created_at", "updated_at", "owner", "thumbnail"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.import_status:
            _dict['import_status'] = self.import_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tags": obj.get("tags"),
            "import_status": ImportStatus.from_dict(obj["import_status"]) if obj.get("import_status") is not None else None,
