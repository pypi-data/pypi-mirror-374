...
class GetSigningPublicKeysResponse(BaseModel):
    """
    GetSigningPublicKeysResponse
    """ # noqa: E501
    keys: List[EdDsaJwk] = Field(description="A Json Web Key Set (JWKS) with public keys used for signing webhooks. You can use this JWKS to verify that a webhook was sent from Canva.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [EdDsaJwk.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
