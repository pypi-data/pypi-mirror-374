...
class UsersMeResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["team_user"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of team_user
        if self.team_user:
            _dict['team_user'] = self.team_user.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "team_user": TeamUserSummary.from_dict(obj["team_user"]) if obj.get("team_user") is not None else None
        })
        return _obj
