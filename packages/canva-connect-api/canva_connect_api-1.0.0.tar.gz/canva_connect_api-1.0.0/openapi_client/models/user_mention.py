...
class UserMention(BaseModel):
    ...
    """ # noqa: E501
    tag: StrictStr = Field(description="The mention tag for the user mentioned in the comment thread or reply content. This has the format of the user's user ID and team ID separated by a colon (`user_id:team_id`).")
    user: TeamUser
    __properties: ClassVar[List[str]] = ["tag", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tag": obj.get("tag"),
            "user": TeamUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
