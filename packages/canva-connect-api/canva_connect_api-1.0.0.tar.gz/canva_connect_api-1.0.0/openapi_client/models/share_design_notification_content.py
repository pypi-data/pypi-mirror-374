...
class ShareDesignNotificationContent(BaseModel):
    """
    ...
    share_url: StrictStr = Field(description="A URL that the user who receives the notification can use to access the shared design.")
    share: Optional[ShareAction] = None
    __properties: ClassVar[List[str]] = ["type", "triggering_user", "receiving_team_user", "design", "share_url", "share"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['share_design']):
            raise ValueError("must be one of enum values ('share_design')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "share": ShareAction.from_dict(obj["share"]) if obj.get("share") is not None else None
        })
        return _obj
