...
class TeamUser(BaseModel):
    ...
    team_id: Optional[StrictStr] = Field(default=None, description="The ID of the user's Canva Team.")
    display_name: Optional[StrictStr] = Field(default=None, description="The name of the user as shown in the Canva UI.")
    __properties: ClassVar[List[str]] = ["user_id", "team_id", "display_name"]
