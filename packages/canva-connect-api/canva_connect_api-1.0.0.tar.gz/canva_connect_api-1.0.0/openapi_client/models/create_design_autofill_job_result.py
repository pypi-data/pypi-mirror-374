...
class CreateDesignAutofillJobResult(BaseModel):
    """
    Design has been created and saved to user's root folder.
    """ # noqa: E501
    type: StrictStr
    design: DesignSummary
    __properties: ClassVar[List[str]] = ["type", "design"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['create_design']):
            raise ValueError("must be one of enum values ('create_design')")
        return value
