...
class CreateDesignExportJobRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    design_id: StrictStr = Field(description="The design ID.")
    format: ExportFormat
    __properties: ClassVar[List[str]] = ["design_id", "format"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "format": ExportFormat.from_dict(obj["format"]) if obj.get("format") is not None else None
        })
        return _obj
