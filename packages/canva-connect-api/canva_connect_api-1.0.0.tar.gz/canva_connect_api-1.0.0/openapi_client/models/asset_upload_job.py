...
class AssetUploadJob(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the asset upload job.")
    status: AssetUploadStatus
    error: Optional[AssetUploadError] = None
    asset: Optional[Asset] = None
    __properties: ClassVar[List[str]] = ["id", "status", "error", "asset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": AssetUploadError.from_dict(obj["error"]) if obj.get("error") is not None else None,
