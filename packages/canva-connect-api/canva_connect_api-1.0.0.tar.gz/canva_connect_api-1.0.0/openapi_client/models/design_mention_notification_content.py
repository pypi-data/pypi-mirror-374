...
class DesignMentionNotificationContent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "triggering_user", "receiving_team_user", "design"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['design_mention']):
            raise ValueError("must be one of enum values ('design_mention')")
        return value
