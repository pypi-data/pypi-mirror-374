...
class DesignPage(BaseModel):
    ...
    """ # noqa: E501
    index: Annotated[int, Field(le=500, strict=True, ge=1)] = Field(description="The index of the page in the design. The first page in a design has the index value `1`.")
    thumbnail: Optional[Thumbnail] = None
    __properties: ClassVar[List[str]] = ["index", "thumbnail"]
