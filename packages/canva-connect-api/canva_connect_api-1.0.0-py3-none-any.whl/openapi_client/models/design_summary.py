...
class DesignSummary(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="URL of the design.")
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "url", "thumbnail", "urls", "created_at", "updated_at", "page_count"]
