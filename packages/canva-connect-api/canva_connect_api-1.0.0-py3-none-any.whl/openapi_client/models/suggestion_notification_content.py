...
class SuggestionNotificationContent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "triggering_user", "receiving_team_user", "design", "suggestion_event_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of suggestion_event_type
        if self.suggestion_event_type:
            _dict['suggestion_event_type'] = self.suggestion_event_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestion_event_type": SuggestionEventType.from_dict(obj["suggestion_event_type"]) if obj.get("suggestion_event_type") is not None else None
        })
        return _obj
