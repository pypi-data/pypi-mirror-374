...
class CustomDesignTypeInput(BaseModel):
    """
    Provide the width and height to define a custom design type.
    """ # noqa: E501
    type: StrictStr
    width: Annotated[int, Field(le=8000, strict=True, ge=40)] = Field(description="The width of the design, in pixels.")
    height: Annotated[int, Field(le=8000, strict=True, ge=40)] = Field(description="The height of the design, in pixels.")
