...
class GetDesignPagesResponse(BaseModel):
    """
    Successful response from a `getDesignPages` request.
    """ # noqa: E501
    items: List[DesignPage] = Field(description="The list of pages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DesignPage.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
