...
class DatasetImageValue(BaseModel):
    """
    If the data field is an image field.
    """ # noqa: E501
    type: StrictStr
    asset_id: StrictStr = Field(description="`asset_id` of the image to insert into the template element.")
    __properties: ClassVar[List[str]] = ["type", "asset_id"]
