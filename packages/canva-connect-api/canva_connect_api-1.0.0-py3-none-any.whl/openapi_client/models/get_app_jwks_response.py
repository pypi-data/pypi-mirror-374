...
class GetAppJwksResponse(BaseModel):
    """
    GetAppJwksResponse
    """ # noqa: E501
    keys: List[JsonWebKey] = Field(description="The value of the \"keys\" parameter is an array of JWK values. The order of keys has no meaning.")
