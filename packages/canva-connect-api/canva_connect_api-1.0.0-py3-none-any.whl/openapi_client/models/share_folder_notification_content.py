...
class ShareFolderNotificationContent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "triggering_user", "receiving_team_user", "folder", "share"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['share_folder']):
            raise ValueError("must be one of enum values ('share_folder')")
        return value
