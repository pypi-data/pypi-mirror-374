...
class DataTableRow(BaseModel):
    ...
    """ # noqa: E501
    cells: Annotated[List[DataTableCell], Field(max_length=20)] = Field(description="Cells of data in row.  All rows must have the same number of cells.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cells": [DataTableCell.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None
        })
        return _obj
