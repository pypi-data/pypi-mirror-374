...
@shutup
def sample_instance(r_str, max_tries=50):
...
class RegexInduction(Task):
    ...
    def generate(self):
        ...
        while len(negatives) < self.config.n_ex:
            ...
            if not re.fullmatch(meta.regex, s):
                negatives.append(s)
