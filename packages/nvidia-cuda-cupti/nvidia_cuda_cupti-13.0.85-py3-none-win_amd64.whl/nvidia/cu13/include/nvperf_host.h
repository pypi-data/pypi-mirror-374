...
#define NVPW_DIM_UNIT_DEFINED
    typedef enum NVPW_DimUnitName
    {
        ...
        NVPW_DIM_UNIT_BRANCH_TARGETS = 3746602690,
        NVPW_DIM_UNIT_BYTES = 3797850191,
        NVPW_DIM_UNIT_CGAS = 2067066462,
        NVPW_DIM_UNIT_CROP_SUBPACKETS = 175697354,
        ...
        NVPW_DIM_UNIT_GCC_REQUESTS = 2855402624,
        ...
        NVPW_DIM_UNIT_ZROP_SUBPACKETS = 1657246246,
        NVPW_DIM_UNIT_Z_OCCLUDERS = 2718134770
    } NVPW_DimUnitName;
