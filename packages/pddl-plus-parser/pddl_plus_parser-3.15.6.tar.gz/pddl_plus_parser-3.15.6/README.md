...
<!-- 
This is the main title of the README file, displayed at the center of the page.
It introduces the project name "PDDL Plus Parser" in bold.
-->
...
<!-- 
This section contains badges that provide quick information about the project:
- PyPI version
...
<!-- 
This section contains additional badges for:
...
<!-- 
This section highlights tools and standards used in the project:
- flake8 for linting
...
<!-- 
This section is reserved for listing the dependencies or prerequisites required to use the project.
-->

## Features

<!-- 
This section is reserved for describing the key features of the project.
-->

## Changelog:

<!-- 
This section provides a detailed version history of the project, including:
- New features
- Bug fixes
...
* version 3.15.5 - Added default parameters to the initialization of the Action class.
* version 3.15.6 - Added hash functionality to the ActionCall class.