...
# NOTE: StreamValidator is provided in satya.validator. We avoid importing it here
# to prevent eager initialization of the Rust extension during package import.
