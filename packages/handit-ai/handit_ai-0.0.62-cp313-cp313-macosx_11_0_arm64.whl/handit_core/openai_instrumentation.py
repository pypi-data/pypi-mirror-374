...
def patch_openai() -> None:
    ...
    # Skip complex chain patching for now - let profiler handle it
    print("DEBUG: Skipping chain patching, relying on profiler")
...
# Removed complex chain patching - using simpler approach
