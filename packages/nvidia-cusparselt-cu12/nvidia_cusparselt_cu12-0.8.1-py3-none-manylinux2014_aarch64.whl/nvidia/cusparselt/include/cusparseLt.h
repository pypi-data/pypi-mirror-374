...
typedef struct { alignas(16) uint8_t data[512]; } cusparseLtHandle_t;
                              
typedef struct { alignas(16) uint8_t data[512]; } cusparseLtMatDescriptor_t;
                              
typedef struct { alignas(16) uint8_t data[512]; } cusparseLtMatmulDescriptor_t;
                              
typedef struct { alignas(16) uint8_t data[512]; } cusparseLtMatmulAlgSelection_t;
                              
typedef struct { alignas(16) uint8_t data[512]; } cusparseLtMatmulPlan_t;
