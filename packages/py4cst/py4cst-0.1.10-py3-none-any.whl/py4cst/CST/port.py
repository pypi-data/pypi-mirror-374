...
class Port(VBAObjWrapper):
    ...
    def set_orientation(self, orientation: str):
        self.cache_method('Orientation', orientation)

    def set_coordinates(self, coordinates: str):
        self.cache_method('Coordinates', coordinates)
    ...
    def add_potential_numerically(self, mode_set: int, potential: str, u_pos: float, v_pos: float):
        self.cache_method('AddPotentialNumerically', mode_set, potential, u_pos, v_pos)

    def add_potential_picked(self, mode_set: int, potential: str, solid_name: str, face_id: int):
        self.cache_method('AddPotentialPicked', mode_set, potential, solid_name, face_id)

    def add_potential_edge_picked(
            self, mode_set: int, potential: str, solid_name: str, edge_id: int):
        self.cache_method('AddPotentialEdgePicked', mode_set, potential, solid_name, edge_id)
    ...
    def get_mode_type(self, port_number: int, mode_number: int) -> str:
        return self.query_method_str('GetModeType', port_number, mode_number)
    ...
    def get_line_impedance_broad_by_index(
        ...
        return self.query_method_float(
            'GetLineImpedanceBroadByIndex', port_number, mode_number, index)
    ...
    def get_type(self, port_number: int) -> str:
        return self.query_method_str('GetType', port_number)
