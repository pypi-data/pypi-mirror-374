...
class AgentV1alpha1SpecToolsInnerLabelSelector(BaseModel):
    """
    A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
    """ # noqa: E501
    match_expressions: Optional[List[AgentV1alpha1SpecToolsInnerLabelSelectorMatchExpressionsInner]] = Field(default=None, description="matchExpressions is a list of label selector requirements. The requirements are ANDed.", alias="matchExpressions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentV1alpha1SpecToolsInnerLabelSelector from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentV1alpha1SpecToolsInnerLabelSelector from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "matchExpressions": [AgentV1alpha1SpecToolsInnerLabelSelectorMatchExpressionsInner.from_dict(_item) for _item in obj["matchExpressions"]] if obj.get("matchExpressions") is not None else None,
