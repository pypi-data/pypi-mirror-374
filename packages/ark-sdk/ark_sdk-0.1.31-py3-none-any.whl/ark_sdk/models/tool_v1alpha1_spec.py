...
from ark_sdk.models.tool_v1alpha1_spec_fetcher import ToolV1alpha1SpecFetcher
...
class ToolV1alpha1Spec(BaseModel):
    ...
    fetcher: Optional[ToolV1alpha1SpecFetcher] = None
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["annotations", "description", "fetcher", "inputSchema", "mcp", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['fetcher', 'mcp']):
            raise ValueError("must be one of enum values ('fetcher', 'mcp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fetcher
        if self.fetcher:
            _dict['fetcher'] = self.fetcher.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fetcher": ToolV1alpha1SpecFetcher.from_dict(obj["fetcher"]) if obj.get("fetcher") is not None else None,
