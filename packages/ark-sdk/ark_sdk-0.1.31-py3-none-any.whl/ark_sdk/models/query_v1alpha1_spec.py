...
from ark_sdk.models.agent_v1alpha1_spec_tools_inner_label_selector import AgentV1alpha1SpecToolsInnerLabelSelector
...
class QueryV1alpha1Spec(BaseModel):
    ...
    evaluator_selector: Optional[AgentV1alpha1SpecToolsInnerLabelSelector] = Field(default=None, alias="evaluatorSelector")
    ...
    selector: Optional[AgentV1alpha1SpecToolsInnerLabelSelector] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evaluatorSelector": AgentV1alpha1SpecToolsInnerLabelSelector.from_dict(obj["evaluatorSelector"]) if obj.get("evaluatorSelector") is not None else None,
            ...
            "selector": AgentV1alpha1SpecToolsInnerLabelSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
