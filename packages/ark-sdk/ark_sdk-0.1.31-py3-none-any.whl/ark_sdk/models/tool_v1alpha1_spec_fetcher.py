...
class ToolV1alpha1SpecFetcher(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["headers", "method", "timeout", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolV1alpha1SpecFetcher from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolV1alpha1SpecFetcher from a dict"""
        if obj is None:
            return None
