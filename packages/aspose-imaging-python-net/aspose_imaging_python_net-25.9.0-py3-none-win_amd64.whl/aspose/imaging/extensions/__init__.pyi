...
class StreamExtensions:
    ...
    @staticmethod
    def create_memory_stream() -> io.RawIOBase:
    ...
    @staticmethod
    def create_memory_stream_with_size(capacity: int) -> io.RawIOBase:
    ...
    @staticmethod
    def create_memory_stream_from_bytes(array: bytes) -> io.RawIOBase:
    ...
    @staticmethod
    def create_file_stream(path: str, file_mode: System.IO.FileMode) -> io.RawIOBase:
