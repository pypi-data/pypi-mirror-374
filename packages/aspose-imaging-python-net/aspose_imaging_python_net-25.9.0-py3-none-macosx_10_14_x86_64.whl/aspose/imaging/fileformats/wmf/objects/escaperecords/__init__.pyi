...
class WmfEscapeEnhancedMetafile(WmfEscapeRecordBase):
    ...
    def comment_identifier(self, value : int):
        ...
    ...
    @comment_type.setter
    def comment_type(self, value : int):
        ...
    ...
    def comment_record_count(self, value : int):
        ...
    ...
    def current_record_size(self, value : int):
        ...
    ...
    def remaining_bytes(self, value : int):
        ...
    ...
    def enhanced_metafile_data_size(self, value : int):
        ...
    
    @property
    def enhanced_metafile_data(self) -> bytes:
        ...
    
    @enhanced_metafile_data.setter
    def enhanced_metafile_data(self, value : bytes):
        ...
...
class WmfEscapePostScript(WmfEscapeRecordBase):
    ...
    def post_script_part(self, value : str):
        ...
