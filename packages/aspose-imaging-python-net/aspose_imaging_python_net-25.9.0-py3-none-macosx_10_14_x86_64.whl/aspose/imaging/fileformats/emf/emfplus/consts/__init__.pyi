...
class EmfPlusImageEffectsIdentifiers:
    ...
    @classmethod
    @property
    def BLUR_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def BRIGHTNESS_CONTRAST_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def COLOR_BALANCE_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def COLOR_CURVE_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def COLOR_LOOKUP_TABLE_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def COLOR_MATRIX_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def HUE_SATURATION_LIGHTNESS_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def LEVELS_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def RED_EYE_CORRECTION_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def SHARPEN_EFFECT_GUID(cls) -> str:
        ...
    
    @classmethod
    @property
    def TINT_EFFECT_GUID(cls) -> str:
        ...
