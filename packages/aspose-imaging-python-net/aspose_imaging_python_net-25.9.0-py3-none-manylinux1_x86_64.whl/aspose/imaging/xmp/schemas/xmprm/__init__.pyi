...
class XmpRightsManagementPackage(aspose.imaging.xmp.XmpPackage):
    ...
    def set_marked_as_right_management(self, value: bool):
    ...
    def set_usage_terms(self, usage_terms: aspose.imaging.xmp.LangAlt):
        '''Sets the usage terms.
        
        :param usage_terms: The usage terms.'''
        ...
    
    def set_web_statement(self, web_statement_url: str):
