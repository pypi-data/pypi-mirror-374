...
class SvgGraphics2D:
    ...
    @overload
    def __init__(self, image: aspose.imaging.fileformats.svg.SvgImage):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def draw_image(self, image: aspose.imaging.RasterImage, origin: aspose.imaging.Point):
    ...
    @overload
    def draw_image(self, image: aspose.imaging.RasterImage, origin: aspose.imaging.Point, size: aspose.imaging.Size):
    ...
    @overload
    def draw_image(self, src_rect: aspose.imaging.Rectangle, dest_rect: aspose.imaging.Rectangle, image: aspose.imaging.RasterImage):
    ...
    def draw_image_point_size(self, image: aspose.imaging.RasterImage, origin: aspose.imaging.Point, size: aspose.imaging.Size):
        '''Draws the specified image of the specified size at the specified location.
    ...
    def draw_image_src_dst_rects(self, src_rect: aspose.imaging.Rectangle, dest_rect: aspose.imaging.Rectangle, image: aspose.imaging.RasterImage):
        '''Draws the specified portion of the specified image at the specified location and with the specified size.
    ...
    def fill_arc(self, pen: aspose.imaging.Pen, brush: aspose.imaging.Brush, rect: aspose.imaging.Rectangle, start_angle: float, arc_angle: float):
    ...
    def draw_cubic_bezier(self, pen: aspose.imaging.Pen, pt1: aspose.imaging.PointF, pt2: aspose.imaging.PointF, pt3: aspose.imaging.PointF, pt4: aspose.imaging.PointF):
    ...
    def draw_string(self, font: aspose.imaging.Font, text: str, origin: aspose.imaging.Point, text_color: aspose.imaging.Color):
    ...
    def fill_rectangle(self, pen: aspose.imaging.Pen, brush: aspose.imaging.Brush, x: int, y: int, width: int, height: int):
        '''Fills the rectangle.
