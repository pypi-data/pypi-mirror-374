...
class SenseX1000Base(object):
    ...
    class AcqDType(Enum):
        ...
        def info(self) -> 'SenseX1000Base.AcqDTypeInfo':
            ...
            return {
                ...
                self.F32RLE.value: SenseX1000Base.AcqDTypeInfo(
                ...
                self.F32RILE.value: SenseX1000Base.AcqDTypeInfo(
                ...
                self.F64RLE.value: SenseX1000Base.AcqDTypeInfo(
                ...
                self.F64RILE.value: SenseX1000Base.AcqDTypeInfo(
    ...
    class AcqData(NamedTuple):
        ...
        def to_hdf5(self, parent: Union['h5py.Group', str], name: Optional[str] = None, format='normal', **kwargs) -> 'h5py.Group':
