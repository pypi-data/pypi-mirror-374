...
import { choice, durationToString, vars, createToast, createIcon, prefetch } from "../util.js";
...
class Queue {
    ...
    async add(track, manual, top = false) {
        prefetch(track.getAudioURL(settings.getAudioType()));
    ...
    #updateHtml() {
        ...
        for (const queuedTrack of this.queuedTracks) {
            ...
            const imageUrl = queuedTrack.track.getCoverURL(settings.getImageQuality(), settings.getMemeMode());
