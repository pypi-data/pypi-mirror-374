...
class Colors:
    ...
    @classmethod
    def get_named_colors_mapping(cls) -> dict:
        """
        ...
        """
        return cls._colors_full_map



    @classmethod
    def to_rgb(cls, color_name :str) -> (float, float, float):
        """
        ...
        # Convert hex to RGB components (0-255 range)
    ...
    def lighten_color(cls, color_name :str, factor=0.85) -> str:
        ...
        """
        # Convert CSS color name to RGB : a triplet of numbers in the (0-1 range)
        rgb = Colors.to_rgb(color_name)    # rgb = mcolors.to_rgb(color_name)
