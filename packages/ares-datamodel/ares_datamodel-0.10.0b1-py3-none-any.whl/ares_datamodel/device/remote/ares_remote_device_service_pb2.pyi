...
class ExecuteCommandRequest(_message.Message):
    ...
    class ArgumentsEntry(_message.Message):
        ...
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[_ares_struct_pb2.AresValue, _Mapping]] = ...) -> None: ...
    COMMAND_NAME_FIELD_NUMBER: _ClassVar[int]
    ARGUMENTS_FIELD_NUMBER: _ClassVar[int]
    command_name: str
    arguments: _containers.MessageMap[str, _ares_struct_pb2.AresValue]
    def __init__(self, command_name: _Optional[str] = ..., arguments: _Optional[_Mapping[str, _ares_struct_pb2.AresValue]] = ...) -> None: ...
