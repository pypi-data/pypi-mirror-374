...
class TradingAgent:
    ...
    def _create_analysis_prompt(self, symbol: str, timeframe: str) -> str:
        """Create analysis prompt for the given symbol and timeframe."""
        return f"""
        Provide a comprehensive technical analysis for {symbol.upper()} cryptocurrency.
        
        Analysis Requirements:
        - Focus on {timeframe} timeframe with multi-timeframe context
        - Include current market state and momentum analysis
        - Cover key technical indicators (RSI, MACD, moving averages)
        - Identify critical support and resistance levels
        - Provide actionable trading outlook with risk assessment
        
        Format: Structure your response with clear sections covering market state,
        timeframe analysis, indicators, trading levels, and concise outlook.
