...
class ReportSchema(BaseModel):
    """Structured schema for market analysis reports"""
    title: str = Field(..., description="Report title starting with **MARKET ANALYSIS:** or **COMPREHENSIVE TECHNICAL ANALYSIS:**")
    market_state: str = Field(..., description="Initial overall market state analysis")
    timeframe_analysis: str = Field(..., description="Multi-timeframe technical analysis")
    indicator_analysis: str = Field(..., description="Advanced indicator analysis")
    trading_levels: str = Field(..., description="Key trading levels and support/resistance")
    outlook: str = Field(..., description="Concise outlook and strategic bias")
...
class LLMCore:
    ...
    async def complete_structured(
        ...
        model: str = "accounts/fireworks/models/deepseek-r1-distill-llama-70b",
