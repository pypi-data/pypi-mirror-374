...
def _display_rich_analysis(result, symbol: str):
    ...
    try:
        if hasattr(result, 'dict'):
            ...
            # Timeframe analysis
            console.print(Panel(data['timeframe_analysis'], title="⏰ Timeframe Analysis", border_style="cyan"))
            
            # Indicators
            console.print(Panel(data['indicator_analysis'], title="📊 Technical Indicators", border_style="yellow"))
            
            # Trading levels
            console.print(Panel(data['trading_levels'], title="🎯 Trading Levels", border_style="magenta"))
