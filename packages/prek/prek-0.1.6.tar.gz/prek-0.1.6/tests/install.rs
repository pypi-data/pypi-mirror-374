...
fn install() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters.clone() },
        {
            ...
            ARGS=(hook-impl --hook-type=post-commit --config=".pre-commit-config.yaml")
...
fn install_with_hooks() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --config="[TEMP_DIR]/.pre-commit-config.yaml")
...
fn init_template_dir() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters.clone() },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --config=".pre-commit-config.yaml" --skip-on-missing-config)
    ...
    insta::with_settings!(
        { filters => filters.clone() },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --config="non-exist-config" --skip-on-missing-config)
