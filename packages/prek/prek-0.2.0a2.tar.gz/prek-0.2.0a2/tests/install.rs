...
fn install_with_hooks() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --cd="[TEMP_DIR]/")
...
fn workspace_install() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters.clone() },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --cd="[TEMP_DIR]/project3")
...
fn workspace_init_template_dir() -> anyhow::Result<()> {
    ...
    insta::with_settings!(
        { filters => filters.clone() },
        {
            ...
            ARGS=(hook-impl --hook-type=pre-commit --cd="[TEMP_DIR]/" --skip-on-missing-config)
