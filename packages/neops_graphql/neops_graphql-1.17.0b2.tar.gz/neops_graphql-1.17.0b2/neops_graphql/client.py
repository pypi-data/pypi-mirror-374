...
class Client(AsyncBaseClient):
    ...
    async def get_and_lock_resources(
        ...
        device_group_query: Union[Optional[str], UnsetType] = UNSET,
        device_query: Union[Optional[str], UnsetType] = UNSET,
        interface_query: Union[Optional[str], UnsetType] = UNSET,
        **kwargs: Any
    ) -> GetAndLockResources:
        query = gql(
            """
            mutation getAndLockResources($reference: String!, $deviceGroupIds: [ID], $deviceIds: [ID], $interfaceIds: [ID], $deviceGroupQuery: String, $deviceQuery: String, $interfaceQuery: String) {
              getAndLockResources(
                reference: $reference
