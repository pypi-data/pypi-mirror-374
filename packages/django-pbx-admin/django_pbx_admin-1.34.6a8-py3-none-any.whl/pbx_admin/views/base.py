...
class AdminListView(  # type: ignore
    ...
    def get_context_data(self, **kwargs):
        ...
        context["_current_queryset"] = queryset

        self.request._current_queryset = queryset
...
class AdminUpdateView(AdminSingleObjectView, UpdateView):
    success_message_template = _("%s was changed successfully.")
                    ...
                    (
                        ...
                        format_html(
                            ...
                            format_html_join(
                                ...
                                (
                                    (
                                        protected_obj._meta.verbose_name,
                                        protected_obj,
                                        protected_obj.pk,
                                    )
