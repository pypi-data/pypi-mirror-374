...
# our own api errors
from abv._utils.request import APIError, APIErrors
from abv.api.core import ApiError

# fern api errors
from abv.api.resources.commons.errors import (
    AccessDeniedError,
    Error,
...
from abv.api.resources.health.errors import ServiceUnavailableError

SUPPORT_URL = "https://abv.dev/support"
API_DOCS_URL = "https://api.reference.abv.dev"
RBAC_DOCS_URL = "https://abv.dev/docs/rbac"
INSTALLATION_DOCS_URL = "https://abv.dev/docs/sdk/typescript/guide"
RATE_LIMITS_URL = "https://abv.dev/faq/all/api-limits"
PYPI_PACKAGE_URL = "https://pypi.org/project/abv/"
