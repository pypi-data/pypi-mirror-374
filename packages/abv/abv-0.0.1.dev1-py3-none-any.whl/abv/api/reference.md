# Reference
## AnnotationQueues
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">list_queues</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv.client import FernABV
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">create_queue</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateAnnotationQueueRequest
from abv.client import FernABV
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">get_queue</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">list_queue_items</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">get_queue_item</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">create_queue_item</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import AnnotationQueueObjectType, CreateAnnotationQueueItemRequest
from abv.client import FernABV
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">update_queue_item</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import UpdateAnnotationQueueItemRequest
from abv.client import FernABV
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">delete_queue_item</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">create_queue_assignment</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import AnnotationQueueAssignmentRequest
from abv.client import FernABV
...
<details><summary><code>client.annotation_queues.<a href="src/abv/resources/annotation_queues/client.py">delete_queue_assignment</a>(...)</code></summary>
<dl>
<dd>
...
## Comments
<details><summary><code>client.comments.<a href="src/abv/resources/comments/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateCommentRequest
from abv.client import FernABV
...
<details><summary><code>client.comments.<a href="src/abv/resources/comments/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.comments.<a href="src/abv/resources/comments/client.py">get_by_id</a>(...)</code></summary>
<dl>
<dd>
...
**comment_id:** `str` — The unique abv identifier of a comment
...
## DatasetItems
<details><summary><code>client.dataset_items.<a href="src/abv/resources/dataset_items/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateDatasetItemRequest
from abv.client import FernABV
...
<details><summary><code>client.dataset_items.<a href="src/abv/resources/dataset_items/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.dataset_items.<a href="src/abv/resources/dataset_items/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.dataset_items.<a href="src/abv/resources/dataset_items/client.py">delete</a>(...)</code></summary>
<dl>
<dd>
...
## DatasetRunItems
<details><summary><code>client.dataset_run_items.<a href="src/abv/resources/dataset_run_items/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateDatasetRunItemRequest
from abv.client import FernABV
...
<details><summary><code>client.dataset_run_items.<a href="src/abv/resources/dataset_run_items/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
## Datasets
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateDatasetRequest
from abv.client import FernABV
...
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">get_run</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">delete_run</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.datasets.<a href="src/abv/resources/datasets/client.py">get_runs</a>(...)</code></summary>
<dl>
<dd>
...
## Health
<details><summary><code>client.health.<a href="src/abv/resources/health/client.py">health</a>()</code></summary>
<dl>
<dd>
...
## Ingestion
<details><summary><code>client.ingestion.<a href="src/abv/resources/ingestion/client.py">batch</a>(...)</code></summary>
<dl>
<dd>
...
Batched ingestion for ABV Tracing.
If you want to use tracing via the API, such as to build your own ABV client implementation, this is the only API route you need to implement.

Within each batch, there can be multiple events.
Each event has a type, an id, a timestamp, metadata and a body.
Internally, we refer to this as the "event envelope" as it tells us something about the event but not the trace.
We use the event id within this envelope to deduplicate messages to avoid processing the same event twice, i.e. the event id should be unique per request.
The event.body.id is the ID of the actual trace and will be used for updates and will be visible within the ABV App.
I.e. if you want to update a trace, you'd use the same body id, but separate event IDs.

Notes:
- Introduction to data model: https://abv.dev/docs/tracing-data-model
...
```python
from abv import IngestionEvent_ScoreCreate, ScoreBody
from abv.client import FernABV
...
**metadata:** `typing.Optional[typing.Any]` — Optional. Metadata field used by the ABV SDKs for debugging.
...
## LlmConnections
<details><summary><code>client.llm_connections.<a href="src/abv/resources/llm_connections/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.llm_connections.<a href="src/abv/resources/llm_connections/client.py">upsert</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import LlmAdapter, UpsertLlmConnectionRequest
from abv.client import FernABV
...
## Media
<details><summary><code>client.media.<a href="src/abv/resources/media/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
**media_id:** `str` — The unique abv identifier of a media record
...
<details><summary><code>client.media.<a href="src/abv/resources/media/client.py">patch</a>(...)</code></summary>
<dl>
<dd>
...
from abv import PatchMediaBody
from abv.client import FernABV
...
<details><summary><code>client.media.<a href="src/abv/resources/media/client.py">get_upload_url</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import GetMediaUploadUrlRequest, MediaContentType
from abv.client import FernABV
...
## Metrics
<details><summary><code>client.metrics.<a href="src/abv/resources/metrics/client.py">metrics</a>(...)</code></summary>
<dl>
<dd>
...
Get metrics from the ABV project using a query object
</dd>
</dl>
</dd>
</dl>
...
## Models
<details><summary><code>client.models.<a href="src/abv/resources/models/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateModelRequest
from abv.client import FernABV
...
<details><summary><code>client.models.<a href="src/abv/resources/models/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.models.<a href="src/abv/resources/models/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.models.<a href="src/abv/resources/models/client.py">delete</a>(...)</code></summary>
<dl>
<dd>
...
Delete a model. Cannot delete models managed by ABV. You can create your own definition with the same modelName to override the definition though.
</dd>
</dl>
</dd>
</dl>
...
## Observations
<details><summary><code>client.observations.<a href="src/abv/resources/observations/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
**observation_id:** `str` — The unique abv identifier of an observation, can be an event, span or generation
...
<details><summary><code>client.observations.<a href="src/abv/resources/observations/client.py">get_many</a>(...)</code></summary>
<dl>
<dd>
...
## Organizations
<details><summary><code>client.organizations.<a href="src/abv/resources/organizations/client.py">get_organization_memberships</a>()</code></summary>
<dl>
<dd>
...
<details><summary><code>client.organizations.<a href="src/abv/resources/organizations/client.py">update_organization_membership</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import MembershipRequest, MembershipRole
from abv.client import FernABV
...
<details><summary><code>client.organizations.<a href="src/abv/resources/organizations/client.py">get_project_memberships</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.organizations.<a href="src/abv/resources/organizations/client.py">update_project_membership</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.organizations.<a href="src/abv/resources/organizations/client.py">get_organization_projects</a>()</code></summary>
<dl>
<dd>
...
## Projects
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">get</a>()</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">update</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">delete</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">get_api_keys</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">create_api_key</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="src/abv/resources/projects/client.py">delete_api_key</a>(...)</code></summary>
<dl>
<dd>
...
## PromptVersion
<details><summary><code>client.prompt_version.<a href="src/abv/resources/prompt_version/client.py">update</a>(...)</code></summary>
<dl>
<dd>
...
**new_labels:** `typing.Sequence[str]` — New labels for the prompt version. Labels are unique across versions. The "latest" label is reserved and managed by ABV.
...
## Prompts
<details><summary><code>client.prompts.<a href="src/abv/resources/prompts/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.prompts.<a href="src/abv/resources/prompts/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.prompts.<a href="src/abv/resources/prompts/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
## Scim
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">get_service_provider_config</a>()</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">get_resource_types</a>()</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">get_schemas</a>()</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">list_users</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">create_user</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">get_user</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.scim.<a href="src/abv/resources/scim/client.py">delete_user</a>(...)</code></summary>
<dl>
<dd>
...
## ScoreConfigs
<details><summary><code>client.score_configs.<a href="src/abv/resources/score_configs/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateScoreConfigRequest, ScoreDataType
from abv.client import FernABV
...
<details><summary><code>client.score_configs.<a href="src/abv/resources/score_configs/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.score_configs.<a href="src/abv/resources/score_configs/client.py">get_by_id</a>(...)</code></summary>
<dl>
<dd>
...
**config_id:** `str` — The unique abv identifier of a score config
...
## ScoreV2
<details><summary><code>client.score_v_2.<a href="src/abv/resources/score_v_2/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.score_v_2.<a href="src/abv/resources/score_v_2/client.py">get_by_id</a>(...)</code></summary>
<dl>
<dd>
...
**score_id:** `str` — The unique abv identifier of a score
...
## Score
<details><summary><code>client.score.<a href="src/abv/resources/score/client.py">create</a>(...)</code></summary>
<dl>
<dd>
...
```python
from abv import CreateScoreRequest
from abv.client import FernABV
...
<details><summary><code>client.score.<a href="src/abv/resources/score/client.py">delete</a>(...)</code></summary>
<dl>
<dd>
...
## Sessions
<details><summary><code>client.sessions.<a href="src/abv/resources/sessions/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.sessions.<a href="src/abv/resources/sessions/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
## Trace
<details><summary><code>client.trace.<a href="src/abv/resources/trace/client.py">get</a>(...)</code></summary>
<dl>
<dd>
...
**trace_id:** `str` — The unique abv identifier of a trace
...
<details><summary><code>client.trace.<a href="src/abv/resources/trace/client.py">delete</a>(...)</code></summary>
<dl>
<dd>
...
**trace_id:** `str` — The unique abv identifier of the trace to delete
...
<details><summary><code>client.trace.<a href="src/abv/resources/trace/client.py">list</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.trace.<a href="src/abv/resources/trace/client.py">delete_multiple</a>(...)</code></summary>
<dl>
<dd>
