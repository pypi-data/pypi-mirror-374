...
- Basic authentication with ABV API keys
...
from abv._client.utils import span_formatter
from abv.logger import abv_logger
from abv.version import __version__ as abv_version
...
class ABVSpanProcessor(BatchSpanProcessor):
    ...
    6. Authentication with ABV API using Basic Auth
