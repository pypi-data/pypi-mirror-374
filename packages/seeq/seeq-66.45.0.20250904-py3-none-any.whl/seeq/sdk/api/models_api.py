...
class ModelsApi(object):
    ...
    def apply_model(self, **kwargs):
        """
        Apply a model once by providing inputs to the model's features
        ...
        :param ModelApplicationInputV1 body: (required)
    ...
    def apply_model_to_table(self, **kwargs):
        """
        Apply a model to a table definition
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
    ...
    def edit_model(self, **kwargs):
        """
        Edit a model by ID. The full model must be provided.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
