...
class GlitchFile(ABC):
    ...
    def has_readout_sci_carrier(self, mosa: MosaID) -> bool:
        """Wether the file has readout_sci_carrier datasets for given MOSA
    ...
    def has_readout_sci_usbs(self, mosa: MosaID) -> bool:
        """Wether the file has readout_sci_usbs datasets for given MOSA
    ...
    def has_readout_tmi_carriers(self, mosa: MosaID) -> bool:
        """Wether the file has readout_tmi_carriers datasets for given MOSA
    ...
    def has_readout_tmi_usbs(self, mosa: MosaID) -> bool:
        """Wether the file has readout_tmi_usbs  datasets for given MOSA
    ...
    def has_readout_ref_carriers(self, mosa: MosaID) -> bool:
        """Wether the file has readout_ref_carriers  datasets for given MOSA
    ...
    def has_readout_ref_usbs(self, mosa: MosaID) -> bool:
        """Wether the file has readout_ref_usbs datasets for given MOSA
    ...
    def has_test_mass(self, mosa: MosaID) -> bool:
        """Wether the file has test mass (tm) datasets for given MOSA
    ...
    def has_lasers(self, mosa: MosaID) -> bool:
        """Wether the file has lasers datasets for given MOSA
...
class GlitchFileV14(GlitchFile):
    ...
    def has_readout_ref_usbs(self, mosa: MosaID) -> bool:
        """Wether the file has readout_ref_usbs datasets"""
