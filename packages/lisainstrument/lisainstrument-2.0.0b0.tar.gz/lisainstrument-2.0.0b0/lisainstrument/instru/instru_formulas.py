...
@for_each_sat
@stream_expression(np.float64)
def scet_wrt_tdb_withinitial(
    t_: np.ndarray,
    tps_wrt_tdb_: np.ndarray | float,
    ...
    *,
    ...
    """Compute scet_wrt_tdb_withinitial"""
    tplus = t_ + tps_wrt_tdb_
    return (
        tps_wrt_tdb_
        + clock_offsets
        ...
        + tps_wrt_tdb_ * clock_noise_fluctuations_covering_telemetry_
...
def moc_time_correlations(
    ...
    scet_wrt_tdb_telemetry_: np.ndarray | float,
) -> np.ndarray | float:
    """Compute moc_time_correlations"""
    return moc_time_correlation_noises_ + scet_wrt_tdb_telemetry_
...
def tps_mprs(
    ...
    """Compute tps_mprs"""
    return scet_wrt_tps_local_ - scet_wrt_tps_distant_ + ranging_noises_
