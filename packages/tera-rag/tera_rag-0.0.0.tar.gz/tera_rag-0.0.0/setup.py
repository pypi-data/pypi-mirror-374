...
version_file = 'tera_rag/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        entry_points={
            'console_scripts': ['tera-rag=tera_rag.cli.cli:run_cmd']
        },
