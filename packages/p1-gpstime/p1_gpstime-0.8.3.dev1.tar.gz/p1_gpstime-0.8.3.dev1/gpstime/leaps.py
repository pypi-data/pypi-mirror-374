...
ALLOW_EXPIRED = (os.environ.get('GPSTIME_ALLOW_EXPIRED', "False") in ('true', 'True', 'TRUE', '1'))
ALT_LEAP_SECONDS_DIR = os.environ.get('GPSTIME_LEAP_SECONDS_DIR', None)

LEAP_FILES = [
    None if ALT_LEAP_SECONDS_DIR is None else os.path.join(ALT_LEAP_SECONDS_DIR, 'leap-seconds.list'),
    None if ALT_LEAP_SECONDS_DIR is None else os.path.join(ALT_LEAP_SECONDS_DIR, 'leapseconds'),
