...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_pdb_tools:5.1.1--pyhdfd78af_0)
...
* Installation:
        ...
        pip install "biobb_pdb_tools>=5.1.1"
...
* Installation:
        ...
        conda install -c bioconda "biobb_pdb_tools>=5.1.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_pdb_tools:5.1.1--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_pdb_tools:5.1.1--pyhdfd78af_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_pdb_tools.sif https://depot.galaxyproject.org/singularity/biobb_pdb_tools:5.1.1--pyhdfd78af_0
