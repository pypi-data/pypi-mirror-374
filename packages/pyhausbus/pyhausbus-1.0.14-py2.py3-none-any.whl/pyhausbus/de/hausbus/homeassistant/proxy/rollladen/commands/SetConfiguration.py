...
class SetConfiguration:
  ...
  def _fromBytes(dataIn:bytearray, offset):
    return SetConfiguration(HausBusUtils.bytesToInt(dataIn, offset), HausBusUtils.bytesToInt(dataIn, offset), MOptions._fromBytes(dataIn, offset))

  def __str__(self):
    return f"SetConfiguration(closeTime={self.closeTime}, openTime={self.openTime}, options={self.options})"
