...
class Configuration:
  ...
  def __str__(self):
    return f"Configuration(maxOnTime={self.maxOnTime}, offDelayTime={self.offDelayTime}, timeBase={self.timeBase}, options={self.options}, disableBitIndex={self.disableBitIndex})"
