...
from pyhausbus.de.hausbus.homeassistant.proxy.analogEingang.data.Configuration import Configuration
from pyhausbus.de.hausbus.homeassistant.proxy.analogEingang.data.Status import Status

class AnalogEingang(ABusFeature):
  CLASS_ID:int = 36
  ...
  def create(deviceId:int, instanceId:int):
    return AnalogEingang(HausBusUtils.getObjectId(deviceId, 36, instanceId))
