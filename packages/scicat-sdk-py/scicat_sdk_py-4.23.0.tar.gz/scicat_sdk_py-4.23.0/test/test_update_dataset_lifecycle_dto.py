...
class TestUpdateDatasetLifecycleDto(unittest.TestCase):
    """UpdateDatasetLifecycleDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDatasetLifecycleDto:
        """Test UpdateDatasetLifecycleDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDatasetLifecycleDto`
        """
        model = UpdateDatasetLifecycleDto()
        if include_optional:
            return UpdateDatasetLifecycleDto(
                archivable = True,
                retrievable = True,
                publishable = True,
    ...
    def testUpdateDatasetLifecycleDto(self):
        """Test UpdateDatasetLifecycleDto"""
