...
class CreateDatablockDto(BaseModel):
    """
    CreateDatablockDto
    """ # noqa: E501
    ...
    dataset_id: StrictStr = Field(description="Persistent identifier of the dataset this datablock belongs to.", alias="datasetId")
    data_file_list: Annotated[List[DataFile], Field(min_length=1)] = Field(alias="dataFileList")
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "archiveId", "size", "packedSize", "chkAlg", "version", "datasetId", "dataFileList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDatablockDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDatablockDto from a dict"""
        if obj is None:
            return None
