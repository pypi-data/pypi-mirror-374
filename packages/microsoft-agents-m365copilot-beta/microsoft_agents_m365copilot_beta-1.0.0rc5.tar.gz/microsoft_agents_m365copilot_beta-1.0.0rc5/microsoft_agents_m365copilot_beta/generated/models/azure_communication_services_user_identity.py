...
@dataclass
class AzureCommunicationServicesUserIdentity(Identity, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AzureCommunicationServicesUserIdentity:
        """
