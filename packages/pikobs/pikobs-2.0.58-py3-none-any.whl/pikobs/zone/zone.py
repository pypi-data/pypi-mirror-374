...
def make_scatter(files_in,
      ...
      #  n_cpu=1
        ...
        if n_cpu==1:  
         ...
         print (f"in Paralle plots")
         time.sleep(4)
         with dask.distributed.Client(processes=True, threads_per_worker=1, 
                                          n_workers=n_cpu, 
                                          silence_logs=40) as client:
           delayed_funcs = [dask.delayed(pikobs.zone_plot)(mode, 
                                                              data_['region'],
                                                              data_['family'], 
                                                              data_['id_stn'],
                                                              datestart,
...
def arg_call():
    ...
    parser.add_argument('--fonction', nargs="+", default='omp', type=str, help="Function") 
