...
timeoutable = register_trait_decorator(TimeoutTrait)
deduplicatable = register_trait_decorator(DeduplicationTrait)
circuit_breakable = register_trait_decorator(CircuitBreakerTrait)
