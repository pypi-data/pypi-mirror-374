...
def _handle_hestia_indicator_to_simapro_exchange_row(source_model: Indicator, context=None,
                                                     **kwargs) -> Union[ElementaryExchangeRow, List[ElementaryExchangeRow]]:
    if context is None:
        context = {}
...
def _handle_hestia_input_to_simapro_elementary_exchange_row(
    source_model: Input, context=None, **kwargs
) -> Union[ElementaryExchangeRow, List[ElementaryExchangeRow]]:
    if context is None:
        context = {}
...
def _value_unpacker(source_model: Union[Indicator, Product], **kwargs) -> Union[float, int]:
    """
    for products:
...
def parse_ecoinvent_ref_id(hestia_product: Union[Product, Input]):
    platform_id = None
